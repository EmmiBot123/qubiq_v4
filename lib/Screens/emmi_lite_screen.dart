...
class _EmmiLiteScreenState extends State<EmmiLiteScreen> {
  ...
  void initState() {
    ...
    if (kIsWeb) {
      registerIframe(
          'emmi-lite-web-view', "https://emmibot123.github.io/emmi-lite/");
      _injectAuthTokenWeb();
    }
  }
  ...
  Future<void> _startLocalServer() async {
    ...
    try {
      ...
      final webAssets = manifestMap.keys
          .where((key) => key.startsWith('assets/assets/emmi-bot-lite/'))
          .toList();
      ...
      for (final assetPath in webAssets) {
        ...
        final relativePath =
            assetPath.replaceFirst('assets/assets/emmi-bot-lite/', '');
