...
Blockly.Java['init_tcs34725'] = function(block) {
  var Gain = block.getFieldValue('Gain') || '';
  var code = "init_tcs34725(' + Gain + ');\n";
  return code;
};


Blockly.Python['init_tcs34725'] = function(block) {
  var Gain = block.getFieldValue('Gain') || '';
  var code = 'init_tcs34725(' + Gain + ')\n';
  return code;
};
...
Blockly.Java['read_tcs34725'] = function(block) {
  var code = "read_tcs34725();\n";
  return code;
};
...
Blockly.Java['tcs34725_values'] = function(block) {
  var code = "tcs34725_values()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['tcs34725_values'] = function(block) {
  var code = 'tcs34725_values()';
...
Blockly.Java['tcs34725_color'] = function(block) {
  var code = "tcs34725_color()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['tcs34725_color'] = function(block) {
  var code = 'tcs34725_color()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
