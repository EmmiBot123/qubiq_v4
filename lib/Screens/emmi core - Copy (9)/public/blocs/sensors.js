...
Blockly.Java['button_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = "button_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['button_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = 'button_sensor2(' + dropdown_pin + ')';
...
Blockly.Arduino['shock_sensor'] = function (block) {

  var dropdown_pin = block.getFieldValue('PIN_BUTTON');
  var logic = this.getFieldValue('LOGIC');

  Blockly.Arduino.setups_['setup_btn1white_' + dropdown_pin] =
...
Blockly.Java['shock_sensor'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = "shock_sensor(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['button_touch_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = "button_touch_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['button_touch_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = 'button_touch_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['tilt_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = "tilt_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['tilt_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = 'tilt_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['photointerrupter_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = "photointerrupter_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['photointerrupter_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = 'photointerrupter_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['knock_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = "knock_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['knock_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = 'knock_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Blocks['knock_sensor3'] = {
  ...
  init: function () {
    ...
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage("media/knock.png", 33, 33))
      .appendField(Blockly.Msg.KNOCK_NAME3)
      .appendField(Blockly.Msg.PIN)
      .appendField(new Blockly.FieldDropdown(profile[card].dropdownAllPins), "PIN_BUTTON")
    this.setOutput(true, 'Boolean');
    this.appendDummyInput()
...
Blockly.Arduino['knock_sensor3'] = function (block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON');
  Blockly.Arduino.setups_['setup_knock_' + dropdown_pin] = 'pinMode(' + dropdown_pin + ',INPUT);';
  var code = 'digitalRead(' + dropdown_pin + ')';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
...
Blockly.Java['knock_sensor3'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = "knock_sensor3(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['knock_sensor3'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_BUTTON') || '';
  var code = 'knock_sensor3(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['ultrasonic_sensor'] = function(block) {
  var PIN_TRIG = block.getFieldValue('PIN_TRIG') || '';
  var PIN_ECHO = block.getFieldValue('PIN_ECHO') || '';
  var code = "ultrasonic_sensor(' + PIN_TRIG + ', ' + PIN_ECHO + ');\n";
  return code;
};
...
Blockly.Blocks['ultrasonic_sensor2'] = {
  init: function () {
    var card = window.localStorage.card;
    this.setColour("#54BCF7");
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/sensor_ultrasound.png", 33, 33))
...
Blockly.Java['ultrasonic_sensor2'] = function(block) {
  var PIN_RGB = block.getFieldValue('PIN_TRIG') || '';
  var PIN_IO = block.getFieldValue('PIN_ECHO') || '';
  var code = "ultrasonic_sensor2(' + PIN_RGB + ', ' + PIN_IO + ');\n";
  return code;
};


Blockly.Python['ultrasonic_sensor2'] = function(block) {
  var PIN_RGB = block.getFieldValue('PIN_TRIG') || '';
  var PIN_IO = block.getFieldValue('PIN_ECHO') || '';
  var code = 'ultrasonic_sensor2(' + PIN_RGB + ', ' + PIN_IO + ')\n';
  return code;
...
Blockly.Blocks["ultrasonic_distance2"] = {
  init: function () {
...
Blockly.Java['Analog_temperature_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN') || '';
  var code = "Analog_temperature_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Analog_temperature_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN') || '';
  var code = 'Analog_temperature_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['LM35_temperature_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN') || '';
  var code = "LM35_temperature_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['LM35_temperature_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN') || '';
  var code = 'LM35_temperature_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['potentiometer_ranger_sensor2'] = function(block) {
  var PinPotentiometer = block.getFieldValue('PIN_POTENTIOMETER') || '';
  var code = "potentiometer_ranger_sensor2(' + PinPotentiometer + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['potentiometer_ranger_sensor2'] = function(block) {
  var PinPotentiometer = block.getFieldValue('PIN_POTENTIOMETER') || '';
  var code = 'potentiometer_ranger_sensor2(' + PinPotentiometer + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['LDR_sensor2'] = function(block) {
  var PinLDR = block.getFieldValue('PIN_LDR') || '';
  var code = "LDR_sensor2(' + PinLDR + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['LDR_sensor2'] = function(block) {
  var PinLDR = block.getFieldValue('PIN_LDR') || '';
  var code = 'LDR_sensor2(' + PinLDR + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['LDR_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_LDR') || '';
  var code = "LDR_status_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['LDR_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_LDR') || '';
  var code = 'LDR_status_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['IR_sensor2'] = function(block) {
  var PinIR = block.getFieldValue('PIN_IR') || '';
  var code = "IR_sensor2(' + PinIR + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['IR_sensor2'] = function(block) {
  var PinIR = block.getFieldValue('PIN_IR') || '';
  var code = 'IR_sensor2(' + PinIR + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['IR_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_IR') || '';
  var code = "IR_status_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['IR_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_IR') || '';
  var code = 'IR_status_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Blocks['ir08h_sensor'] = {
  ...
  init: function () {
    ...
    this.setInputsInline(true);
    this.setTooltip('IR08H obstacle sensor status');
  }
};

Blockly.Arduino['ir08h_sensor'] = function (block) {

  var dropdown_pin = block.getFieldValue('PIN_IR');

  Blockly.Arduino.setups_['setup_ir08h_' + dropdown_pin] =
...
Blockly.Java['ir08h_sensor'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_IR') || '';
  var code = "ir08h_sensor(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['ir08h_sensor'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_IR') || '';
  var code = 'ir08h_sensor(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Flame_sensor2'] = function(block) {
  var PinFlame = block.getFieldValue('PIN_FLAME') || '';
  var code = "Flame_sensor2(' + PinFlame + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Flame_sensor2'] = function(block) {
  var PinFlame = block.getFieldValue('PIN_FLAME') || '';
  var code = 'Flame_sensor2(' + PinFlame + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Flame_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_FLAME') || '';
  var code = "Flame_status_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Flame_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_FLAME') || '';
  var code = 'Flame_status_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Sound_sensor2'] = function(block) {
  var PinSound = block.getFieldValue('PIN_SOUND') || '';
  var code = "Sound_sensor2(' + PinSound + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Sound_sensor2'] = function(block) {
  var PinSound = block.getFieldValue('PIN_SOUND') || '';
  var code = 'Sound_sensor2(' + PinSound + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Sound_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_SOUND') || '';
  var code = "Sound_status_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Sound_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_SOUND') || '';
  var code = 'Sound_status_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['dht_sensor2'] = function(block) {
  var PinDHT = block.getFieldValue('PIN_DHT') || '';
  var code = "dht_sensor2(' + PinDHT + ');\n";
  return code;
};


Blockly.Python['dht_sensor2'] = function(block) {
  var PinDHT = block.getFieldValue('PIN_DHT') || '';
  var code = 'dht_sensor2(' + PinDHT + ')\n';
  return code;
};
...
Blockly.Blocks["dht_measure"] = {
  init: function () {
    ...
    this.appendDummyInput().appendField(
      new Blockly.FieldDropdown(
        [[Blockly.Msg.DHT_Type11, "0"], [Blockly.Msg.DHT_Type21, "1"], [Blockly.Msg.DHT_Type22, "2"]],
        function (option) { this.sourceBlock_.updateShape(option); }
      ),
      "OUTPUT_TYPE"
    );
    this.appendDummyInput().appendField(
      new Blockly.FieldDropdown(
        [[Blockly.Msg.DHT_Temp, "0"], [Blockly.Msg.DHT_Humi, "1"], [Blockly.Msg.DHT_Head, "2"]]
      ),
      "OUTPUT_VALUE"
    );
    this.setColour("#54BCF7");
  ...
  // (keep your updateShape, mutationToDom, domToMutation functions as before)
};
...
Blockly.Arduino["dht_measure"] = function (block) {
  ...
  Blockly.Arduino.setups_['setup_dht_' + dht_number] = 'dht_' + dht_number + '.begin();\n';
  ...
  if (Status == '0')
    ...
    code = 'dht_' + dht_number + '.computeHeatIndex(dht_' + dht_number + '.readTemperature(), dht_' + dht_number + '.readHumidity(), false)';
...
Blockly.Java['Gas_sensor2'] = function(block) {
  var PinGas = block.getFieldValue('PIN_GAS') || '';
  var code = "Gas_sensor2(' + PinGas + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Gas_sensor2'] = function(block) {
  var PinGas = block.getFieldValue('PIN_GAS') || '';
  var code = 'Gas_sensor2(' + PinGas + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Gas_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_GAS') || '';
  var code = "Gas_status_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Gas_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_GAS') || '';
  var code = 'Gas_status_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Alcohol_sensor2'] = function(block) {
  var PinAlcohol = block.getFieldValue('PIN_ALCOHOL') || '';
  var code = "Alcohol_sensor2(' + PinAlcohol + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Alcohol_sensor2'] = function(block) {
  var PinAlcohol = block.getFieldValue('PIN_ALCOHOL') || '';
  var code = 'Alcohol_sensor2(' + PinAlcohol + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Alcohol_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_ALCOHOL') || '';
  var code = "Alcohol_status_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Alcohol_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_ALCOHOL') || '';
  var code = 'Alcohol_status_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Air_sensor2'] = function(block) {
  var PinAir = block.getFieldValue('PIN_AIR') || '';
  var code = "Air_sensor2(' + PinAir + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Air_sensor2'] = function(block) {
  var PinAir = block.getFieldValue('PIN_AIR') || '';
  var code = 'Air_sensor2(' + PinAir + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Air_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_AIR') || '';
  var code = "Air_status_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Air_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_AIR') || '';
  var code = 'Air_status_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Vibration_sensor2'] = function(block) {
  var PinVibration = block.getFieldValue('PIN_VIBRATION') || '';
  var code = "Vibration_sensor2(' + PinVibration + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Vibration_sensor2'] = function(block) {
  var PinVibration = block.getFieldValue('PIN_VIBRATION') || '';
  var code = 'Vibration_sensor2(' + PinVibration + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Vibration_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_VIBRATION') || '';
  var code = "Vibration_status_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Vibration_status_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_VIBRATION') || '';
  var code = 'Vibration_status_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['hall_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_HALL') || '';
  var code = "hall_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['hall_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_HALL') || '';
  var code = 'hall_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['hall_sensor2_analog'] = function(block) {
  var PinMag = block.getFieldValue('PIN_MAG') || '';
  var code = "hall_sensor2_analog(' + PinMag + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['hall_sensor2_analog'] = function(block) {
  var PinMag = block.getFieldValue('PIN_MAG') || '';
  var code = 'hall_sensor2_analog(' + PinMag + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Arduino['reed_switch'] = function (block) {

  var dropdown_pin = block.getFieldValue('PIN_HALL');

  Blockly.Arduino.setups_['setup_hall_' + dropdown_pin] =
    'pinMode(' + dropdown_pin + ',INPUT);';
...
Blockly.Java['reed_switch'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_HALL') || '';
  var code = "reed_switch(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['reed_switch'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_HALL') || '';
  var code = 'reed_switch(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['pir_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_PIR') || '';
  var code = "pir_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['pir_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_PIR') || '';
  var code = 'pir_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Vapor_sensor2'] = function(block) {
  var PinVapor = block.getFieldValue('PIN_VAPOR') || '';
  var code = "Vapor_sensor2(' + PinVapor + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Vapor_sensor2'] = function(block) {
  var PinVapor = block.getFieldValue('PIN_VAPOR') || '';
  var code = 'Vapor_sensor2(' + PinVapor + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['AmbientLight_sensor2'] = function(block) {
  var PinAlight = block.getFieldValue('PIN_ALIGHT') || '';
  var code = "AmbientLight_sensor2(' + PinAlight + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['AmbientLight_sensor2'] = function(block) {
  var PinAlight = block.getFieldValue('PIN_ALIGHT') || '';
  var code = 'AmbientLight_sensor2(' + PinAlight + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Water_sensor2'] = function(block) {
  var PinWater = block.getFieldValue('PIN_WATER') || '';
  var code = "Water_sensor2(' + PinWater + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Water_sensor2'] = function(block) {
  var PinWater = block.getFieldValue('PIN_WATER') || '';
  var code = 'Water_sensor2(' + PinWater + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Moisture_sensor2'] = function(block) {
  var PinMoisture = block.getFieldValue('PIN_MOISTURE') || '';
  var code = "Moisture_sensor2(' + PinMoisture + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Moisture_sensor2'] = function(block) {
  var PinMoisture = block.getFieldValue('PIN_MOISTURE') || '';
  var code = 'Moisture_sensor2(' + PinMoisture + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Joystick_axis_sensor2'] = function(block) {
  var PinJoystick = block.getFieldValue('PIN_JOYSTICK') || '';
  var code = "Joystick_axis_sensor2(' + PinJoystick + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Joystick_axis_sensor2'] = function(block) {
  var PinJoystick = block.getFieldValue('PIN_JOYSTICK') || '';
  var code = 'Joystick_axis_sensor2(' + PinJoystick + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['joystick_button_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_JOYSTICK2') || '';
  var code = "joystick_button_sensor2(' + dropdown_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['joystick_button_sensor2'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN_JOYSTICK2') || '';
  var code = 'joystick_button_sensor2(' + dropdown_pin + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['SoundAmp_sensor2'] = function(block) {
  var PinSound = block.getFieldValue('PIN_SOUND') || '';
  var code = "SoundAmp_sensor2(' + PinSound + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['SoundAmp_sensor2'] = function(block) {
  var PinSound = block.getFieldValue('PIN_SOUND') || '';
  var code = 'SoundAmp_sensor2(' + PinSound + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['MRTX_button'] = function(block) {
  var code = "MRTX_button()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MRTX_button'] = function(block) {
  var code = 'MRTX_button()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['MRTNode_button'] = function(block) {
  var code = "MRTNode_button()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MRTNode_button'] = function(block) {
  var code = 'MRTNode_button()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['touch_internal_esp32'] = function(block) {
  var PinTouch = block.getFieldValue('PIN_TOUCH') || '';
  var code = "touch_internal_esp32(' + PinTouch + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['touch_internal_esp32'] = function(block) {
  var PinTouch = block.getFieldValue('PIN_TOUCH') || '';
  var code = 'touch_internal_esp32(' + PinTouch + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['hall_sensor_esp32'] = function(block) {
  var code = "hall_sensor_esp32()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['hall_sensor_esp32'] = function(block) {
  var code = 'hall_sensor_esp32()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['mc005'] = function(block) {
  var value_pin = Blockly.Java.valueToCode(block, 'pin', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "mc005(' + value_pin + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['inter'] = function(block) {
  var value_pin = Blockly.Java.valueToCode(block, 'pin', Blockly.Java.ORDER_ATOMIC) || '';
  var dropdown_state = block.getFieldValue('state') || '';
  var code = "inter(' + value_pin + ', ' + dropdown_state + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['block_pir'] = function(block) {
  var value_v1 = Blockly.Java.valueToCode(block, 'NAME', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "block_pir(' + value_v1 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['block_feu'] = function(block) {
  var value_v1 = Blockly.Java.valueToCode(block, 'FEU', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "block_feu(' + value_v1 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['block_anticollision'] = function(block) {
  var value_v1 = Blockly.Java.valueToCode(block, 'COLLISION', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "block_anticollision(' + value_v1 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['block_sensitif'] = function(block) {
  var value_v1 = Blockly.Java.valueToCode(block, 'SENSITIF', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "block_sensitif(' + value_v1 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Blocks["cap615"] = {
  init: function () {
    ...
    var prog = window.localStorage.prog;
    if (prog != "python") {
      this.appendDummyInput().appendField(new Blockly.FieldImage('media/moisture.png', 33, 33, "*"))
...
Blockly.Java['Init_CCS811'] = function(block) {
  var code = "Init_CCS811();\n";
  return code;
};


Blockly.Python['Init_CCS811'] = function(block) {
  var code = 'Init_CCS811()\n';
  return code;
};
...
Blockly.Java['CCS811_available'] = function(block) {
  var code = "CCS811_available()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['CCS811_available'] = function(block) {
  var code = 'CCS811_available()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['CCS811_readed'] = function(block) {
  var code = "CCS811_readed()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['CCS811_readed'] = function(block) {
  var code = 'CCS811_readed()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['CCS811_values'] = function(block) {
  var code = "CCS811_values()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['CCS811_values'] = function(block) {
  var code = 'CCS811_values()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
