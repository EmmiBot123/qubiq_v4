...
Blockly.Java['APDS9960_init'] = function(block) {
  var code = "APDS9960_init();\n";
  return code;
};


Blockly.Python['APDS9960_init'] = function(block) {
  var code = 'APDS9960_init()\n';
  return code;
};
...
Blockly.Java['APDS9960_gesture_init'] = function(block) {
  var code = "APDS9960_gesture_init();\n";
  return code;
};


Blockly.Python['APDS9960_gesture_init'] = function(block) {
  var code = 'APDS9960_gesture_init()\n';
  return code;
};
...
Blockly.Arduino['APDS9960_color_init'] = function(block) {
  ...
  // Ensure pin 21 is set as output in setup
  Blockly.Arduino.setups_['setup_relay_pin_21'] = 'pinMode(14, OUTPUT);';

  // Generate code based on dropdown selection
  var code = '';
  if (enable == '1')
    code = 'digitalWrite(14, HIGH);\n';
  else
    code = 'digitalWrite(14, LOW);\n';

  return code;
};

Blockly.Java['APDS9960_color_init'] = function(block) {
  var enable = block.getFieldValue('ENABLE') || '';
  var code = "APDS9960_color_init(' + enable + ');\n";
  return code;
};


Blockly.Python['APDS9960_color_init'] = function(block) {
  var enable = block.getFieldValue('ENABLE') || '';
  var code = 'APDS9960_color_init(' + enable + ')\n';
  return code;
};
...
Blockly.Java['APDS9960_gesture_gain'] = function(block) {
  var code = "APDS9960_gesture_gain();\n";
  return code;
};


Blockly.Python['APDS9960_gesture_gain'] = function(block) {
  var code = 'APDS9960_gesture_gain()\n';
  return code;
};
...
Blockly.Java['APDS9960_gesture_detected'] = function(block) {
  var code = "APDS9960_gesture_detected()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['APDS9960_gesture_detected'] = function(block) {
  var code = 'APDS9960_gesture_detected()';
...
Blockly.Java['APDS9960_color_detected'] = function(block) {
  var code = "APDS9960_color_detected()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['APDS9960_color_detected'] = function(block) {
  var code = 'APDS9960_color_detected()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['APDS9960_readgesture'] = function(block) {
  var code = "APDS9960_readgesture()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['APDS9960_readgesture'] = function(block) {
  var code = 'APDS9960_readgesture()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['APDS9960_gesture'] = function(block) {
  var code = "APDS9960_gesture()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['APDS9960_gesture'] = function(block) {
  var code = 'APDS9960_gesture()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['APDS9960_read_colors'] = function(block) {
  var code = "APDS9960_read_colors();\n";
  return code;
};


Blockly.Python['APDS9960_read_colors'] = function(block) {
  var code = 'APDS9960_read_colors()\n';
  return code;
};
...
Blockly.Java['APDS9960_color'] = function(block) {
  var code = "APDS9960_color()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['APDS9960_color'] = function(block) {
  var code = 'APDS9960_color()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
