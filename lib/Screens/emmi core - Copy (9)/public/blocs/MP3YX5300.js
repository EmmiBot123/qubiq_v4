...
Blockly.Java['YX5300Mp3_init_esp32'] = function(block) {
  var code = "YX5300Mp3_init_esp32();\n";
  return code;
};


Blockly.Python['YX5300Mp3_init_esp32'] = function(block) {
  var code = 'YX5300Mp3_init_esp32()\n';
  return code;
};
...
Blockly.Java['YX5300Mp3_set_equalizator'] = function(block) {
  var code = "YX5300Mp3_set_equalizator();\n";
  return code;
};


Blockly.Python['YX5300Mp3_set_equalizator'] = function(block) {
  var code = 'YX5300Mp3_set_equalizator()\n';
  return code;
};
...
Blockly.Java['YX5300Mp3_set_volumen'] = function(block) {
  var volumen = Blockly.Java.valueToCode(block, 'Volumen', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "YX5300Mp3_set_volumen(' + volumen + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['YX5300Mp3_set_volumen'] = function(block) {
  var volumen = Blockly.Python.valueToCode(block, 'Volumen', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'YX5300Mp3_set_volumen(' + volumen + ')';
...
Blockly.Java['YX5300Mp3_operation'] = function(block) {
  var code = "YX5300Mp3_operation();\n";
  return code;
};


Blockly.Python['YX5300Mp3_operation'] = function(block) {
  var code = 'YX5300Mp3_operation()\n';
  return code;
};
...
Blockly.Java['YX5300Mp3_running'] = function(block) {
  var code = "YX5300Mp3_running();\n";
  return code;
};


Blockly.Python['YX5300Mp3_running'] = function(block) {
  var code = 'YX5300Mp3_running()\n';
  return code;
};
...
Blockly.Java['YX5300Mp3_playsong'] = function(block) {
  var song = Blockly.Java.valueToCode(block, 'Song', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "YX5300Mp3_playsong(' + song + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['YX5300Mp3_playsong'] = function(block) {
...
Blockly.Java['YX5300Mp3_playsongdirectiry'] = function(block) {
  var song = Blockly.Java.valueToCode(block, 'Song', Blockly.Java.ORDER_ATOMIC) || '';
  var directory = Blockly.Java.valueToCode(block, 'Directory', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "YX5300Mp3_playsongdirectiry(' + song + ', ' + directory + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['YX5300Mp3_playsongdirectiry'] = function(block) {
  var song = Blockly.Python.valueToCode(block, 'Song', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['YX5300Mp3_playfolderrepeat'] = function(block) {
  var folder = Blockly.Java.valueToCode(block, 'Folder', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "YX5300Mp3_playfolderrepeat(' + folder + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['YX5300Mp3_playfolderrepeat'] = function(block) {
...
Blockly.Java['YX5300Mp3_playFolderShuffle'] = function(block) {
  var result = Blockly.Java.valueToCode(block, 'Folder', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "YX5300Mp3_playFolderShuffle(' + result + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['YX5300Mp3_playFolderShuffle'] = function(block) {
  var result = Blockly.Python.valueToCode(block, 'Folder', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'YX5300Mp3_playFolderShuffle(' + result + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['YX5300Mp3_playTrackRepeat'] = function(block) {
  var song = Blockly.Java.valueToCode(block, 'Song', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "YX5300Mp3_playTrackRepeat(' + song + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['YX5300Mp3_playTrackRepeat'] = function(block) {
  var song = Blockly.Python.valueToCode(block, 'Song', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'YX5300Mp3_playTrackRepeat(' + song + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
