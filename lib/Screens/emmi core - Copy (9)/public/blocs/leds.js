Blockly.Blocks["led_digital_init"] = {
  init: function () {
...
Blockly.Java['led_pwm'] = function (block) {
  var droppinpwm = block.getFieldValue('PWM') || '';
  var stat = Blockly.Java.valueToCode(block, "STAT", Blockly.Java.ORDER_ATOMIC) || '0';
  var code = "led_pwm(" + droppinpwm + ", " + stat + ");\n";
  return code;
};


Blockly.Python['led_pwm'] = function (block) {
  var droppinpwm = block.getFieldValue('PWM') || '';
  var stat = Blockly.Python.valueToCode(block, "STAT", Blockly.Python.ORDER_ATOMIC) || '0';
  var code = 'led_pwm(' + droppinpwm + ', ' + stat + ')\n';
  return code;
};
...
Blockly.Java['rgb_init'] = function (block) {
  var value_rouge = block.getFieldValue('rouge') || '';
  var value_vert = block.getFieldValue('vert') || '';
  var value_bleu = block.getFieldValue('bleu') || '';
  var code = "rgb_init(" + value_rouge + ", " + value_vert + ", " + value_bleu + ");\n";
  return code;
};
...
Blockly.Java['rgb_set'] = function (block) {
  var value_r = Blockly.Java.valueToCode(block, 'r', Blockly.Java.ORDER_ATOMIC) || '0';
  var value_v = Blockly.Java.valueToCode(block, 'v', Blockly.Java.ORDER_ATOMIC) || '0';
  var value_b = Blockly.Java.valueToCode(block, 'b', Blockly.Java.ORDER_ATOMIC) || '0';
  var code = "rgb_set(" + value_r + ", " + value_v + ", " + value_b + ");\n";
  return code;
};
...
Blockly.Blocks["MRTX_led_setcolor"] = {
  init: function () {
...
Blockly.Java['rgb_init_esp32'] = function (block) {
  var value_rouge = block.getFieldValue('rouge') || '';
  var value_vert = block.getFieldValue('vert') || '';
  var value_bleu = block.getFieldValue('bleu') || '';
  var code = "rgb_init_esp32(" + value_rouge + ", " + value_vert + ", " + value_bleu + ");\n";
  return code;
};


Blockly.Python['rgb_init_esp32'] = function (block) {
  var value_rouge = block.getFieldValue('rouge') || '';
  var value_vert = block.getFieldValue('vert') || '';
  var value_bleu = block.getFieldValue('bleu') || '';
  var code = 'rgb_init_esp32(' + value_rouge + ', ' + value_vert + ', ' + value_bleu + ')\n';
...
Blockly.Blocks["rgb_setcolor_anode"] = {
  init: function () {
