...
Blockly.Java['emptyVar'] = function(block) {
  var value = block.getFieldValue('VAR') || '';
  var code = "emptyVar(' + value + ');\n";
  return code;
};
 */
Blockly.Arduino['emptyVar'] = function(block) {
...
Blockly.Java['emptytext'] = function(block) {
  var text_content = block.getFieldValue('content') || '';
  var code = "emptytext(' + text_content + ');\n";
  return code;
};
...
Blockly.Java['esp_dig_pin'] = function(block) {
  var code = "esp_dig_pin();\n";
  return code;
};


Blockly.Python['esp_dig_pin'] = function(block) {
  var code = 'esp_dig_pin()\n';
  return code;
};
...
Blockly.Java['textmod'] = function(block) {
  var code = "textmod();\n";
  return code;
};
...
Blockly.Java['paragraph'] = function(block) {
  var code = "paragraph();\n";
  return code;
};
...
Blockly.Java['header'] = function(block) {
  var code = "header()";
...
Blockly.Java['link'] = function(block) {
  var link = block.getFieldValue('target') || '';
  var code = "link(' + link + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['table'] = function(block) {
  var code = "table()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['tablerow'] = function(block) {
  var code = "tablerow()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['tableheading'] = function(block) {
  var code = "tableheading()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['tabledata'] = function(block) {
  var code = "tabledata()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['image'] = function(block) {
  var source = block.getFieldValue('source') || '';
  var code = "image(' + source + ');\n";
  return code;
};
...
Blockly.Java['args'] = function(block) {
  var code = "args();\n";
  return code;
};
...
Blockly.Java['color'] = function(block) {
  var color = block.getFieldValue('value') || '';
...
Blockly.Java['bgcolor'] = function(block) {
  var color = block.getFieldValue('value') || '';
...
Blockly.Java['textalign'] = function(block) {
  var value = block.getFieldValue('value') || '';
  var code = "textalign(' + value + ');\n";
  return code;
};
...
Blockly.Java['border'] = function(block) {
  var type = block.getFieldValue('type') || '';
  var color = block.getFieldValue('color') || '';
  var code = "border(' + type + ', ' + color + ');\n";
  return code;
};
...
Blockly.Java['input'] = function(block) {
  var type = block.getFieldValue('type') || '';
  var code = "input(' + type + ');\n";
  return code;
};
...
Blockly.Java['form'] = function(block) {
  var action = block.getFieldValue('action') || '';
  var method = block.getFieldValue('method') || '';
  var code = "form(' + action + ', ' + method + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['label'] = function(block) {
  var for_value = block.getFieldValue('for') || '';
  var code = "label(' + for_value + ');\n";
  return code;
};
...
Blockly.Java['br'] = function(block) {
  var code = "br();\n";
  return code;
};
...
Blockly.Java['esp8266_html'] = function(block) {
  var code = "esp8266_html();\n";
  return code;
};
