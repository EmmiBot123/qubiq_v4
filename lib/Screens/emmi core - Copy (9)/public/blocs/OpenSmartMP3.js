...
Blockly.Java['OpenSmartMp3_init_ss'] = function(block) {
  var code = "OpenSmartMp3_init_ss()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OpenSmartMp3_init_ss'] = function(block) {
  var code = 'OpenSmartMp3_init_ss()';
...
Blockly.Java['OpenSmartMp3_set_volumen'] = function(block) {
  var volumen = Blockly.Java.valueToCode(block, 'Volumen', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OpenSmartMp3_set_volumen(' + volumen + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OpenSmartMp3_set_volumen'] = function(block) {
...
Blockly.Java['OpenSmartMp3_operation'] = function(block) {
  var code = "OpenSmartMp3_operation();\n";
  return code;
};


Blockly.Python['OpenSmartMp3_operation'] = function(block) {
  var code = 'OpenSmartMp3_operation()\n';
  return code;
};
...
Blockly.Java['OpenSmartMp3_playsong'] = function(block) {
  var song = Blockly.Java.valueToCode(block, 'Song', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OpenSmartMp3_playsong(' + song + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OpenSmartMp3_playsong'] = function(block) {
...
Blockly.Java['OpenSmartMp3_playsongdirectiry'] = function(block) {
  var song = Blockly.Java.valueToCode(block, 'Song', Blockly.Java.ORDER_ATOMIC) || '';
  var directory = Blockly.Java.valueToCode(block, 'Directory', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OpenSmartMp3_playsongdirectiry(' + song + ', ' + directory + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OpenSmartMp3_playsongdirectiry'] = function(block) {
  var song = Blockly.Python.valueToCode(block, 'Song', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['OpenSmartMp3_injectindex'] = function(block) {
  var song = Blockly.Java.valueToCode(block, 'Song', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OpenSmartMp3_injectindex(' + song + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OpenSmartMp3_injectindex'] = function(block) {
  var song = Blockly.Python.valueToCode(block, 'Song', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'OpenSmartMp3_injectindex(' + song + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
