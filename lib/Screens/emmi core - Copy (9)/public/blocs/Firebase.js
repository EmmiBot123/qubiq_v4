...
Blockly.Java['firebase_init'] = function(block) {
  var URL_Path = block.getFieldValue('URL_PATH') || '';
  var APIReadKey = block.getFieldValue('API_READ_KEY') || '';
  var code = "firebase_init(' + URL_Path + ', ' + APIReadKey + ');\n";
  return code;
};


Blockly.Python['firebase_init'] = function(block) {
  var URL_Path = block.getFieldValue('URL_PATH') || '';
  var APIReadKey = block.getFieldValue('API_READ_KEY') || '';
  var code = 'firebase_init(' + URL_Path + ', ' + APIReadKey + ')\n';
  return code;
...
Blockly.Java['firebase_start'] = function(block) {
  var code = "firebase_start();\n";
  return code;
};


Blockly.Python['firebase_start'] = function(block) {
  var code = 'firebase_start()\n';
  return code;
};
...
Blockly.Java['firebase_write_num'] = function(block) {
  var node = Blockly.Java.valueToCode(block, 'node', Blockly.Java.ORDER_ATOMIC) || '';
  var value = Blockly.Java.valueToCode(block, 'value', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "firebase_write_num(' + node + ', ' + value + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['firebase_write_num'] = function(block) {
  var node = Blockly.Python.valueToCode(block, 'node', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['firebase_write_text'] = function(block) {
  var node = Blockly.Java.valueToCode(block, 'node', Blockly.Java.ORDER_ATOMIC) || '';
  var value = Blockly.Java.valueToCode(block, 'value', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "firebase_write_text(' + node + ', ' + value + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['firebase_write_text'] = function(block) {
  var node = Blockly.Python.valueToCode(block, 'node', Blockly.Python.ORDER_ATOMIC) || '';
  var value = Blockly.Python.valueToCode(block, 'value', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'firebase_write_text(' + node + ', ' + value + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
...
Blockly.Java['firebase_read_num'] = function(block) {
  var node = Blockly.Java.valueToCode(block, 'node', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "firebase_read_num(' + node + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['firebase_read_num'] = function(block) {
  var node = Blockly.Python.valueToCode(block, 'node', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'firebase_read_num(' + node + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['firebase_read_text'] = function(block) {
  var node = Blockly.Java.valueToCode(block, 'node', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "firebase_read_text(' + node + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['firebase_read_text'] = function(block) {
  var node = Blockly.Python.valueToCode(block, 'node', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'firebase_read_text(' + node + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['firebase_delete_node'] = function(block) {
  var node = Blockly.Java.valueToCode(block, 'node', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "firebase_delete_node(' + node + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['firebase_delete_node'] = function(block) {
  var node = Blockly.Python.valueToCode(block, 'node', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'firebase_delete_node(' + node + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
