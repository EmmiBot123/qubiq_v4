...
Blockly.Java['RTTTL_music'] = function(block) {
  var PIN_BUZZER = block.getFieldValue('PIN_BUZZER') || '';
  var code = "RTTTL_music(' + PIN_BUZZER + ');\n";
  return code;
};


Blockly.Python['RTTTL_music'] = function(block) {
  var PIN_BUZZER = block.getFieldValue('PIN_BUZZER') || '';
  var code = 'RTTTL_music(' + PIN_BUZZER + ')\n';
  return code;
};
...
Blockly.Java['RTTTL_music_custom'] = function(block) {
  var rtttl_melody = Blockly.Java.valueToCode(block, 'rtttl_melody', Blockly.Java.ORDER_ATOMIC) || '';
  var PIN_BUZZER = block.getFieldValue('PIN_BUZZER') || '';
  var code = "RTTTL_music_custom(' + rtttl_melody + ', ' + PIN_BUZZER + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RTTTL_music_custom'] = function(block) {
...
Blockly.Java['RTTTL_music_x'] = function(block) {
  var code = "RTTTL_music_x();\n";
  return code;
};


Blockly.Python['RTTTL_music_x'] = function(block) {
  var code = 'RTTTL_music_x()\n';
  return code;
};
...
Blockly.Java['RTTTL_music_custom_x'] = function(block) {
  var rtttl_melody = Blockly.Java.valueToCode(block, 'rtttl_melody', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "RTTTL_music_custom_x(' + rtttl_melody + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RTTTL_music_custom_x'] = function(block) {
  var rtttl_melody = Blockly.Python.valueToCode(block, 'rtttl_melody', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'RTTTL_music_custom_x(' + rtttl_melody + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
