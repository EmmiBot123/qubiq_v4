...
Blockly.Java['mouth_init'] = function(block) {
  var code = "mouth_init();\n";
  return code;
};


Blockly.Python['mouth_init'] = function(block) {
  var code = 'mouth_init()\n';
  return code;
};
...
Blockly.Java['mouth_matrix5x6'] = function(block) {
  var code = "mouth_matrix5x6();\n";
  return code;
};
...
Blockly.Java['mouth_matrix8x8'] = function(block) {
  var code = "mouth_matrix8x8();\n";
  return code;
};

Blockly.Python['mouth_matrix8x8'] = function(block) {
  var code = 'mouth_matrix8x8()\n';
  return code;
};
...
Blockly.Java['mouth_face'] = function(block) {
  var dropdown_otto9_mouth_choice = block.getFieldValue('otto9_mouth_choice') || '';
  var code = "mouth_face(' + dropdown_otto9_mouth_choice + ');\n";
  return code;
};
...
Blockly.Java['mouth#'] = function(block) {
  var valuemouth = Blockly.Java.valueToCode(block, 'mouth', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "mouth#(' + valuemouth + ')";
...
Blockly.Java['mouthp'] = function(block) {
...
Blockly.Java['mouth_text'] = function(block) {
  var text_input = block.getFieldValue('input') || '';
  var code = "mouth_text(' + text_input + ');\n";
  return code;
};
...
Blockly.Java['mouth_clear'] = function(block) {
  var code = "mouth_clear();\n";
  return code;
};
...
Blockly.Java['Init_MAX7219_ledmatrix'] = function(block) {
  var code = "Init_MAX7219_ledmatrix();\n";
  return code;
};


Blockly.Python['Init_MAX7219_ledmatrix'] = function(block) {
  var code = 'Init_MAX7219_ledmatrix()\n';
  return code;
};
...
Blockly.Java['MAX7219_ledmatrix_shutdown'] = function(block) {
  var code = "MAX7219_ledmatrix_shutdown();\n";
  return code;
};


Blockly.Python['MAX7219_ledmatrix_shutdown'] = function(block) {
  var code = 'MAX7219_ledmatrix_shutdown()\n';
  return code;
};
...
Blockly.Java['MAX7219_ledmatrix_brightness'] = function(block) {
  var brightness = Blockly.Java.valueToCode(block, 'BRIGHTNESS', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "MAX7219_ledmatrix_brightness(' + brightness + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MAX7219_ledmatrix_brightness'] = function(block) {
...
Blockly.Java['MAX7219_ledmatrix_clear'] = function(block) {
  var code = "MAX7219_ledmatrix_clear();\n";
  return code;
};


Blockly.Python['MAX7219_ledmatrix_clear'] = function(block) {
  var code = 'MAX7219_ledmatrix_clear()\n';
  return code;
};
...
Blockly.Java['MAX7219_ledmatrix_draw'] = function(block) {
  var code = "MAX7219_ledmatrix_draw();\n";
  return code;
};


Blockly.Python['MAX7219_ledmatrix_draw'] = function(block) {
  var code = 'MAX7219_ledmatrix_draw()\n';
  return code;
};
...
Blockly.Java['MAX7219_ledmatrix_row'] = function(block) {
  var row = Blockly.Java.valueToCode(block, 'Row', Blockly.Java.ORDER_ATOMIC) || '';
  var value = Blockly.Java.valueToCode(block, 'VALUE', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "MAX7219_ledmatrix_row(' + row + ', ' + value + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MAX7219_ledmatrix_row'] = function(block) {
...
Blockly.Java['MAX7219_ledmatrix_column'] = function(block) {
  var Column = Blockly.Java.valueToCode(block, 'Column', Blockly.Java.ORDER_ATOMIC) || '';
  var value = Blockly.Java.valueToCode(block, 'VALUE', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "MAX7219_ledmatrix_column(' + Column + ', ' + value + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MAX7219_ledmatrix_column'] = function(block) {
...
Blockly.Java['MAX7219_ledmatrix_led'] = function(block) {
  var row = Blockly.Java.valueToCode(block, 'Row', Blockly.Java.ORDER_ATOMIC) || '';
  var Column = Blockly.Java.valueToCode(block, 'Column', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "MAX7219_ledmatrix_led(' + row + ', ' + Column + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MAX7219_ledmatrix_led'] = function(block) {
  var row = Blockly.Python.valueToCode(block, 'Row', Blockly.Python.ORDER_ATOMIC) || '';
  var Column = Blockly.Python.valueToCode(block, 'Column', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'MAX7219_ledmatrix_led(' + row + ', ' + Column + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
...
Blockly.Java['MAX7219_animation'] = function(block) {
  var bitmap = block.getFieldValue('bitmap') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var code = "MAX7219_animation(' + bitmap + ', ' + dropdown_otto_move_speed + ');\n";
  return code;
};


Blockly.Python['MAX7219_animation'] = function(block) {
  var bitmap = block.getFieldValue('bitmap') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var code = 'MAX7219_animation(' + bitmap + ', ' + dropdown_otto_move_speed + ')\n';
  return code;
...
Blockly.Java['matrice8x8_animation'] = function(block) {
  var bitmap = block.getFieldValue('bitmap') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var code = "matrice8x8_animation(' + bitmap + ', ' + dropdown_otto_move_speed + ');\n";
  return code;
};


Blockly.Python['matrice8x8_animation'] = function(block) {
  var bitmap = block.getFieldValue('bitmap') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var code = 'matrice8x8_animation(' + bitmap + ', ' + dropdown_otto_move_speed + ')\n';
  return code;
...
Blockly.Java['Init_MAX7219_ledmatrix_esp32'] = function(block) {
  var code = "Init_MAX7219_ledmatrix_esp32();\n";
  return code;
};


Blockly.Python['Init_MAX7219_ledmatrix_esp32'] = function(block) {
  var code = 'Init_MAX7219_ledmatrix_esp32()\n';
  return code;
};
...
Blockly.Java['MAX7219_ledmatrix_brightness_esp32'] = function(block) {
  var brightness = Blockly.Java.valueToCode(block, 'BRIGHTNESS', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "MAX7219_ledmatrix_brightness_esp32(' + brightness + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MAX7219_ledmatrix_brightness_esp32'] = function(block) {
  var brightness = Blockly.Python.valueToCode(block, 'BRIGHTNESS', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'MAX7219_ledmatrix_brightness_esp32(' + brightness + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['MAX7219_ledmatrix_clear_esp32'] = function(block) {
  var code = "MAX7219_ledmatrix_clear_esp32();\n";
  return code;
};


Blockly.Python['MAX7219_ledmatrix_clear_esp32'] = function(block) {
  var code = 'MAX7219_ledmatrix_clear_esp32()\n';
  return code;
};
...
Blockly.Java['MAX7219_ledmatrix_draw_esp32'] = function(block) {
  var code = "MAX7219_ledmatrix_draw_esp32();\n";
  return code;
};


Blockly.Python['MAX7219_ledmatrix_draw_esp32'] = function(block) {
  var code = 'MAX7219_ledmatrix_draw_esp32()\n';
  return code;
};
...
Blockly.Java['MAX7219_ledmatrix_row_esp32'] = function(block) {
  var row = Blockly.Java.valueToCode(block, 'Row', Blockly.Java.ORDER_ATOMIC) || '';
  var value = Blockly.Java.valueToCode(block, 'VALUE', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "MAX7219_ledmatrix_row_esp32(' + row + ', ' + value + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MAX7219_ledmatrix_row_esp32'] = function(block) {
  var row = Blockly.Python.valueToCode(block, 'Row', Blockly.Python.ORDER_ATOMIC) || '';
  var value = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'MAX7219_ledmatrix_row_esp32(' + row + ', ' + value + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
...
Blockly.Java['MAX7219_ledmatrix_column_esp32'] = function(block) {
  var Column = Blockly.Java.valueToCode(block, 'Column', Blockly.Java.ORDER_ATOMIC) || '';
  var value = Blockly.Java.valueToCode(block, 'VALUE', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "MAX7219_ledmatrix_column_esp32(' + Column + ', ' + value + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MAX7219_ledmatrix_column_esp32'] = function(block) {
  var Column = Blockly.Python.valueToCode(block, 'Column', Blockly.Python.ORDER_ATOMIC) || '';
  var value = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'MAX7219_ledmatrix_column_esp32(' + Column + ', ' + value + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
...
Blockly.Java['MAX7219_ledmatrix_led_esp32'] = function(block) {
  var row = Blockly.Java.valueToCode(block, 'Row', Blockly.Java.ORDER_ATOMIC) || '';
  var Column = Blockly.Java.valueToCode(block, 'Column', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "MAX7219_ledmatrix_led_esp32(' + row + ', ' + Column + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['MAX7219_ledmatrix_led_esp32'] = function(block) {
  var row = Blockly.Python.valueToCode(block, 'Row', Blockly.Python.ORDER_ATOMIC) || '';
  var Column = Blockly.Python.valueToCode(block, 'Column', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'MAX7219_ledmatrix_led_esp32(' + row + ', ' + Column + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
