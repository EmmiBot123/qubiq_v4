...
Blockly.Java['buzzer_music'] = function(block) {
  var code = "buzzer_music();\n";
  return code;
};


Blockly.Python['buzzer_music'] = function(block) {
  var code = 'buzzer_music()\n';
  return code;
};
...
Blockly.Java['buzzer_music_custom'] = function(block) {
  var rtttl_melody = Blockly.Java.valueToCode(block, 'rtttl_melody', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "buzzer_music_custom(' + rtttl_melody + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['buzzer_music_custom'] = function(block) {
  var rtttl_melody = Blockly.Python.valueToCode(block, 'rtttl_melody', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'buzzer_music_custom(' + rtttl_melody + ')';
...
Blockly.Java['cute_play'] = function(block) {
  var dropdown_sound = block.getFieldValue('sound') || '';
  var code = "cute_play(' + dropdown_sound + ');\n";
  return code;
};


Blockly.Python['cute_play'] = function(block) {
  var dropdown_sound = block.getFieldValue('sound') || '';
  var code = 'cute_play(' + dropdown_sound + ')\n';
  return code;
};
...
Blockly.Java['led_pwm_esp32'] = function(block) {
  var droppinpwm = block.getFieldValue('PWM') || '';
  var code = "led_pwm_esp32(' + droppinpwm + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['led_pwm_esp32'] = function(block) {
  var droppinpwm = block.getFieldValue('PWM') || '';
  var code = 'led_pwm_esp32(' + droppinpwm + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
