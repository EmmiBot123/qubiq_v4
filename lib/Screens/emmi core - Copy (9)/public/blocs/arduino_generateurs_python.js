...
Blockly.Python["base_setup"] = function (block) {
	var branch = Blockly.Python.statementToCode(block, "DO");
	if (branch) Blockly.Python.setups_["userSetupCode"] = branch;
	return "";
};
Blockly.Python["base_setup_loop"] = function (block) {
	var setup_branch = Blockly.Python.statementToCode(block, "DO");
	var loop_branch = Blockly.Python.statementToCode(block, "LOOP") || Blockly.Python.PASS;
	var code = "";
	if (setup_branch) {
		code += setup_branch;
	}
