...
Blockly.Java['Alexa_init_esp'] = function(block) {
  var NameDevice = block.getFieldValue('NameDevice') || '';
  var code = "Alexa_init_esp(' + NameDevice + ');\n";
  return code;
};


Blockly.Python['Alexa_init_esp'] = function(block) {
  var NameDevice = block.getFieldValue('NameDevice') || '';
  var code = 'Alexa_init_esp(' + NameDevice + ')\n';
  return code;
};
...
Blockly.Java['Alexa_loop'] = function(block) {
  var code = "Alexa_loop();\n";
  return code;
};


Blockly.Python['Alexa_loop'] = function(block) {
  var code = 'Alexa_loop()\n';
  return code;
};
...
Blockly.Java['Alexa_param'] = function(block) {
  var code = "Alexa_param()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Alexa_param'] = function(block) {
  var code = 'Alexa_param()';
