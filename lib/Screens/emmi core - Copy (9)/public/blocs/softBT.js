...
Blockly.Java['soft_bt_init'] = function (block) {
  var code = "soft_bt_init();\n";
  return code;
};


Blockly.Python['soft_bt_init'] = function (block) {
  var code = 'soft_bt_init()\n';
  return code;
};
...
Blockly.Java['esp32_bt_init'] = function (block) {
  var btName = Blockly.Java.valueToCode(block, 'BT_NAME', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "esp32_bt_init(" + btName + ");\n";
  return code;
};


Blockly.Python['esp32_bt_init'] = function (block) {
  var btName = Blockly.Python.valueToCode(block, 'BT_NAME', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'esp32_bt_init(' + btName + ')\n';
  return code;
};
...
Blockly.Java['soft_bt_printfor'] = function (block) {
  var content = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "soft_bt_printfor(' + content + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_bt_printfor'] = function (block) {
...
Blockly.Java['soft_bt_available'] = function (block) {
  var code = "soft_bt_available()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_bt_available'] = function (block) {
  var code = 'soft_bt_available()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_bt_read'] = function (block) {
  var code = "soft_bt_read()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_bt_read'] = function (block) {
  var code = 'soft_bt_read()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_bt_read_string'] = function (block) {
  var code = "soft_bt_read_string()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_bt_read_string'] = function (block) {
  var code = 'soft_bt_read_string()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_bt_read_number'] = function (block) {
  var code = "soft_bt_read_number()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_bt_read_number'] = function (block) {
  var code = 'soft_bt_read_number()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_bt_println'] = function (block) {
  var content = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "soft_bt_println(' + content + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_bt_println'] = function (block) {
  var content = Blockly.Python.valueToCode(block, 'CONTENT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'soft_bt_println(' + content + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_bt_print'] = function (block) {
  var content = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "soft_bt_print(' + content + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_bt_print'] = function (block) {
  var content = Blockly.Python.valueToCode(block, 'CONTENT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'soft_bt_print(' + content + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_bt_write'] = function (block) {
  var content = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "soft_bt_write(' + content + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_bt_write'] = function (block) {
  var content = Blockly.Python.valueToCode(block, 'CONTENT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'soft_bt_write(' + content + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
