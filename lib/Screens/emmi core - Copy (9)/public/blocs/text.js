...
Blockly.Java['text_join'] = function(block) {
  var argument0 = Blockly.Java.valueToCode(block, 'ADD0', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "text_join(' + argument0 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['text_join'] = function(block) {
  var argument0 = Blockly.Python.valueToCode(block, 'ADD0', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'text_join(' + argument0 + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['text_append'] = function(block) {
  var argument0 = Blockly.Java.valueToCode(block, 'TEXT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "text_append(' + argument0 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['text_append'] = function(block) {
  var argument0 = Blockly.Python.valueToCode(block, 'TEXT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'text_append(' + argument0 + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['text_length'] = function(block) {
  var argument0 = Blockly.Java.valueToCode(block, 'VALUE', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "text_length(' + argument0 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['text_length'] = function(block) {
  var argument0 = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'text_length(' + argument0 + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['text_isEmpty'] = function(block) {
  var argument0 = Blockly.Java.valueToCode(block, 'VALUE', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "text_isEmpty(' + argument0 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['text_prompt_ext'] = function(block) {
  var msg = Blockly.Java.valueToCode(block, 'TEXT', Blockly.Java.ORDER_ATOMIC) || '';
  var returnType = block.getFieldValue('TYPE') || '';
  var code = "text_prompt_ext(' + msg + ', ' + returnType + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['text_indexOf'] = function(block) {
  var substring = Blockly.Java.valueToCode(block, 'FIND', Blockly.Java.ORDER_ATOMIC) || '';
  var text = Blockly.Java.valueToCode(block, 'VALUE', Blockly.Java.ORDER_ATOMIC) || '';
  var operator = block.getFieldValue('END') || '';
  var code = "text_indexOf(' + substring + ', ' + text + ', ' + operator + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['text_indexOf'] = function(block) {
  var substring = Blockly.Python.valueToCode(block, 'FIND', Blockly.Python.ORDER_ATOMIC) || '';
  var text = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_ATOMIC) || '';
  var operator = block.getFieldValue('END') || '';
  var code = 'text_indexOf(' + substring + ', ' + text + ', ' + operator + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['text_charAt'] = function(block) {
  var text = Blockly.Java.valueToCode(block, 'VALUE', Blockly.Java.ORDER_ATOMIC) || '';
  var at = Blockly.Java.valueToCode(block, 'AT', Blockly.Java.ORDER_ATOMIC) || '';
  var at = Blockly.Java.valueToCode(block, 'AT', Blockly.Java.ORDER_ATOMIC) || '';
  var where = block.getFieldValue('WHERE') || '';
  var code = "text_charAt(' + text + ', ' + at + ', ' + at + ', ' + where + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['text_getSubstring'] = function(block) {
  var text = Blockly.Java.valueToCode(block, 'STRING', Blockly.Java.ORDER_ATOMIC) || '';
  var at1 = Blockly.Java.valueToCode(block, 'AT1', Blockly.Java.ORDER_ATOMIC) || '';
  var at1 = Blockly.Java.valueToCode(block, 'AT1', Blockly.Java.ORDER_ATOMIC) || '';
  var at2 = Blockly.Java.valueToCode(block, 'AT2', Blockly.Java.ORDER_ATOMIC) || '';
  var at2 = Blockly.Java.valueToCode(block, 'AT2', Blockly.Java.ORDER_ATOMIC) || '';
  var where1 = block.getFieldValue('WHERE1') || '';
  var where2 = block.getFieldValue('WHERE2') || '';
  var code = "text_getSubstring(' + text + ', ' + at1 + ', ' + at1 + ', ' + at2 + ', ' + at2 + ', ' + where1 + ', ' + where2 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Python['text_getSubstring'] = function(block) {
  ...
  var at1 = Blockly.Python.valueToCode(block, 'AT1', Blockly.Python.ORDER_ATOMIC) || '';
  var at1 = Blockly.Python.valueToCode(block, 'AT1', Blockly.Python.ORDER_ATOMIC) || '';
  var at2 = Blockly.Python.valueToCode(block, 'AT2', Blockly.Python.ORDER_ATOMIC) || '';
  var at2 = Blockly.Python.valueToCode(block, 'AT2', Blockly.Python.ORDER_ATOMIC) || '';
  var where1 = block.getFieldValue('WHERE1') || '';
  var where2 = block.getFieldValue('WHERE2') || '';
  var code = 'text_getSubstring(' + text + ', ' + at1 + ', ' + at1 + ', ' + at2 + ', ' + at2 + ', ' + where1 + ', ' + where2 + ')';
...
Blockly.Java['conversion_tochar'] = function(block) {
  var value_name = Blockly.Java.valueToCode(block, 'NAME', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "conversion_tochar(' + value_name + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['conversion_tochar'] = function(block) {
...
Blockly.Java['conversion_toString'] = function(block) {
  var value_name = Blockly.Java.valueToCode(block, 'NAME', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "conversion_toString(' + value_name + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['conversion_toString'] = function(block) {
  var value_name = Blockly.Python.valueToCode(block, 'NAME', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'conversion_toString(' + value_name + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['conversion_toString2'] = function(block) {
  var value_name = Blockly.Java.valueToCode(block, 'NAME', Blockly.Java.ORDER_ATOMIC) || '';
  var decimals = Blockly.Java.valueToCode(block, 'Decimals', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "conversion_toString2(' + value_name + ', ' + decimals + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['conversion_toString2'] = function(block) {
  var value_name = Blockly.Python.valueToCode(block, 'NAME', Blockly.Python.ORDER_ATOMIC) || '';
  var decimals = Blockly.Python.valueToCode(block, 'Decimals', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'conversion_toString2(' + value_name + ', ' + decimals + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
