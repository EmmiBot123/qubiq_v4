...
Blockly.Java['Init_RTC_ds3231'] = function(block) {
  var code = "Init_RTC_ds3231();\n";
  return code;
};


Blockly.Python['Init_RTC_ds3231'] = function(block) {
  var code = 'Init_RTC_ds3231()\n';
  return code;
};
...
Blockly.Java['DateTime_RTC_ds3231'] = function(block) {
  var day = Blockly.Java.valueToCode(block, 'DS3231_DAY', Blockly.Java.ORDER_ATOMIC) || '';
  var month = Blockly.Java.valueToCode(block, 'DS3231_MONTH', Blockly.Java.ORDER_ATOMIC) || '';
  var year = Blockly.Java.valueToCode(block, 'DS3231_YEAR', Blockly.Java.ORDER_ATOMIC) || '';
  var hour = Blockly.Java.valueToCode(block, 'DS3231_HOUR', Blockly.Java.ORDER_ATOMIC) || '';
  var min = Blockly.Java.valueToCode(block, 'DS3231_MINUTE', Blockly.Java.ORDER_ATOMIC) || '';
  var sec = Blockly.Java.valueToCode(block, 'DS3231_SECOND', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "DateTime_RTC_ds3231(' + day + ', ' + month + ', ' + year + ', ' + hour + ', ' + min + ', ' + sec + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['DateTime_RTC_ds3231'] = function(block) {
  var day = Blockly.Python.valueToCode(block, 'DS3231_DAY', Blockly.Python.ORDER_ATOMIC) || '';
  var month = Blockly.Python.valueToCode(block, 'DS3231_MONTH', Blockly.Python.ORDER_ATOMIC) || '';
  var year = Blockly.Python.valueToCode(block, 'DS3231_YEAR', Blockly.Python.ORDER_ATOMIC) || '';
  var hour = Blockly.Python.valueToCode(block, 'DS3231_HOUR', Blockly.Python.ORDER_ATOMIC) || '';
  var min = Blockly.Python.valueToCode(block, 'DS3231_MINUTE', Blockly.Python.ORDER_ATOMIC) || '';
  var sec = Blockly.Python.valueToCode(block, 'DS3231_SECOND', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'DateTime_RTC_ds3231(' + day + ', ' + month + ', ' + year + ', ' + hour + ', ' + min + ', ' + sec + ')';
...
Blockly.Java['order_read_rtc_ds3231'] = function(block) {
  var code = "order_read_rtc_ds3231();\n";
  return code;
};


Blockly.Python['order_read_rtc_ds3231'] = function(block) {
  var code = 'order_read_rtc_ds3231()\n';
  return code;
};

Blockly.Blocks['order_read_rtc_ds32312'] = {
  helpUrl: '',
  init: function() {
    this.setColour("#54BCF7");
    this.appendDummyInput()
        .appendField(Blockly.Msg.RTCDS3231_READ_RTC1);
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("Order to read the rtc");
...
Blockly.Arduino['order_read_rtc_ds32312'] = function(block) {
  // TODO: Assemble Python into code variable.
...
Blockly.Java['order_read_rtc_ds32312'] = function(block) {
  var code = "order_read_rtc_ds32312();\n";
  return code;
};


Blockly.Python['order_read_rtc_ds32312'] = function(block) {
  var code = 'order_read_rtc_ds32312()\n';
  return code;
};
...
Blockly.Java['values_ds3231'] = function(block) {
  var code = "values_ds3231()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['values_ds3231'] = function(block) {
  var code = 'values_ds3231()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['values_text_ds3231'] = function(block) {
  var code = "values_text_ds3231()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['values_text_ds3231'] = function(block) {
  var code = 'values_text_ds3231()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
