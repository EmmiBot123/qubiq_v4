...
Blockly.Java['otto_configuration'] = function(block) {
  var PIN_YL = block.getFieldValue('PIN_YL') || '';
  var PIN_YR = block.getFieldValue('PIN_YR') || '';
  var PIN_RL = block.getFieldValue('PIN_RL') || '';
  var PIN_RR = block.getFieldValue('PIN_RR') || '';
  var PIN_Buzzer = block.getFieldValue('PIN_Buzzer') || '';
  var code = "otto_configuration(' + PIN_YL + ', ' + PIN_YR + ', ' + PIN_RL + ', ' + PIN_RR + ', ' + PIN_Buzzer + ');\n";
  return code;
};


Blockly.Python['otto_configuration'] = function(block) {
  var PIN_YL= block.getFieldValue('PIN_YL');
  var PIN_YR= block.getFieldValue('PIN_YR');
  var PIN_RL= block.getFieldValue('PIN_RL');
  var PIN_RR= block.getFieldValue('PIN_RR');
  ...
  Blockly.Python.imports_['otto_lib'] = 'import Otto';
  Blockly.Python.definitions_['otto_init'] = 'otto = Otto.Otto(' + PIN_YL + ', ' + PIN_YR + ', ' + PIN_RL + ', ' + PIN_RR + ', True, ' + PIN_Buzzer + ')';
  var code = 'otto.home()\n';
  return code;
};
...
Blockly.Java['otto_home'] = function(block) {
  var code = "otto_home();\n";
  return code;
};


Blockly.Python['otto_home'] = function(block) {
  var code = 'otto_home()\n';
  return code;
};
...
Blockly.Java['esp32servo_home'] = function(block) {
  var code = "esp32servo_home();\n";
  return code;
};


Blockly.Python['esp32servo_home'] = function(block) {
  var code = 'esp32servo_home()\n';
  return code;
};
...
Blockly.Java['otto_calibration'] = function(block) {
  var valuell = Blockly.Java.valueToCode(block, 'LL', Blockly.Java.ORDER_ATOMIC) || '';
  var valuerl = Blockly.Java.valueToCode(block, 'RL', Blockly.Java.ORDER_ATOMIC) || '';
  var valuelf = Blockly.Java.valueToCode(block, 'LF', Blockly.Java.ORDER_ATOMIC) || '';
  var valuerf = Blockly.Java.valueToCode(block, 'RF', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "otto_calibration(' + valuell + ', ' + valuerl + ', ' + valuelf + ', ' + valuerf + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['otto_calibration'] = function(block) {
  // Auto-generated Python stub for otto_calibration
  var code = '0';
...
Blockly.Java['otto_eeprom'] = function(block) {
  var code = "otto_eeprom();\n";
  return code;
};


Blockly.Python['otto_eeprom'] = function(block) {
  var code = 'otto_eeprom()\n';
  return code;
};
...
Blockly.Java['otto_movelegs'] = function(block) {
  var PIN_YL = Blockly.Java.valueToCode(block, 'PIN_YL', Blockly.Java.ORDER_ATOMIC) || '';
  var PIN_YR = Blockly.Java.valueToCode(block, 'PIN_YR', Blockly.Java.ORDER_ATOMIC) || '';
  var PIN_RL = Blockly.Java.valueToCode(block, 'PIN_RL', Blockly.Java.ORDER_ATOMIC) || '';
  var PIN_RR = Blockly.Java.valueToCode(block, 'PIN_RR', Blockly.Java.ORDER_ATOMIC) || '';
  var TEMPO = Blockly.Java.valueToCode(block, 'TEMPO', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "otto_movelegs(' + PIN_YL + ', ' + PIN_YR + ', ' + PIN_RL + ', ' + PIN_RR + ', ' + TEMPO + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['otto_movelegs'] = function(block) {
  // Auto-generated Python stub for otto_movelegs
  var code = '0';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['otto_moveservos'] = function(block) {
  var Period = Blockly.Java.valueToCode(block, 'Period', Blockly.Java.ORDER_ATOMIC) || '';
  var Pos = Blockly.Java.valueToCode(block, 'Pos', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "otto_moveservos(' + Period + ', ' + Pos + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['otto_moveservos'] = function(block) {
  // Auto-generated Python stub for otto_moveservos
  var code = '0';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['esp32servo_move'] = function(block) {
  var dir = block.getFieldValue('esp32_move_sens') || '';
  var speed = block.getFieldValue('esp32_move_speed') || '';
  var code = "esp32servo_move(' + dir + ', ' + speed + ');\n";
  return code;
};


Blockly.Python['esp32servo_move'] = function(block) {
  var dir = block.getFieldValue('esp32_move_sens') || '';
  var speed = block.getFieldValue('esp32_move_speed') || '';
  var code = 'esp32servo_move(' + dir + ', ' + speed + ')\n';
  return code;
...
Blockly.Java['otto_move'] = function(block) {
  var dropdown_otto_move_sens = block.getFieldValue('otto_move_sens') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var code = "otto_move(' + dropdown_otto_move_sens + ', ' + dropdown_otto_move_speed + ');\n";
  return code;
};


Blockly.Python['otto_move'] = function(block) {
  var dropdown_otto_move_sens = block.getFieldValue('otto_move_sens') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var code = 'otto_move(' + dropdown_otto_move_sens + ', ' + dropdown_otto_move_speed + ')\n';
  return code;
...
Blockly.Java['otto_dance'] = function(block) {
  var dropdown_otto_dance_movement = block.getFieldValue('otto_dance_movement') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var dropdown_otto_dance_size = block.getFieldValue('otto_dance_size') || '';
  var code = "otto_dance(' + dropdown_otto_dance_movement + ', ' + dropdown_otto_move_speed + ', ' + dropdown_otto_dance_size + ');\n";
  return code;
};


Blockly.Python['otto_dance'] = function(block) {
  var dropdown_otto_dance_movement = block.getFieldValue('otto_dance_movement') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var dropdown_otto_dance_size = block.getFieldValue('otto_dance_size') || '';
  var code = 'otto_dance(' + dropdown_otto_dance_movement + ', ' + dropdown_otto_move_speed + ', ' + dropdown_otto_dance_size + ')\n';
...
Blockly.Java['otto_do'] = function(block) {
  var dropdown_otto_do_movement = block.getFieldValue('otto_do_movement') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var dropdown_otto_dance_size = block.getFieldValue('otto_dance_size') || '';
  var code = "otto_do(' + dropdown_otto_do_movement + ', ' + dropdown_otto_move_speed + ', ' + dropdown_otto_dance_size + ');\n";
  return code;
};


Blockly.Python['otto_do'] = function(block) {
  var dropdown_otto_do_movement = block.getFieldValue('otto_do_movement') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var dropdown_otto_dance_size = block.getFieldValue('otto_dance_size') || '';
  var code = 'otto_do(' + dropdown_otto_do_movement + ', ' + dropdown_otto_move_speed + ', ' + dropdown_otto_dance_size + ')\n';
...
Blockly.Java['otto_gesture'] = function(block) {
  var dropdown_otto_gesture = block.getFieldValue('otto_gesture') || '';
  var code = "otto_gesture(' + dropdown_otto_gesture + ');\n";
  return code;
};


Blockly.Python['otto_gesture'] = function(block) {
  var dropdown_otto_gesture = block.getFieldValue('otto_gesture') || '';
  var code = 'otto_gesture(' + dropdown_otto_gesture + ')\n';
  return code;
};
...
Blockly.Java['otto_sound'] = function(block) {
  var dropdown_otto_sound = block.getFieldValue('otto_sound') || '';
  var code = "otto_sound(' + dropdown_otto_sound + ');\n";
  return code;
};


Blockly.Python['otto_sound'] = function(block) {
  var dropdown_otto_sound = block.getFieldValue('otto_sound') || '';
  var code = 'otto_sound(' + dropdown_otto_sound + ')\n';
  return code;
};
...
Blockly.Java['otto_tone'] = function(block) {
  var dropdown_otto_note = block.getFieldValue('otto_note') || '';
  var dropdown_otto_note_duration = block.getFieldValue('otto_note_duration') || '';
  var code = "otto_tone(' + dropdown_otto_note + ', ' + dropdown_otto_note_duration + ');\n";
  return code;
};


Blockly.Python['otto_tone'] = function(block) {
  var dropdown_otto_note = block.getFieldValue('otto_note') || '';
  var dropdown_otto_note_duration = block.getFieldValue('otto_note_duration') || '';
  var code = 'otto_tone(' + dropdown_otto_note + ', ' + dropdown_otto_note_duration + ')\n';
  return code;
...
Blockly.Java['otto_tonehz'] = function(block) {
  var Hz1 = Blockly.Java.valueToCode(block, 'Hz1', Blockly.Java.ORDER_ATOMIC) || '';
  var duration = Blockly.Java.valueToCode(block, 'duration', Blockly.Java.ORDER_ATOMIC) || '';
  var silent = Blockly.Java.valueToCode(block, 'silent', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "otto_tonehz(' + Hz1 + ', ' + duration + ', ' + silent + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['otto_tonehz'] = function(block) {
  // Auto-generated Python stub for otto_tonehz
  var code = '0';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['otto_bendtone'] = function(block) {
  var Hz1 = Blockly.Java.valueToCode(block, 'Hz1', Blockly.Java.ORDER_ATOMIC) || '';
  var Hz2 = Blockly.Java.valueToCode(block, 'Hz2', Blockly.Java.ORDER_ATOMIC) || '';
  var prop = Blockly.Java.valueToCode(block, 'prop', Blockly.Java.ORDER_ATOMIC) || '';
  var duration = Blockly.Java.valueToCode(block, 'duration', Blockly.Java.ORDER_ATOMIC) || '';
  var silent = Blockly.Java.valueToCode(block, 'silent', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "otto_bendtone(' + Hz1 + ', ' + Hz2 + ', ' + prop + ', ' + duration + ', ' + silent + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['otto_bendtone'] = function(block) {
  // Auto-generated Python stub for otto_bendtone
  var code = '0';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['otto_getsensor'] = function(block) {
  var code = "otto_getsensor()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['otto_getsensor'] = function(block) {
  // Auto-generated Python stub for otto_getsensor
  var code = '0';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
