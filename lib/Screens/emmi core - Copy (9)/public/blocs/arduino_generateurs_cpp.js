...
Blockly.Java['esp8266_init'] = function(block) {
  var code = "esp8266_init()";
...
Blockly.Java['esp8266_send'] = function(block) {
  var data = Blockly.Java.valueToCode(block, 'message', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "esp8266_send(' + data + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['esp8266_send_html'] = function(block) {
  var code = "esp8266_send_html();\n";
  return code;
};
...
Blockly.Java['esp8266_wait_server'] = function(block) {
  var code = "esp8266_wait_server();\n";
  return code;
};
...
Blockly.Java['esp8266_wait_client'] = function(block) {
  var code = "esp8266_wait_client()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['base_code_entree'] = function(block) {
  var code = "base_code_entree()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['VOICE_play'] = function(block) {
  var voiceId = block.getFieldValue('VOICE_ID') || '';
  var code = "VOICE_play(' + voiceId + ');\n";
  return code;
};


Blockly.Python['VOICE_play'] = function(block) {
  var voiceId = block.getFieldValue('VOICE_ID') || '';
  var code = 'VOICE_play(' + voiceId + ')\n';
  return code;
};
...
Blockly.Java['speaker_init'] = function(block) {
  var code = "speaker_init();\n";
  return code;
};


Blockly.Python['speaker_init'] = function(block) {
  var code = 'speaker_init()\n';
  return code;
};
...
Blockly.Arduino["digital_write_ir"] = function (block) {
    var dropdown_pin = block.getFieldValue("PIN");
    var dropdown_stat = Blockly.Arduino.valueToCode(block, "STAT", Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.setups_["setup_output_" + dropdown_pin] = "pinMode(" + dropdown_pin + ", OUTPUT);";
...
Blockly.Arduino["digital_read_mic"] = function (block) {
...
Blockly.Arduino["inout_analog_touch"] = function (block) {
    var dropdown_pin = block.getFieldValue("broche");
    var code = "analogRead(" + dropdown_pin + ")";
    return [code, Blockly.Arduino.ORDER_ATOMIC]
};
Blockly.Arduino["analog_read_mic"] = function (block) {
    var dropdown_pin = block.getFieldValue("broche");
    var code = "analogRead(" + dropdown_pin + ")";
    return [code, Blockly.Arduino.ORDER_ATOMIC]
};
...
Blockly.Java['eeprom_write'] = function(block) {
  var adresse = Blockly.Java.valueToCode(block, 'adr', Blockly.Java.ORDER_ATOMIC) || '';
  var valeur = Blockly.Java.valueToCode(block, 'val', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "eeprom_write(' + adresse + ', ' + valeur + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['eeprom_write'] = function(block) {
  var adresse = Blockly.Python.valueToCode(block, 'adr', Blockly.Python.ORDER_ATOMIC) || '';
  var valeur = Blockly.Python.valueToCode(block, 'val', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'eeprom_write(' + adresse + ', ' + valeur + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['eeprom_read'] = function(block) {
  var adresse = Blockly.Java.valueToCode(block, 'adr', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "eeprom_read(' + adresse + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['eeprom_read'] = function(block) {
  var adresse = Blockly.Python.valueToCode(block, 'adr', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'eeprom_read(' + adresse + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
