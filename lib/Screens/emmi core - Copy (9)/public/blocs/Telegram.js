...
Blockly.Java['telegram_init'] = function(block) {
  var BotToken = block.getFieldValue('BOT_TOKEN') || '';
  var ChatID = block.getFieldValue('CHAT_ID') || '';
  var code = "telegram_init(' + BotToken + ', ' + ChatID + ');\n";
  return code;
};


Blockly.Python['telegram_init'] = function(block) {
  var BotToken = block.getFieldValue('BOT_TOKEN') || '';
  var ChatID = block.getFieldValue('CHAT_ID') || '';
  var code = 'telegram_init(' + BotToken + ', ' + ChatID + ')\n';
  return code;
...
Blockly.Java['telegram_loop_message'] = function(block) {
  var code = "telegram_loop_message();\n";
  return code;
};


Blockly.Python['telegram_loop_message'] = function(block) {
  var code = 'telegram_loop_message()\n';
  return code;
};
...
Blockly.Java['telegram_sendmessage'] = function(block) {
  var texttosend = Blockly.Java.valueToCode(block, 'texttosend', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "telegram_sendmessage(' + texttosend + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['telegram_sendmessage'] = function(block) {
  var texttosend = Blockly.Python.valueToCode(block, 'texttosend', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'telegram_sendmessage(' + texttosend + ')';
...
Blockly.Java['telegram_message_name_received'] = function(block) {
  var code = "telegram_message_name_received()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['telegram_message_name_received'] = function(block) {
  var code = 'telegram_message_name_received()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['telegram_message_received'] = function(block) {
  var code = "telegram_message_received()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['telegram_message_received'] = function(block) {
  var code = 'telegram_message_received()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
