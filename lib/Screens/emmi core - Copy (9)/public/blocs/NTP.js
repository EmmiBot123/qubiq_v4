...
Blockly.Java['Init_NTP'] = function(block) {
  var code = "Init_NTP();\n";
  return code;
};


Blockly.Python['Init_NTP'] = function(block) {
  var code = 'Init_NTP()\n';
  return code;
};
...
Blockly.Java['order_read_NTP_server'] = function(block) {
  var code = "order_read_NTP_server();\n";
  return code;
};


Blockly.Python['order_read_NTP_server'] = function(block) {
  var code = 'order_read_NTP_server()\n';
  return code;
};
...
Blockly.Java['values_NTP_server'] = function(block) {
  var code = "values_NTP_server()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['values_NTP_server'] = function(block) {
  var code = 'values_NTP_server()';
...
Blockly.Java['values_text_NTP_server'] = function(block) {
  var code = "values_text_NTP_server()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['values_text_NTP_server'] = function(block) {
  var code = 'values_text_NTP_server()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
