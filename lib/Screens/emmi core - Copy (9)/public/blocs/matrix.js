...
Blockly.Java['matrix16x8_init'] = function(block) {
  var code = "matrix16x8_init()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['matrix16x8_init'] = function(block) {
  var code = 'matrix16x8_init()';
...
Blockly.Java['eyes_init'] = function(block) {
  var code = "eyes_init();\n";
  return code;
};


Blockly.Python['eyes_init'] = function(block) {
  var code = 'eyes_init()\n';
  return code;
};

Blockly.Blocks['eyes_ESP'] = { init: function() {
  this.appendDummyInput() .appendField(new Blockly.FieldImage('media/eyes.png', 58, 33, "*")).appendField(Blockly.Msg.OTTO_HOME_TEXT + Blockly.Msg.MAX7219_LM_NAME+" "+Blockly.Msg.APDS9960_init2);
  this.setInputsInline(true);
  this.setPreviousStatement(true);
  this.setNextStatement(true);
...
Blockly.Arduino['eyes_ESP'] = function(block) {
  // 1. INCLUDE & DEFINE
  Blockly.Arduino.includes_['ematrix16x8'] = '#include <Wire.h>\n' +
                                              '#include <Adafruit_LEDBackpack.h>\n' +
                                              '#include <Adafruit_GFX.h>\n' + // Often needed for graphics
                                              'Adafruit_8x16matrix ematrix = Adafruit_8x16matrix();';
  
  // 2. SETUP: Force ESP32 pins (21, 22)
  Blockly.Arduino.setups_['ematrix16x8'] = 'Wire.begin(21, 22); // ESP32 I2C Pins\n' +
                                           'ematrix.begin(0x70); // Initialize Matrix at 0x70\n';
  return '';
};

Blockly.Java['eyes_ESP'] = function(block) {
  var code = "eyes_ESP();\n";
  return code;
};


Blockly.Python['eyes_ESP'] = function(block) {
  var code = 'eyes_ESP()\n';
  return code;
};
...
Blockly.Java['eyes_display'] = function(block) {
  var code = "eyes_display();\n";
  return code;
};


Blockly.Python['eyes_display'] = function(block) {
  var code = 'eyes_display()\n';
  return code;
};
...
Blockly.Java['eyes_clear'] = function(block) {
  var code = "eyes_clear();\n";
  return code;
};


Blockly.Python['eyes_clear'] = function(block) {
  var code = 'eyes_clear()\n';
  return code;
};

Blockly.Blocks['eyes_clearesp'] = {init: function() {
  this.appendDummyInput()   .appendField(Blockly.Msg.OTTO9_EYES_CLEAR_TEXT);
  this.setInputsInline(false);
  this.setPreviousStatement(true);
  this.setNextStatement(true);
...
Blockly.Arduino['eyes_clearesp'] = function(block) {
  // 1. Clear the internal memory
  // 2. Push the empty memory to the screen to actually make it go black
  var code = 'display.clearDisplay();\n' +
             'display.display();\n';
  return code;
};

Blockly.Java['eyes_clearesp'] = function(block) {
  var code = "eyes_clearesp();\n";
  return code;
};


Blockly.Python['eyes_clearesp'] = function(block) {
  var code = 'eyes_clearesp()\n';
  return code;
};
...
Blockly.Java['matrizled_clear2'] = function(block) {
  var code = "matrizled_clear2();\n";
  return code;
};


Blockly.Python['matrizled_clear2'] = function(block) {
  var code = 'matrizled_clear2()\n';
  return code;
};
...
Blockly.Java['eyes_rotate'] = function(block) {
  var angle = block.getFieldValue('angle') || '';
  var code = "eyes_rotate(' + angle + ');\n";
  return code;
};


Blockly.Python['eyes_rotate'] = function(block) {
  var angle = block.getFieldValue('angle') || '';
  var code = 'eyes_rotate(' + angle + ')\n';
  return code;
};
...
Blockly.Java['eyes_blink'] = function(block) {
  var rate = block.getFieldValue('rate') || '';
  var code = "eyes_blink(' + rate + ');\n";
  return code;
};


Blockly.Python['eyes_blink'] = function(block) {
  var rate = block.getFieldValue('rate') || '';
  var code = 'eyes_blink(' + rate + ')\n';
  return code;
};
...
Blockly.Java['eyes_face'] = function(block) {
  var dropdown_otto9_eyes_choice = block.getFieldValue('otto9_eyes_choice') || '';
  var code = "eyes_face(' + dropdown_otto9_eyes_choice + ');\n";
  return code;
};


Blockly.Python['eyes_face'] = function(block) {
  var dropdown_otto9_eyes_choice = block.getFieldValue('otto9_eyes_choice') || '';
  var code = 'eyes_face(' + dropdown_otto9_eyes_choice + ')\n';
  return code;
};

Blockly.Blocks['eyes_faceesp'] = { init: function() {
  this.appendDummyInput()  .appendField("👀 "+Blockly.Msg.OTTO9_EYES_TEXT)  .appendField(new Blockly.FieldDropdown(Blockly.Msg.OTTO9_EYES_CHOICE), "otto9_eyes_choice");
  this.setInputsInline(true);
  this.setPreviousStatement(true);
  this.setNextStatement(true);
...
Blockly.Arduino['eyes_faceesp'] = function(block) {
  var dropdown = block.getFieldValue('otto9_eyes_choice');

  // 1. DEFINE BITMAPS
  Blockly.Arduino.definitions_['otto_bitmaps'] = 
    'const uint8_t eyes_bmp[] = {0x00,0x3c,0x42,0x4a,0x42,0x42,0x3c,0x00,0x00,0x3c,0x42,0x4a,0x42,0x42,0x3c,0x00};\n' +
    'const uint8_t happy_bmp[] = {0x00,0x3c,0x02,0x02,0x02,0x02,0x3c,0x00,0x00,0x3c,0x02,0x02,0x02,0x02,0x3c,0x00};\n' +
    'const uint8_t sad_bmp[] = {0x00,0x38,0x78,0x60,0x60,0x78,0x38,0x00,0x00,0x38,0x78,0x60,0x60,0x78,0x38,0x00};\n' +
    'const uint8_t angry_bmp[] = {0x00,0x1e,0x3c,0x78,0x70,0x20,0x00,0x00,0x00,0x00,0x20,0x70,0x78,0x3c,0x1e,0x00};\n' +
    'const uint8_t love_bmp[] = {0x00,0x0c,0x1e,0x3c,0x3c,0x1e,0x0c,0x00,0x00,0x0c,0x1e,0x3c,0x3c,0x1e,0x0c,0x00};\n' +
    'const uint8_t sleep_bmp[] = {0x00,0x22,0x32,0x2a,0x26,0x22,0x00,0x00,0x00,0x00,0x22,0x32,0x2a,0x26,0x22,0x00};\n' +
    'const uint8_t wave_bmp[] = {0x1c,0x38,0x70,0x38,0x1c,0x38,0x70,0x00,0x00,0x1c,0x38,0x70,0x38,0x1c,0x38,0x70};\n' +
    'const uint8_t fail_bmp[] = {0xe0,0x70,0x38,0x1c,0x0e,0x07,0x00,0x00,0x00,0x00,0x07,0x0e,0x1c,0x38,0x70,0xe0};\n' +
    'const uint8_t magic_bmp[] = {0x00,0x00,0x7e,0xff,0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x7e,0xff,0x7e,0x00,0x00};\n';

  // 2. DEFINE DRAW FUNCTION (6x SCALE + ROTATION)
  Blockly.Arduino.definitions_['drawScaled'] = 
    'void drawScaled(const uint8_t *bitmap) {\n' +
    '  // LEFT EYE: Start X=11, Y=8 (Centered vertically) \n' +
    '  for (int col=0; col<8; col++) {\n' +
    '    uint8_t data = bitmap[col];\n' +
    '    for (int row=0; row<8; row++) {\n' +
    '       // Draw 6x6 pixel blocks \n' +
    '       if (data & (1<<row)) display.fillRect(11 + col*6, 8 + row*6, 6, 6, SH110X_WHITE);\n' +
    '    }\n' +
    '  }\n' +
    '  // RIGHT EYE: Start X=69 (Includes gap), Y=8 \n' +
    '  for (int col=0; col<8; col++) {\n' +
    '    uint8_t data = bitmap[col+8];\n' +
    '    for (int row=0; row<8; row++) {\n' +
    '       if (data & (1<<row)) display.fillRect(69 + col*6, 8 + row*6, 6, 6, SH110X_WHITE);\n' +
    '    }\n' +
    '  }\n' +
    '}\n';

  // 3. SELECT MAP
  var mapName = "eyes_bmp";
  if (dropdown.indexOf("happy") != -1) mapName = "happy_bmp";
  if (dropdown.indexOf("sad") != -1) mapName = "sad_bmp";
  if (dropdown.indexOf("angry") != -1) mapName = "angry_bmp";
  if (dropdown.indexOf("love") != -1) mapName = "love_bmp";
  if (dropdown.indexOf("sleep") != -1) mapName = "sleep_bmp";
  if (dropdown.indexOf("wave") != -1) mapName = "wave_bmp";
  if (dropdown.indexOf("fail") != -1) mapName = "fail_bmp";
  if (dropdown.indexOf("magic") != -1) mapName = "magic_bmp";
...
Blockly.Java['eyes_faceesp'] = function(block) {
  var dropdown = block.getFieldValue('otto9_eyes_choice') || '';
  var code = "eyes_faceesp(' + dropdown + ');\n";
  return code;
};


Blockly.Python['eyes_faceesp'] = function(block) {
  var dropdown = block.getFieldValue('otto9_eyes_choice') || '';
  var code = 'eyes_faceesp(' + dropdown + ')\n';
  return code;
};
...
Blockly.Java['eyes_text'] = function(block) {
  var text_input = block.getFieldValue('input') || '';
  var code = "eyes_text(' + text_input + ');\n";
  return code;
};


Blockly.Python['eyes_text'] = function(block) {
  var text_input = block.getFieldValue('input') || '';
  var code = 'eyes_text(' + text_input + ')\n';
  return code;
};
...
Blockly.Java['eyes#'] = function(block) {
  var value_eyes = Blockly.Java.valueToCode(block, 'eyes', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "eyes#(' + value_eyes + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['eyes#'] = function(block) {
  var value_eyes = Blockly.Python.valueToCode(block, 'eyes', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'eyes#(' + value_eyes + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['eyesp'] = function(block) {
  var valuex = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "eyesp(' + valuex + ', ' + valuey + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['eyesp'] = function(block) {
...
Blockly.Java['eyesl'] = function(block) {
  var valuex1 = Blockly.Java.valueToCode(block, 'X1', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey1 = Blockly.Java.valueToCode(block, 'Y1', Blockly.Java.ORDER_ATOMIC) || '';
  var valuex2 = Blockly.Java.valueToCode(block, 'X2', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey2 = Blockly.Java.valueToCode(block, 'Y2', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "eyesl(' + valuex1 + ', ' + valuey1 + ', ' + valuex2 + ', ' + valuey2 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['eyesl'] = function(block) {
  var valuex1 = Blockly.Python.valueToCode(block, 'X1', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey1 = Blockly.Python.valueToCode(block, 'Y1', Blockly.Python.ORDER_ATOMIC) || '';
  var valuex2 = Blockly.Python.valueToCode(block, 'X2', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey2 = Blockly.Python.valueToCode(block, 'Y2', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'eyesl(' + valuex1 + ', ' + valuey1 + ', ' + valuex2 + ', ' + valuey2 + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['eyesr'] = function(block) {
  var valuex1 = Blockly.Java.valueToCode(block, 'X1', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey1 = Blockly.Java.valueToCode(block, 'Y1', Blockly.Java.ORDER_ATOMIC) || '';
  var valuex2 = Blockly.Java.valueToCode(block, 'X2', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey2 = Blockly.Java.valueToCode(block, 'Y2', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "eyesr(' + valuex1 + ', ' + valuey1 + ', ' + valuex2 + ', ' + valuey2 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['eyesr'] = function(block) {
  var valuex1 = Blockly.Python.valueToCode(block, 'X1', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey1 = Blockly.Python.valueToCode(block, 'Y1', Blockly.Python.ORDER_ATOMIC) || '';
  var valuex2 = Blockly.Python.valueToCode(block, 'X2', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey2 = Blockly.Python.valueToCode(block, 'Y2', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['eyesc'] = function(block) {
  var valuex = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var valuer = Blockly.Java.valueToCode(block, 'R', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "eyesc(' + valuex + ', ' + valuey + ', ' + valuer + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['eyesc'] = function(block) {
  var valuex = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var valuer = Blockly.Python.valueToCode(block, 'R', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'eyesc(' + valuex + ', ' + valuey + ', ' + valuer + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['eyesm'] = function(block) {
  var code = "eyesm();\n";
  return code;
};


Blockly.Python['eyesm'] = function(block) {
  var code = 'eyesm()\n';
  return code;
};
...
Blockly.Java['matrizledm2_old'] = function(block) {
  var code = "matrizledm2_old();\n";
  return code;
};


Blockly.Python['matrizledm2_old'] = function(block) {
  var code = 'matrizledm2_old()\n';
  return code;
};
...
Blockly.Java['GFX_matrix_init'] = function(block) {
  var code = "GFX_matrix_init();\n";
  return code;
};


Blockly.Python['GFX_matrix_init'] = function(block) {
  var code = 'GFX_matrix_init()\n';
  return code;
};
...
Blockly.Java['GFX_OLED_init'] = function(block) {
  var value_address = block.getFieldValue('address') || '';
  var code = "GFX_OLED_init(' + value_address + ');\n";
  return code;
};


Blockly.Python['GFX_OLED_init'] = function(block) {
  var value_address = block.getFieldValue('address') || '';
  var code = 'GFX_OLED_init(' + value_address + ')\n';
  return code;
};
...
Blockly.Java['GFX_OLED_init2'] = function(block) {
  var value_address = block.getFieldValue('address') || '';
  var code = "GFX_OLED_init2(' + value_address + ');\n";
  return code;
};


Blockly.Python['GFX_OLED_init2'] = function(block) {
  var value_address = block.getFieldValue('address') || '';
  var code = 'GFX_OLED_init2(' + value_address + ')\n';
  return code;
};
...
Blockly.Java['GFX_display'] = function(block) {
  var code = "GFX_display();\n";
  return code;
};


Blockly.Python['GFX_display'] = function(block) {
  var code = 'GFX_display()\n';
  return code;
};
...
Blockly.Java['GFX_clear'] = function(block) {
  var code = "GFX_clear();\n";
  return code;
};


Blockly.Python['GFX_clear'] = function(block) {
  var code = 'GFX_clear()\n';
  return code;
};
...
Blockly.Java['GFX_pixel'] = function(block) {
  var valuex = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "GFX_pixel(' + valuex + ', ' + valuey + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['GFX_pixel'] = function(block) {
  var valuex = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'GFX_pixel(' + valuex + ', ' + valuey + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
...
Blockly.Java['GFX_line'] = function(block) {
  var valuex1 = Blockly.Java.valueToCode(block, 'X1', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey1 = Blockly.Java.valueToCode(block, 'Y1', Blockly.Java.ORDER_ATOMIC) || '';
  var valuex2 = Blockly.Java.valueToCode(block, 'X2', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey2 = Blockly.Java.valueToCode(block, 'Y2', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "GFX_line(' + valuex1 + ', ' + valuey1 + ', ' + valuex2 + ', ' + valuey2 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['GFX_line'] = function(block) {
  var valuex1 = Blockly.Python.valueToCode(block, 'X1', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey1 = Blockly.Python.valueToCode(block, 'Y1', Blockly.Python.ORDER_ATOMIC) || '';
  var valuex2 = Blockly.Python.valueToCode(block, 'X2', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey2 = Blockly.Python.valueToCode(block, 'Y2', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['GFX_rectangle'] = function(block) {
  var valuex1 = Blockly.Java.valueToCode(block, 'X1', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey1 = Blockly.Java.valueToCode(block, 'Y1', Blockly.Java.ORDER_ATOMIC) || '';
  var valuex2 = Blockly.Java.valueToCode(block, 'X2', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey2 = Blockly.Java.valueToCode(block, 'Y2', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "GFX_rectangle(' + valuex1 + ', ' + valuey1 + ', ' + valuex2 + ', ' + valuey2 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['GFX_rectangle'] = function(block) {
  var valuex1 = Blockly.Python.valueToCode(block, 'X1', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey1 = Blockly.Python.valueToCode(block, 'Y1', Blockly.Python.ORDER_ATOMIC) || '';
  var valuex2 = Blockly.Python.valueToCode(block, 'X2', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey2 = Blockly.Python.valueToCode(block, 'Y2', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['GFX_circle'] = function(block) {
  var valuex = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var valuey = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var valuer = Blockly.Java.valueToCode(block, 'R', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "GFX_circle(' + valuex + ', ' + valuey + ', ' + valuer + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['GFX_circle'] = function(block) {
  var valuex = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var valuey = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var valuer = Blockly.Python.valueToCode(block, 'R', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'GFX_circle(' + valuex + ', ' + valuey + ', ' + valuer + ')';
...
Blockly.Java['GFX_bitmap'] = function(block) {
  var x0 = Blockly.Java.valueToCode(block, 'x0', Blockly.Java.ORDER_ATOMIC) || '';
  var y0 = Blockly.Java.valueToCode(block, 'y0', Blockly.Java.ORDER_ATOMIC) || '';
  var width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var IconName = block.getFieldValue('NAME') || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = "GFX_bitmap(' + x0 + ', ' + y0 + ', ' + width + ', ' + height + ', ' + IconName + ', ' + Color + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['GFX_bitmap'] = function(block) {
