...
Blockly.Java['Init_generalremotecontrol'] = function(block) {
  var code = "Init_generalremotecontrol()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['Init_generalremotecontrol'] = function(block) {
  var code = 'Init_generalremotecontrol()';
...
Blockly.Java['IR_Remote_Key'] = function(block) {
  var code = "IR_Remote_Key()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['IR_Remote_Key'] = function(block) {
  var code = 'IR_Remote_Key()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Init_remotecontrolMRT'] = function(block) {
  var pin_ir = block.getFieldValue('PIN_IR') || '';
  var code = "Init_remotecontrolMRT(' + pin_ir + ');\n";
  return code;
};


Blockly.Python['Init_remotecontrolMRT'] = function(block) {
  var pin_ir = block.getFieldValue('PIN_IR') || '';
  var code = 'Init_remotecontrolMRT(' + pin_ir + ')\n';
  return code;
};
...
Blockly.Java['IR_RemoteMRT_Key'] = function(block) {
  var code = "IR_RemoteMRT_Key()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['IR_RemoteMRT_Key'] = function(block) {
  var code = 'IR_RemoteMRT_Key()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Init_remotecontrolMRTNode'] = function(block) {
  var pin_ir = block.getFieldValue('PIN_IR') || '';
  var code = "Init_remotecontrolMRTNode(' + pin_ir + ');\n";
  return code;
};


Blockly.Python['Init_remotecontrolMRTNode'] = function(block) {
  var pin_ir = block.getFieldValue('PIN_IR') || '';
  var code = 'Init_remotecontrolMRTNode(' + pin_ir + ')\n';
  return code;
};
...
Blockly.Java['IR_RemoteMRT_Key_Node'] = function(block) {
  var code = "IR_RemoteMRT_Key_Node()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['IR_RemoteMRT_Key_Node'] = function(block) {
  var code = 'IR_RemoteMRT_Key_Node()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Init_remotecontrolMRTNodeIL'] = function(block) {
  var pin_ir = block.getFieldValue('PIN_IR') || '';
  var code = "Init_remotecontrolMRTNodeIL(' + pin_ir + ');\n";
  return code;
};


Blockly.Python['Init_remotecontrolMRTNodeIL'] = function(block) {
  var pin_ir = block.getFieldValue('PIN_IR') || '';
  var code = 'Init_remotecontrolMRTNodeIL(' + pin_ir + ')\n';
  return code;
};
...
Blockly.Java['IR_RemoteMRT_Key_NodeIL'] = function(block) {
  var code = "IR_RemoteMRT_Key_NodeIL()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['IR_RemoteMRT_Key_NodeIL'] = function(block) {
  var code = 'IR_RemoteMRT_Key_NodeIL()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['Attend_remotecontrolMRTNodeIL'] = function(block) {
  var code = "Attend_remotecontrolMRTNodeIL();\n";
  return code;
};


Blockly.Python['Attend_remotecontrolMRTNodeIL'] = function(block) {
  var code = 'Attend_remotecontrolMRTNodeIL()\n';
  return code;
};
