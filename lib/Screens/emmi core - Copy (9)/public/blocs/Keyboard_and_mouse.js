...
Blockly.Java['keyboard_function'] = function(block) {
  var SelectedKey = Blockly.Java.valueToCode(block, 'SelectedKey', Blockly.Java.ORDER_ATOMIC) || '';
  var key_function = block.getFieldValue('KEY_FUN') || '';
  var code = "keyboard_function(' + SelectedKey + ', ' + key_function + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['keyboard_function'] = function(block) {
  var SelectedKey = Blockly.Python.valueToCode(block, 'SelectedKey', Blockly.Python.ORDER_ATOMIC) || '';
  var key_function = block.getFieldValue('KEY_FUN') || '';
  var code = 'keyboard_function(' + SelectedKey + ', ' + key_function + ')';
...
Blockly.Java['key_pressed'] = function(block) {
  var code = "key_pressed()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['keyboard_text'] = function(block) {
  var value_texttoprint = Blockly.Java.valueToCode(block, 'texttoprint', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "keyboard_text(' + value_texttoprint + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['keyboard_text'] = function(block) {
  var value_texttoprint = Blockly.Python.valueToCode(block, 'texttoprint', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'keyboard_text(' + value_texttoprint + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['mouse_function'] = function(block) {
  var mouse_button = block.getFieldValue('MOUSE_BUTTON') || '';
  var mouse_button2 = block.getFieldValue('MOUSE_BUTTON2') || '';
  var code = "mouse_function(' + mouse_button + ', ' + mouse_button2 + ');\n";
  return code;
};


Blockly.Python['mouse_function'] = function(block) {
  var mouse_button = block.getFieldValue('MOUSE_BUTTON') || '';
  var mouse_button2 = block.getFieldValue('MOUSE_BUTTON2') || '';
  var code = 'mouse_function(' + mouse_button + ', ' + mouse_button2 + ')\n';
  return code;
...
Blockly.Java['mouse_move'] = function(block) {
  var mouse_move_x = Blockly.Java.valueToCode(block, 'axis_x', Blockly.Java.ORDER_ATOMIC) || '';
  var mouse_move_y = Blockly.Java.valueToCode(block, 'axis_y', Blockly.Java.ORDER_ATOMIC) || '';
  var mouse_move_w = Blockly.Java.valueToCode(block, 'wheel', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "mouse_move(' + mouse_move_x + ', ' + mouse_move_y + ', ' + mouse_move_w + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['mouse_move'] = function(block) {
  var mouse_move_x = Blockly.Python.valueToCode(block, 'axis_x', Blockly.Python.ORDER_ATOMIC) || '';
  var mouse_move_y = Blockly.Python.valueToCode(block, 'axis_y', Blockly.Python.ORDER_ATOMIC) || '';
  var mouse_move_w = Blockly.Python.valueToCode(block, 'wheel', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'mouse_move(' + mouse_move_x + ', ' + mouse_move_y + ', ' + mouse_move_w + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['keyboard_function_esp32'] = function(block) {
  var SelectedKey = Blockly.Java.valueToCode(block, 'SelectedKey', Blockly.Java.ORDER_ATOMIC) || '';
  var key_function = block.getFieldValue('KEY_FUN') || '';
  var code = "keyboard_function_esp32(' + SelectedKey + ', ' + key_function + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['keyboard_function_esp32'] = function(block) {
  var SelectedKey = Blockly.Python.valueToCode(block, 'SelectedKey', Blockly.Python.ORDER_ATOMIC) || '';
  var key_function = block.getFieldValue('KEY_FUN') || '';
  var code = 'keyboard_function_esp32(' + SelectedKey + ', ' + key_function + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
...
Blockly.Java['keyboard_text_esp32'] = function(block) {
  var value_texttoprint = Blockly.Java.valueToCode(block, 'texttoprint', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "keyboard_text_esp32(' + value_texttoprint + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['keyboard_text_esp32'] = function(block) {
  var value_texttoprint = Blockly.Python.valueToCode(block, 'texttoprint', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'keyboard_text_esp32(' + value_texttoprint + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['mouse_function_esp32'] = function(block) {
  var mouse_button = block.getFieldValue('MOUSE_BUTTON') || '';
  var mouse_button2 = block.getFieldValue('MOUSE_BUTTON2') || '';
  var code = "mouse_function_esp32(' + mouse_button + ', ' + mouse_button2 + ');\n";
  return code;
};


Blockly.Python['mouse_function_esp32'] = function(block) {
  var mouse_button = block.getFieldValue('MOUSE_BUTTON') || '';
  var mouse_button2 = block.getFieldValue('MOUSE_BUTTON2') || '';
  var code = 'mouse_function_esp32(' + mouse_button + ', ' + mouse_button2 + ')\n';
  return code;
...
Blockly.Java['mouse_move_esp32'] = function(block) {
  var mouse_move_x = Blockly.Java.valueToCode(block, 'axis_x', Blockly.Java.ORDER_ATOMIC) || '';
  var mouse_move_y = Blockly.Java.valueToCode(block, 'axis_y', Blockly.Java.ORDER_ATOMIC) || '';
  var mouse_move_w = Blockly.Java.valueToCode(block, 'wheel', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "mouse_move_esp32(' + mouse_move_x + ', ' + mouse_move_y + ', ' + mouse_move_w + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['mouse_move_esp32'] = function(block) {
  var mouse_move_x = Blockly.Python.valueToCode(block, 'axis_x', Blockly.Python.ORDER_ATOMIC) || '';
  var mouse_move_y = Blockly.Python.valueToCode(block, 'axis_y', Blockly.Python.ORDER_ATOMIC) || '';
  var mouse_move_w = Blockly.Python.valueToCode(block, 'wheel', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'mouse_move_esp32(' + mouse_move_x + ', ' + mouse_move_y + ', ' + mouse_move_w + ')';
