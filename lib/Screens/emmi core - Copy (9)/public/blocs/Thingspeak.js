...
Blockly.Java['thingspeak_init'] = function(block) {
  var Channel = block.getFieldValue('CHANNEL') || '';
  var APIWriteKey = block.getFieldValue('API_WRITE_KEY') || '';
  var APIReadKey = block.getFieldValue('API_READ_KEY') || '';
  var code = "thingspeak_init(' + Channel + ', ' + APIWriteKey + ', ' + APIReadKey + ');\n";
  return code;
};


Blockly.Python['thingspeak_init'] = function(block) {
  var Channel = block.getFieldValue('CHANNEL') || '';
  var APIWriteKey = block.getFieldValue('API_WRITE_KEY') || '';
  var APIReadKey = block.getFieldValue('API_READ_KEY') || '';
  var code = 'thingspeak_init(' + Channel + ', ' + APIWriteKey + ', ' + APIReadKey + ')\n';
...
Blockly.Java['thingspeak_write'] = function(block) {
  var variable = Blockly.Java.valueToCode(block, 'variable', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "thingspeak_write(' + variable + ')";
...
Blockly.Java['thingspeak_write_long'] = function(block) {
  var code = "thingspeak_write_long()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['thingspeak_write_long'] = function(block) {
  var code = 'thingspeak_write_long()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['thingspeak_write_float'] = function(block) {
  var code = "thingspeak_write_float()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['thingspeak_write_float'] = function(block) {
  var code = 'thingspeak_write_float()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
