...
Blockly.Java['rgb_set'] = function(block) {
  var value_r = Blockly.Java.valueToCode(block, 'r', Blockly.Java.ORDER_ATOMIC) || '';
  var value_v = Blockly.Java.valueToCode(block, 'v', Blockly.Java.ORDER_ATOMIC) || '';
  var value_b = Blockly.Java.valueToCode(block, 'b', Blockly.Java.ORDER_ATOMIC) || '';
