...
Blockly.Java['st7735_init'] = function(block) {
  var wrap = block.getFieldValue('WRAP') || '';
  var code = "st7735_init(' + wrap + ');\n";
  return code;
};


Blockly.Python['st7735_init'] = function(block) {
  var wrap = block.getFieldValue('WRAP') || '';
  var code = 'st7735_init(' + wrap + ')\n';
  return code;
};
...
Blockly.Java['st7735_backgroundcolor'] = function(block) {
  var Color = block.getFieldValue('COLOR') || '';
  var code = "st7735_backgroundcolor(' + Color + ');\n";
  return code;
};


Blockly.Python['st7735_backgroundcolor'] = function(block) {
  var Color = block.getFieldValue('COLOR') || '';
  var code = 'st7735_backgroundcolor(' + Color + ')\n';
  return code;
};
...
Blockly.Java['st7735_icon'] = function(block) {
  var IconName = block.getFieldValue('NAME') || '';
  var Var_Codes = block.getFieldValue('CODES') || '';
  var code = "st7735_icon(' + IconName + ', ' + Var_Codes + ');\n";
  return code;
};


Blockly.Python['st7735_icon'] = function(block) {
  var IconName = block.getFieldValue('NAME') || '';
  var Var_Codes = block.getFieldValue('CODES') || '';
  var code = 'st7735_icon(' + IconName + ', ' + Var_Codes + ')\n';
  return code;
...
Blockly.Java['st7735_rotatedisplay'] = function(block) {
  var Degree = block.getFieldValue('DEGREE') || '';
  var code = "st7735_rotatedisplay(' + Degree + ');\n";
  return code;
};


Blockly.Python['st7735_rotatedisplay'] = function(block) {
  var Degree = block.getFieldValue('DEGREE') || '';
  var code = 'st7735_rotatedisplay(' + Degree + ')\n';
  return code;
};
...
Blockly.Java['st7735_invertdisplay'] = function(block) {
  var InvertON_OFF = block.getFieldValue('INVERT_DISPLAY') || '';
  var code = "st7735_invertdisplay(' + InvertON_OFF + ');\n";
  return code;
};


Blockly.Python['st7735_invertdisplay'] = function(block) {
  var InvertON_OFF = block.getFieldValue('INVERT_DISPLAY') || '';
  var code = 'st7735_invertdisplay(' + InvertON_OFF + ')\n';
  return code;
};
...
Blockly.Java['st7735_setcursor'] = function(block) {
  ...
  var code = "st7735_setcursor(' + x0 + ', ' + y0 + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_setcursor'] = function(block) {
...
Blockly.Java['st7735_settextcolor'] = function(block) {
  var Color = block.getFieldValue('COLOR') || '';
  var code = "st7735_settextcolor(' + Color + ');\n";
  return code;
};


Blockly.Python['st7735_settextcolor'] = function(block) {
  var Color = block.getFieldValue('COLOR') || '';
  var code = 'st7735_settextcolor(' + Color + ')\n';
  return code;
};
...
Blockly.Java['st7735_settextsize'] = function(block) {
  var size = block.getFieldValue('SIZE') || '';
  var code = "st7735_settextsize(' + size + ');\n";
  return code;
};


Blockly.Python['st7735_settextsize'] = function(block) {
  var size = block.getFieldValue('SIZE') || '';
  var code = 'st7735_settextsize(' + size + ')\n';
  return code;
};
...
Blockly.Java['st7735_wraptext'] = function(block) {
  var wrapON_OFF = block.getFieldValue('WRAPTEXT') || '';
  var code = "st7735_wraptext(' + wrapON_OFF + ');\n";
  return code;
};


Blockly.Python['st7735_wraptext'] = function(block) {
  var wrapON_OFF = block.getFieldValue('WRAPTEXT') || '';
  var code = 'st7735_wraptext(' + wrapON_OFF + ')\n';
  return code;
};
...
Blockly.Java['st7735_printTextln'] = function(block) {
  var texttoprint = Blockly.Java.valueToCode(block, 'text_to_print', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "st7735_printTextln(' + texttoprint + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_printTextln'] = function(block) {
  var texttoprint = Blockly.Python.valueToCode(block, 'text_to_print', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'st7735_printTextln(' + texttoprint + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['st7735_drawpixel'] = function(block) {
  var x0 = Blockly.Java.valueToCode(block, 'x0', Blockly.Java.ORDER_ATOMIC) || '';
  var y0 = Blockly.Java.valueToCode(block, 'y0', Blockly.Java.ORDER_ATOMIC) || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = "st7735_drawpixel(' + x0 + ', ' + y0 + ', ' + Color + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_drawpixel'] = function(block) {
  var x0 = Blockly.Python.valueToCode(block, 'x0', Blockly.Python.ORDER_ATOMIC) || '';
  var y0 = Blockly.Python.valueToCode(block, 'y0', Blockly.Python.ORDER_ATOMIC) || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = 'st7735_drawpixel(' + x0 + ', ' + y0 + ', ' + Color + ')';
...
Blockly.Java['st7735_drawline'] = function(block) {
  var x0 = Blockly.Java.valueToCode(block, 'x0', Blockly.Java.ORDER_ATOMIC) || '';
  var y0 = Blockly.Java.valueToCode(block, 'y0', Blockly.Java.ORDER_ATOMIC) || '';
  var x1 = Blockly.Java.valueToCode(block, 'x1', Blockly.Java.ORDER_ATOMIC) || '';
  var y1 = Blockly.Java.valueToCode(block, 'y1', Blockly.Java.ORDER_ATOMIC) || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = "st7735_drawline(' + x0 + ', ' + y0 + ', ' + x1 + ', ' + y1 + ', ' + Color + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_drawline'] = function(block) {
  var x0 = Blockly.Python.valueToCode(block, 'x0', Blockly.Python.ORDER_ATOMIC) || '';
  var y0 = Blockly.Python.valueToCode(block, 'y0', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['st7735_drawrectangle'] = function(block) {
  var x0 = Blockly.Java.valueToCode(block, 'x0', Blockly.Java.ORDER_ATOMIC) || '';
  var y0 = Blockly.Java.valueToCode(block, 'y0', Blockly.Java.ORDER_ATOMIC) || '';
  ...
  var Color = block.getFieldValue('COLOR') || '';
  var code = "st7735_drawrectangle(' + x0 + ', ' + y0 + ', ' + width + ', ' + height + ', ' + Color + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_drawrectangle'] = function(block) {
  var x0 = Blockly.Python.valueToCode(block, 'x0', Blockly.Python.ORDER_ATOMIC) || '';
  var y0 = Blockly.Python.valueToCode(block, 'y0', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['st7735_drawroundrectangle'] = function(block) {
  var x0 = Blockly.Java.valueToCode(block, 'x0', Blockly.Java.ORDER_ATOMIC) || '';
  var y0 = Blockly.Java.valueToCode(block, 'y0', Blockly.Java.ORDER_ATOMIC) || '';
  var width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var round = Blockly.Java.valueToCode(block, 'round', Blockly.Java.ORDER_ATOMIC) || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = "st7735_drawroundrectangle(' + x0 + ', ' + y0 + ', ' + width + ', ' + height + ', ' + round + ', ' + Color + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_drawroundrectangle'] = function(block) {
  var x0 = Blockly.Python.valueToCode(block, 'x0', Blockly.Python.ORDER_ATOMIC) || '';
  var y0 = Blockly.Python.valueToCode(block, 'y0', Blockly.Python.ORDER_ATOMIC) || '';
  var width = Blockly.Python.valueToCode(block, 'width', Blockly.Python.ORDER_ATOMIC) || '';
  var height = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
  var round = Blockly.Python.valueToCode(block, 'round', Blockly.Python.ORDER_ATOMIC) || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = 'st7735_drawroundrectangle(' + x0 + ', ' + y0 + ', ' + width + ', ' + height + ', ' + round + ', ' + Color + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['st7735_drawcircle'] = function(block) {
  var x0 = Blockly.Java.valueToCode(block, 'x0', Blockly.Java.ORDER_ATOMIC) || '';
  var y0 = Blockly.Java.valueToCode(block, 'y0', Blockly.Java.ORDER_ATOMIC) || '';
  var radius = Blockly.Java.valueToCode(block, 'radius', Blockly.Java.ORDER_ATOMIC) || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = "st7735_drawcircle(' + x0 + ', ' + y0 + ', ' + radius + ', ' + Color + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_drawcircle'] = function(block) {
  var x0 = Blockly.Python.valueToCode(block, 'x0', Blockly.Python.ORDER_ATOMIC) || '';
  var y0 = Blockly.Python.valueToCode(block, 'y0', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['st7735_drawtriangle'] = function(block) {
  var x0 = Blockly.Java.valueToCode(block, 'x0', Blockly.Java.ORDER_ATOMIC) || '';
  var y0 = Blockly.Java.valueToCode(block, 'y0', Blockly.Java.ORDER_ATOMIC) || '';
  var x1 = Blockly.Java.valueToCode(block, 'x1', Blockly.Java.ORDER_ATOMIC) || '';
  var y1 = Blockly.Java.valueToCode(block, 'y1', Blockly.Java.ORDER_ATOMIC) || '';
  var x2 = Blockly.Java.valueToCode(block, 'x2', Blockly.Java.ORDER_ATOMIC) || '';
  var y2 = Blockly.Java.valueToCode(block, 'y2', Blockly.Java.ORDER_ATOMIC) || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = "st7735_drawtriangle(' + x0 + ', ' + y0 + ', ' + x1 + ', ' + y1 + ', ' + x2 + ', ' + y2 + ', ' + Color + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_drawtriangle'] = function(block) {
  var x0 = Blockly.Python.valueToCode(block, 'x0', Blockly.Python.ORDER_ATOMIC) || '';
  var y0 = Blockly.Python.valueToCode(block, 'y0', Blockly.Python.ORDER_ATOMIC) || '';
  var x1 = Blockly.Python.valueToCode(block, 'x1', Blockly.Python.ORDER_ATOMIC) || '';
  var y1 = Blockly.Python.valueToCode(block, 'y1', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['st7735_properties'] = function(block) {
  var property = block.getFieldValue('Property') || '';
  var code = "st7735_properties(' + property + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_properties'] = function(block) {
  var property = block.getFieldValue('Property') || '';
  var code = 'st7735_properties(' + property + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['st7735_drawicon'] = function(block) {
  var x0 = Blockly.Java.valueToCode(block, 'x0', Blockly.Java.ORDER_ATOMIC) || '';
  var y0 = Blockly.Java.valueToCode(block, 'y0', Blockly.Java.ORDER_ATOMIC) || '';
  var width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var IconName = block.getFieldValue('NAME') || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = "st7735_drawicon(' + x0 + ', ' + y0 + ', ' + width + ', ' + height + ', ' + IconName + ', ' + Color + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['st7735_drawicon'] = function(block) {
  var x0 = Blockly.Python.valueToCode(block, 'x0', Blockly.Python.ORDER_ATOMIC) || '';
  var y0 = Blockly.Python.valueToCode(block, 'y0', Blockly.Python.ORDER_ATOMIC) || '';
  var width = Blockly.Python.valueToCode(block, 'width', Blockly.Python.ORDER_ATOMIC) || '';
  var height = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['st7735_init_esp32'] = function(block) {
  var wrap = block.getFieldValue('WRAP') || '';
  var code = "st7735_init_esp32(' + wrap + ');\n";
  return code;
};


Blockly.Python['st7735_init_esp32'] = function(block) {
  var wrap = block.getFieldValue('WRAP') || '';
  var code = 'st7735_init_esp32(' + wrap + ')\n';
  return code;
};
