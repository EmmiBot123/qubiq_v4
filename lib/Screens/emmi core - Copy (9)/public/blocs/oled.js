...
Blockly.Java['OLED_init'] = function(block) {
  var value_height = block.getFieldValue('height') || '';
  var value_address = block.getFieldValue('address') || '';
  var code = "OLED_init(' + value_height + ', ' + value_address + ');\n";
  return code;
};
...
Blockly.Java['OLED_init2'] = function(block) {
  var value_address = block.getFieldValue('address') || '';
  var code = "OLED_init2(' + value_address + ');\n";
  return code;
};


Blockly.Python['OLED_init2'] = function(block) {
  var value_address = block.getFieldValue('address') || '';
  var code = 'OLED_init2(' + value_address + ')\n';
  return code;
};
...
Blockly.Blocks['OLED_cust'] = {
  init: function() {
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage('media/oled.png', 33, 33, "*"))
      .appendField("Init OLED 1.3'' I²C (ESP32)"); // Clear label
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour("#B655F5");
...
Blockly.Arduino['OLED_cust'] = function(block) {
  // 1. INCLUDE
  Blockly.Arduino.includes_['OLED'] = '#include <Wire.h>\n' +
                                      '#include <Adafruit_GFX.h>\n' +
                                      '#include <Adafruit_SH110X.h>';

  // 2. DEFINITION
  Blockly.Arduino.definitions_['OLED'] = 'Adafruit_SH1106G display = Adafruit_SH1106G(128, 64, &Wire, -1);';

  // 3. SETUP
  Blockly.Arduino.setups_['OLED'] = 'Wire.begin(21, 22);\n' +
                                    'delay(100);\n' + 
                                    'display.begin(0x3C, true);\n' + 
                                    'display.setRotation(0); // CHANGED TO 0 (Correct for Pins at Top)\n' + 
                                    'display.clearDisplay();\n' +
                                    'display.display();\n';
  return "";
};

Blockly.Java['OLED_cust'] = function(block) {
  var code = "OLED_cust();\n";
  return code;
};


Blockly.Python['OLED_cust'] = function(block) {
  var code = 'OLED_cust()\n';
  return code;
};
...
Blockly.Java['OLED_initU'] = function(block) {
  var code = "OLED_initU();\n";
  return code;
};


Blockly.Python['OLED_initU'] = function(block) {
  var code = 'OLED_initU()\n';
  return code;
};
...
Blockly.Java['OLED_display'] = function(block) {
  var code = "OLED_display();\n";
  return code;
};
...
Blockly.Java['OLED_displayU'] = function(block) {
  var code = "OLED_displayU();\n";
  return code;
};


Blockly.Python['OLED_displayU'] = function(block) {
  var code = 'OLED_displayU()\n';
  return code;
};
...
Blockly.Java['OLED_clear'] = function(block) {
  var code = "OLED_clear();\n";
  return code;
};
...
Blockly.Java['OLED_clearU'] = function(block) {
  var code = "OLED_clearU();\n";
  return code;
};


Blockly.Python['OLED_clearU'] = function(block) {
  var code = 'OLED_clearU()\n';
  return code;
};
...
Blockly.Java['OLED_rotate'] = function(block) {
  var angle = block.getFieldValue('angle') || '';
  var code = "OLED_rotate(' + angle + ');\n";
  return code;
};
...
Blockly.Java['OLED_data'] = function(block) {
  ...
  var value_size = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var value_print = Blockly.Java.valueToCode(block, 'print', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_data(' + value_x + ', ' + value_y + ', ' + value_size + ', ' + value_print + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_data'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_size = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['OLED_dataU'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_print = Blockly.Java.valueToCode(block, 'print', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_dataU(' + value_x + ', ' + value_y + ', ' + value_print + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_dataU'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_print = Blockly.Python.valueToCode(block, 'print', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'OLED_dataU(' + value_x + ', ' + value_y + ', ' + value_print + ')';
...
Blockly.Java['OLED_symbol'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_size = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var value_print = Blockly.Java.valueToCode(block, 'print', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_symbol(' + value_x + ', ' + value_y + ', ' + value_size + ', ' + value_print + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_symbol'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_size = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
  var value_print = Blockly.Python.valueToCode(block, 'print', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['OLED_scroll'] = function(block) {
  var mode = block.getFieldValue('mode') || '';
  var code = "OLED_scroll(' + mode + ');\n";
  return code;
};
...
Blockly.Java['OLED_invert'] = function(block) {
  var mode = block.getFieldValue('mode') || '';
  var code = "OLED_invert(' + mode + ');\n";
  return code;
};
...
Blockly.Java['OLED_pixel'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_pixel(' + value_x + ', ' + value_y + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['OLED_pixelU'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_pixelU(' + value_x + ', ' + value_y + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_pixelU'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'OLED_pixelU(' + value_x + ', ' + value_y + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
...
Blockly.Java['OLED_line'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  ...
  var code = "OLED_line(' + value_x + ', ' + value_y + ', ' + value_width + ', ' + value_height + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['OLED_lineU'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var value_height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_lineU(' + value_x + ', ' + value_y + ', ' + value_width + ', ' + value_height + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_lineU'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_width = Blockly.Python.valueToCode(block, 'width', Blockly.Python.ORDER_ATOMIC) || '';
  var value_height = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['OLED_rectangle'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var value_height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_rectangle(' + value_x + ', ' + value_y + ', ' + value_width + ', ' + value_height + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_rectangle'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_width = Blockly.Python.valueToCode(block, 'width', Blockly.Python.ORDER_ATOMIC) || '';
  var value_height = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['OLED_rectangleU'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var value_height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_rectangleU(' + value_x + ', ' + value_y + ', ' + value_width + ', ' + value_height + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_rectangleU'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_width = Blockly.Python.valueToCode(block, 'width', Blockly.Python.ORDER_ATOMIC) || '';
  var value_height = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['OLED_round'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var value_height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var value_round = Blockly.Java.valueToCode(block, 'round', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_round(' + value_x + ', ' + value_y + ', ' + value_width + ', ' + value_height + ', ' + value_round + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_round'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_width = Blockly.Python.valueToCode(block, 'width', Blockly.Python.ORDER_ATOMIC) || '';
  var value_height = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
  var value_round = Blockly.Python.valueToCode(block, 'round', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'OLED_round(' + value_x + ', ' + value_y + ', ' + value_width + ', ' + value_height + ', ' + value_round + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['OLED_roundU'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var value_height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_roundU(' + value_x + ', ' + value_y + ', ' + value_width + ', ' + value_height + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_roundU'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_width = Blockly.Python.valueToCode(block, 'width', Blockly.Python.ORDER_ATOMIC) || '';
  var value_height = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['OLED_circle'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_circle(' + value_x + ', ' + value_y + ', ' + value_width + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['OLED_circleU'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_circleU(' + value_x + ', ' + value_y + ', ' + value_width + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_circleU'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_width = Blockly.Python.valueToCode(block, 'width', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'OLED_circleU(' + value_x + ', ' + value_y + ', ' + value_width + ')';
...
Blockly.Java['OLED_triangle'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var value_height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var value_round = Blockly.Java.valueToCode(block, 'round', Blockly.Java.ORDER_ATOMIC) || '';
  var value_angle = Blockly.Java.valueToCode(block, 'angle', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_triangle(' + value_x + ', ' + value_y + ', ' + value_width + ', ' + value_height + ', ' + value_round + ', ' + value_angle + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['OLED_triangleU'] = function(block) {
  var value_x = Blockly.Java.valueToCode(block, 'X', Blockly.Java.ORDER_ATOMIC) || '';
  var value_y = Blockly.Java.valueToCode(block, 'Y', Blockly.Java.ORDER_ATOMIC) || '';
  var value_width = Blockly.Java.valueToCode(block, 'width', Blockly.Java.ORDER_ATOMIC) || '';
  var value_height = Blockly.Java.valueToCode(block, 'height', Blockly.Java.ORDER_ATOMIC) || '';
  var value_round = Blockly.Java.valueToCode(block, 'round', Blockly.Java.ORDER_ATOMIC) || '';
  var value_angle = Blockly.Java.valueToCode(block, 'angle', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "OLED_triangleU(' + value_x + ', ' + value_y + ', ' + value_width + ', ' + value_height + ', ' + value_round + ', ' + value_angle + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_triangleU'] = function(block) {
  var value_x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_ATOMIC) || '';
  var value_y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_ATOMIC) || '';
  var value_width = Blockly.Python.valueToCode(block, 'width', Blockly.Python.ORDER_ATOMIC) || '';
  var value_height = Blockly.Python.valueToCode(block, 'height', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['OLED_bitmap'] = function(block) {
  var bitmap = block.getFieldValue('bitmap') || '';
  var code = "OLED_bitmap(' + bitmap + ');\n";
  return code;
};
...
Blockly.Java['OLED_bitmap2'] = function(block) {
  ...
  var IconName = block.getFieldValue('NAME') || '';
  var Color = block.getFieldValue('COLOR') || '';
  var code = "OLED_bitmap2(' + x0 + ', ' + y0 + ', ' + width + ', ' + height + ', ' + IconName + ', ' + Color + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['OLED_bitmap2'] = function(block) {
...
Blockly.Java['oled_icon'] = function(block) {
  var IconName = block.getFieldValue('NAME') || '';
  var Var_Codes = block.getFieldValue('CODES') || '';
  var code = "oled_icon(' + IconName + ', ' + Var_Codes + ');\n";
  return code;
};
...
Blockly.Java['OLED_eyes'] = function(block) {
  var oled_eyes = block.getFieldValue('oled_eyes') || '';
  var code = "OLED_eyes(' + oled_eyes + ');\n";
  return code;
};


Blockly.Python['OLED_eyes'] = function(block) {
  var oled_eyes = block.getFieldValue('oled_eyes') || '';
  var code = 'OLED_eyes(' + oled_eyes + ')\n';
  return code;
};
