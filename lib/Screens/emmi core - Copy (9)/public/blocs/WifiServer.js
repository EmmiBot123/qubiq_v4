...
Blockly.Java['wifiserver_port'] = function(block) {
  var server_port = Blockly.Java.valueToCode(block, 'server_port', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "wifiserver_port(' + server_port + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['wifiserver_port'] = function(block) {
  var server_port = Blockly.Python.valueToCode(block, 'server_port', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'wifiserver_port(' + server_port + ')';
...
Blockly.Java['wifiserver_waitconnection'] = function(block) {
  var code = "wifiserver_waitconnection();\n";
  return code;
};
...
Blockly.Java['wifiserver_answer'] = function(block) {
  var server_answer = Blockly.Java.valueToCode(block, 'server_answer', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "wifiserver_answer(' + server_answer + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['wifiserver_answer'] = function(block) {
  var server_answer = Blockly.Python.valueToCode(block, 'server_answer', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'wifiserver_answer(' + server_answer + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['wifiserver_stop'] = function(block) {
  var code = "wifiserver_stop();\n";
  return code;
};


Blockly.Python['wifiserver_stop'] = function(block) {
  var code = 'wifiserver_stop()\n';
  return code;
};
...
Blockly.Java['wifiserver_flush'] = function(block) {
  var code = "wifiserver_flush();\n";
  return code;
};


Blockly.Python['wifiserver_flush'] = function(block) {
  var code = 'wifiserver_flush()\n';
  return code;
};
...
Blockly.Java['wifiserver_ip'] = function(block) {
  var code = "wifiserver_ip()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['wifiserver_ip'] = function(block) {
  var code = 'wifiserver_ip()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['wifiserver_request'] = function(block) {
  var code = "wifiserver_request()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['wifiserver_request'] = function(block) {
  var code = 'wifiserver_request()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['wifiserver_port_library'] = function(block) {
  var server_port = Blockly.Java.valueToCode(block, 'server_port', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "wifiserver_port_library(' + server_port + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['wifiserver_port_library'] = function(block) {
  var server_port = Blockly.Python.valueToCode(block, 'server_port', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'wifiserver_port_library(' + server_port + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['esp8266_getArg'] = function(block) {
  var code = "esp8266_getArg();\n";
  return code;
};


Blockly.Python['esp8266_getArg'] = function(block) {
  var code = 'esp8266_getArg()\n';
  return code;
};
...
Blockly.Java['esp8266_useArg'] = function(block) {
  var code = "esp8266_useArg()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['esp8266_useArg'] = function(block) {
  var code = 'esp8266_useArg()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['esp8266_send'] = function(block) {
  var pagina = block.getFieldValue('text') || '';
  var direccion = block.getFieldValue('address') || '';
  var code = "esp8266_send(' + pagina + ', ' + direccion + ');\n";
  return code;
};
...
Blockly.Java['esp8266_handle_request'] = function(block) {
  var code = "esp8266_handle_request();\n";
  return code;
};


Blockly.Python['esp8266_handle_request'] = function(block) {
  var code = 'esp8266_handle_request()\n';
  return code;
};
...
Blockly.Java['wifiserver_port_asyn_library'] = function(block) {
  var server_port = Blockly.Java.valueToCode(block, 'server_port', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "wifiserver_port_asyn_library(' + server_port + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['wifiserver_port_asyn_library'] = function(block) {
  var server_port = Blockly.Python.valueToCode(block, 'server_port', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'wifiserver_port_asyn_library(' + server_port + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['esp8266_asyngetArg'] = function(block) {
  var code = "esp8266_asyngetArg();\n";
  return code;
};


Blockly.Python['esp8266_asyngetArg'] = function(block) {
  var code = 'esp8266_asyngetArg()\n';
  return code;
};
...
Blockly.Java['esp8266_asynuseArg'] = function(block) {
  var code = "esp8266_asynuseArg()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['esp8266_asynuseArg'] = function(block) {
  var code = 'esp8266_asynuseArg()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['esp8266_asynsend'] = function(block) {
  var pagina = block.getFieldValue('text') || '';
  var direccion = block.getFieldValue('address') || '';
  var code = "esp8266_asynsend(' + pagina + ', ' + direccion + ');\n";
  return code;
};


Blockly.Python['esp8266_asynsend'] = function(block) {
  var pagina = block.getFieldValue('text') || '';
  var direccion = block.getFieldValue('address') || '';
  var code = 'esp8266_asynsend(' + pagina + ', ' + direccion + ')\n';
  return code;
...
Blockly.Java['esp8266_asynsend_text'] = function(block) {
  var answer_text = Blockly.Java.valueToCode(block, 'server_answer', Blockly.Java.ORDER_ATOMIC) || '';
  var direccion = block.getFieldValue('address') || '';
  var code = "esp8266_asynsend_text(' + answer_text + ', ' + direccion + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['esp8266_asynsend_text'] = function(block) {
  var answer_text = Blockly.Python.valueToCode(block, 'server_answer', Blockly.Python.ORDER_ATOMIC) || '';
  var direccion = block.getFieldValue('address') || '';
  var code = 'esp8266_asynsend_text(' + answer_text + ', ' + direccion + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
