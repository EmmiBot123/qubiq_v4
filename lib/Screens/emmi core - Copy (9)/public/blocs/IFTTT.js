...
Blockly.Java['ifttt_init'] = function(block) {
  var api_key = block.getFieldValue('API_KEY') || '';
  var code = "ifttt_init(' + api_key + ');\n";
  return code;
};


Blockly.Python['ifttt_init'] = function(block) {
  var api_key = block.getFieldValue('API_KEY') || '';
  var code = 'ifttt_init(' + api_key + ')\n';
  return code;
};
...
Blockly.Java['ifttt_send'] = function(block) {
  var value1 = Blockly.Java.valueToCode(block, 'value1', Blockly.Java.ORDER_ATOMIC) || '';
  var value2 = Blockly.Java.valueToCode(block, 'value2', Blockly.Java.ORDER_ATOMIC) || '';
  var value3 = Blockly.Java.valueToCode(block, 'value3', Blockly.Java.ORDER_ATOMIC) || '';
  var evento = Blockly.Java.valueToCode(block, 'evento', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "ifttt_send(' + value1 + ', ' + value2 + ', ' + value3 + ', ' + evento + ')";
...
Blockly.Python['ifttt_send'] = function(block) {
  ...
  var evento = Blockly.Python.valueToCode(block, 'evento', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'ifttt_send(' + value1 + ', ' + value2 + ', ' + value3 + ', ' + evento + ')';
