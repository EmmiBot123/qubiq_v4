...
Blockly.Java['soft_init'] = function(block) {
  var code = "soft_init();\n";
  return code;
};


Blockly.Python['soft_init'] = function(block) {
  var code = 'soft_init()\n';
  return code;
};
...
Blockly.Blocks['soft_printfor'] = {
  ...
  init: function() {
    ...
    this.appendValueInput("CONTENT", "Number")
        .setCheck("Number")
        .appendField(Blockly.Msg.SSerial_Print_Format)
...
Blockly.Java['soft_printfor'] = function(block) {
  var content = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "soft_printfor(' + content + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_printfor'] = function(block) {
...
Blockly.Java['soft_available'] = function(block) {
  var code = "soft_available()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_available'] = function(block) {
  var code = 'soft_available()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_read'] = function(block) {
  var code = "soft_read()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_read'] = function(block) {
  var code = 'soft_read()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Blocks['soft_read_string'] = {
  ...
  init: function() {
	...
	.appendField(new Blockly.FieldImage("media/serie.png", 20,25 ))
	this.appendDummyInput("")
	    .appendField(Blockly.Msg.SSERIAL_ReadString);
	this.appendDummyInput()
...
Blockly.Java['soft_read_string'] = function(block) {
  var code = "soft_read_string()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_read_string'] = function(block) {
  var code = 'soft_read_string()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Blocks['soft_read_number'] = {
  ...
  init: function() {
	...
	.appendField(new Blockly.FieldImage("media/serie.png", 20,25 ))
	this.appendDummyInput("")
	    .appendField(Blockly.Msg.SSERIAL_ReadNum);
	this.appendDummyInput()
        .appendField(new Blockly.FieldCheckbox('FALSE'), 'LOGIC')
		.appendField(Blockly.Msg.SSERIAL_Readlf)
    this.setInputsInline(true);
...
Blockly.Java['soft_read_number'] = function(block) {
  var code = "soft_read_number()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_read_number'] = function(block) {
  var code = 'soft_read_number()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_println'] = function(block) {
  var content = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "soft_println(' + content + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_println'] = function(block) {
  var content = Blockly.Python.valueToCode(block, 'CONTENT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'soft_println(' + content + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_print'] = function(block) {
  var content = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "soft_print(' + content + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_print'] = function(block) {
  var content = Blockly.Python.valueToCode(block, 'CONTENT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'soft_print(' + content + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['soft_write'] = function(block) {
  var content = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "soft_write(' + content + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['soft_write'] = function(block) {
  var content = Blockly.Python.valueToCode(block, 'CONTENT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'soft_write(' + content + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
