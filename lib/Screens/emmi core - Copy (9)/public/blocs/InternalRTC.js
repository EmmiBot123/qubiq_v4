...
Blockly.Java['Init_RTC_internal'] = function(block) {
  var code = "Init_RTC_internal();\n";
  return code;
};


Blockly.Python['Init_RTC_internal'] = function(block) {
  var code = 'Init_RTC_internal()\n';
  return code;
};
...
Blockly.Java['DateTime_RTC_internal'] = function(block) {
  var day = Blockly.Java.valueToCode(block, 'INTERNAL_DAY', Blockly.Java.ORDER_ATOMIC) || '';
  var month = Blockly.Java.valueToCode(block, 'INTERNAL_MONTH', Blockly.Java.ORDER_ATOMIC) || '';
  var year = Blockly.Java.valueToCode(block, 'INTERNAL_YEAR', Blockly.Java.ORDER_ATOMIC) || '';
  var hour = Blockly.Java.valueToCode(block, 'INTERNAL_HOUR', Blockly.Java.ORDER_ATOMIC) || '';
  var min = Blockly.Java.valueToCode(block, 'INTERNAL_MINUTE', Blockly.Java.ORDER_ATOMIC) || '';
  var sec = Blockly.Java.valueToCode(block, 'INTERNAL_SECOND', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "DateTime_RTC_internal(' + day + ', ' + month + ', ' + year + ', ' + hour + ', ' + min + ', ' + sec + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['DateTime_RTC_internal'] = function(block) {
  var day = Blockly.Python.valueToCode(block, 'INTERNAL_DAY', Blockly.Python.ORDER_ATOMIC) || '';
  var month = Blockly.Python.valueToCode(block, 'INTERNAL_MONTH', Blockly.Python.ORDER_ATOMIC) || '';
  var year = Blockly.Python.valueToCode(block, 'INTERNAL_YEAR', Blockly.Python.ORDER_ATOMIC) || '';
  var hour = Blockly.Python.valueToCode(block, 'INTERNAL_HOUR', Blockly.Python.ORDER_ATOMIC) || '';
  var min = Blockly.Python.valueToCode(block, 'INTERNAL_MINUTE', Blockly.Python.ORDER_ATOMIC) || '';
  var sec = Blockly.Python.valueToCode(block, 'INTERNAL_SECOND', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'DateTime_RTC_internal(' + day + ', ' + month + ', ' + year + ', ' + hour + ', ' + min + ', ' + sec + ')';
...
Blockly.Java['values_internal_RTC'] = function(block) {
  var code = "values_internal_RTC()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['values_internal_RTC'] = function(block) {
  var code = 'values_internal_RTC()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['values_text_internal_RTC'] = function(block) {
  var code = "values_text_internal_RTC()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['values_text_internal_RTC'] = function(block) {
  var code = 'values_text_internal_RTC()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
