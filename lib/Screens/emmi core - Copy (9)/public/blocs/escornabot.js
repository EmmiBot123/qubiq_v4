...
Blockly.Java['escornabot_init'] = function(block) {
  var dropdown_escornabot_move_choice = block.getFieldValue('escornabot_mode_choice') || '';
  var code = "escornabot_init(' + dropdown_escornabot_move_choice + ');\n";
  return code;
};


Blockly.Python['escornabot_init'] = function(block) {
  var dropdown_escornabot_move_choice = block.getFieldValue('escornabot_mode_choice') || '';
  var code = 'escornabot_init(' + dropdown_escornabot_move_choice + ')\n';
  return code;
};
...
Blockly.Java['escornabot_spin'] = function(block) {
  var spinNumber = block.getFieldValue('spinNumber') || '';
  var v = block.getFieldValue('escornabot_spin_velocity') || '';
  var code = "escornabot_spin(' + spinNumber + ', ' + v + ');\n";
  return code;
};


Blockly.Python['escornabot_spin'] = function(block) {
  var spinNumber = block.getFieldValue('spinNumber') || '';
  var v = block.getFieldValue('escornabot_spin_velocity') || '';
  var code = 'escornabot_spin(' + spinNumber + ', ' + v + ')\n';
  return code;
...
Blockly.Java['escornabot_distance'] = function(block) {
  var spinNumber = block.getFieldValue('distance') || '';
  var v = block.getFieldValue('escornabot_spin_velocity') || '';
  var code = "escornabot_distance(' + spinNumber + ', ' + v + ');\n";
  return code;
};


Blockly.Python['escornabot_distance'] = function(block) {
  var spinNumber = block.getFieldValue('distance') || '';
  var v = block.getFieldValue('escornabot_spin_velocity') || '';
  var code = 'escornabot_distance(' + spinNumber + ', ' + v + ')\n';
  return code;
...
Blockly.Java['escornabot_turnspin'] = function(block) {
  var spinNumber = block.getFieldValue('spinNumber') || '';
  var v = block.getFieldValue('escornabot_spin_velocity') || '';
  var code = "escornabot_turnspin(' + spinNumber + ', ' + v + ');\n";
  return code;
};


Blockly.Python['escornabot_turnspin'] = function(block) {
  var spinNumber = block.getFieldValue('spinNumber') || '';
  var v = block.getFieldValue('escornabot_spin_velocity') || '';
  var code = 'escornabot_turnspin(' + spinNumber + ', ' + v + ')\n';
  return code;
...
Blockly.Java['escornabot_turnangle'] = function(block) {
  var angle = block.getFieldValue('angle') || '';
  var v = block.getFieldValue('escornabot_spin_velocity') || '';
  var code = "escornabot_turnangle(' + angle + ', ' + v + ');\n";
  return code;
};


Blockly.Python['escornabot_turnangle'] = function(block) {
  var angle = block.getFieldValue('angle') || '';
  var v = block.getFieldValue('escornabot_spin_velocity') || '';
  var code = 'escornabot_turnangle(' + angle + ', ' + v + ')\n';
  return code;
...
Blockly.Java['escornabot_stop'] = function(block) {
  var code = "escornabot_stop();\n";
  return code;
};


Blockly.Python['escornabot_stop'] = function(block) {
  var code = 'escornabot_stop()\n';
  return code;
};
...
Blockly.Java['escornabot_beep'] = function(block) {
  var time = block.getFieldValue('time') || '';
  var code = "escornabot_beep(' + time + ');\n";
  return code;
};


Blockly.Python['escornabot_beep'] = function(block) {
  var time = block.getFieldValue('time') || '';
  var code = 'escornabot_beep(' + time + ')\n';
  return code;
};
...
Blockly.Java['escornabot_ledon'] = function(block) {
  var l = block.getFieldValue('escornabot_led_choice') || '';
  var code = "escornabot_ledon(' + l + ');\n";
  return code;
};


Blockly.Python['escornabot_ledon'] = function(block) {
  var l = block.getFieldValue('escornabot_led_choice') || '';
  var code = 'escornabot_ledon(' + l + ')\n';
  return code;
};
...
Blockly.Java['escornabot_ledoff'] = function(block) {
  var l = block.getFieldValue('escornabot_led_choice') || '';
  var code = "escornabot_ledoff(' + l + ');\n";
  return code;
};


Blockly.Python['escornabot_ledoff'] = function(block) {
  var l = block.getFieldValue('escornabot_led_choice') || '';
  var code = 'escornabot_ledoff(' + l + ')\n';
  return code;
};
...
Blockly.Java['escornabot_getbutton'] = function(block) {
  var boton = block.getFieldValue('button') || '';
  var code = "escornabot_getbutton(' + boton + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['escornabot_getbutton'] = function(block) {
  var boton = block.getFieldValue('button') || '';
  var code = 'escornabot_getbutton(' + boton + ')';
...
Blockly.Java['escornabot_us_init'] = function(block) {
  var trigger = block.getFieldValue('Trigger') || '';
  var echo = block.getFieldValue('Echo') || '';
  var code = "escornabot_us_init(' + trigger + ', ' + echo + ');\n";
  return code;
};


Blockly.Python['escornabot_us_init'] = function(block) {
  var trigger = block.getFieldValue('Trigger') || '';
  var echo = block.getFieldValue('Echo') || '';
  var code = 'escornabot_us_init(' + trigger + ', ' + echo + ')\n';
  return code;
...
Blockly.Java['escornabot_getus'] = function(block) {
  var code = "escornabot_getus()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['escornabot_getus'] = function(block) {
  var code = 'escornabot_getus()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['escornabot_ir_init'] = function(block) {
  var izquierda = block.getFieldValue('Izquierda') || '';
  var derecha = block.getFieldValue('Derecha') || '';
  var code = "escornabot_ir_init(' + izquierda + ', ' + derecha + ');\n";
  return code;
};


Blockly.Python['escornabot_ir_init'] = function(block) {
  var izquierda = block.getFieldValue('Izquierda') || '';
  var derecha = block.getFieldValue('Derecha') || '';
  var code = 'escornabot_ir_init(' + izquierda + ', ' + derecha + ')\n';
  return code;
...
Blockly.Java['escornabot_blackLeft'] = function(block) {
  var code = "escornabot_blackLeft()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['escornabot_blackLeft'] = function(block) {
  var code = 'escornabot_blackLeft()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['escornabot_blackRight'] = function(block) {
  var code = "escornabot_blackRight()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['escornabot_blackRight'] = function(block) {
  var code = 'escornabot_blackRight()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['escornabot_whiteLeft'] = function(block) {
  var code = "escornabot_whiteLeft()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['escornabot_whiteLeft'] = function(block) {
  var code = 'escornabot_whiteLeft()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['escornabot_whiteRight'] = function(block) {
  var code = "escornabot_whiteRight()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['escornabot_whiteRight'] = function(block) {
  var code = 'escornabot_whiteRight()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['escornabot_app'] = function(block) {
  var code = "escornabot_app();\n";
  return code;
};


Blockly.Python['escornabot_app'] = function(block) {
  var code = 'escornabot_app()\n';
  return code;
};
