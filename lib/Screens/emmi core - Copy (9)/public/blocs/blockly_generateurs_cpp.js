...
Blockly.Java['controls_switch'] = function (block) {
    var argument = Blockly.Java.valueToCode(block, 'CASE', Blockly.Java.ORDER_ATOMIC) || '';
    var code = "controls_switch(" + argument + ");\n";
    return code;
};


Blockly.Python['controls_switch'] = function (block) {
    var argument = Blockly.Python.valueToCode(block, 'CASE', Blockly.Python.ORDER_ATOMIC) || '';
    var code = 'controls_switch(' + argument + ')\n';
    return code;
};
...
Blockly.Java['controls_for'] = function (block) {
    var argument0 = Blockly.Java.valueToCode(block, 'FROM', Blockly.Java.ORDER_ATOMIC) || '';
    var argument1 = Blockly.Java.valueToCode(block, 'TO', Blockly.Java.ORDER_ATOMIC) || '';
    var increment = Blockly.Java.valueToCode(block, 'BY', Blockly.Java.ORDER_ATOMIC) || '';
    var code = "controls_for(" + argument0 + ", " + argument1 + ", " + increment + ");\n";
    return code;
};


Blockly.Python['controls_for'] = function (block) {
    var argument0 = Blockly.Python.valueToCode(block, 'FROM', Blockly.Python.ORDER_ATOMIC) || '';
    var argument1 = Blockly.Python.valueToCode(block, 'TO', Blockly.Python.ORDER_ATOMIC) || '';
    var increment = Blockly.Python.valueToCode(block, 'BY', Blockly.Python.ORDER_ATOMIC) || '';
    var code = 'controls_for(' + argument0 + ', ' + argument1 + ', ' + increment + ')\n';
    return code;
};
...
Blockly.Arduino["inout_onoff2"] = function (block) {
    var code = block.getFieldValue("BOOL") == "HIGH" ? "LOW" : "LOW";
    return [code, Blockly.Arduino.ORDER_ATOMIC]
};
// math
...
Blockly.Arduino['intervalle'] = function (block) {
    ...
    Blockly.Java['intervalle'] = function (block) {
        var code = "intervalle();\n";
        return code;
    };
...
Blockly.Java['analog_pin'] = function (block) {
    var code = "analog_pin()";
...
Blockly.Java['text_char'] = function (block) {
    var code = "text_char()";
    return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['text_char'] = function (block) {
    var code = 'text_char()';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['variables_get'] = function (block) {
    var code = Blockly.Java.variableDB_.getName(block.getFieldValue('VAR'), Blockly.Variables.NAME_TYPE);
    return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['variables_set_init'] = function (block) {
    var argument0 = Blockly.Java.valueToCode(block, 'VALUE', Blockly.Java.ORDER_ATOMIC) || '';
    var code = "variables_set_init(' + argument0 + ')";
    return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['variables_set_init'] = function (block) {
    var argument0 = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_ATOMIC) || '';
    var code = 'variables_set_init(' + argument0 + ')';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['procedures_defnoreturn'] = function (block) {
    var code = "procedures_defnoreturn();\n";
    return code;
};
...
Blockly.Java['procedures_defreturn'] = function (block) {
    var returnValue = Blockly.Java.valueToCode(block, 'RETURN', Blockly.Java.ORDER_ATOMIC) || '';
    var code = "procedures_defreturn(' + returnValue + ')";
    return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['procedures_defreturn'] = function (block) {
    var returnValue = Blockly.Python.valueToCode(block, 'RETURN', Blockly.Python.ORDER_ATOMIC) || '';
    var code = 'procedures_defreturn(' + returnValue + ')';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['procedures_callreturn'] = function (block) {
    var code = "procedures_callreturn()";
    return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['procedures_callnoreturn'] = function (block) {
    var code = "procedures_callnoreturn()";
    return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['procedures_ifreturn'] = function (block) {
    ...
    var code = "procedures_ifreturn(' + value + ')";
    return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['creer_tableau'] = function (block) {
    var code = "creer_tableau()";
    return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['creer_tableau'] = function (block) {
    var code = 'creer_tableau()';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['fixer_tableau'] = function (block) {
    var value_value = Blockly.Java.valueToCode(block, 'value', Blockly.Java.ORDER_ATOMIC) || '';
    var code = "fixer_tableau(' + value_value + ')";
    return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['fixer_tableau'] = function (block) {
...
Blockly.Java['mrtduino_pin'] = function (block) {
    var code = block.getFieldValue('MRTPIN') || '';
    var code = "mrtduino_pin(' + code + ')";
    return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['mrtduino_pin'] = function (block) {
    var code = block.getFieldValue('MRTPIN') || '';
    var code = 'mrtduino_pin(' + code + ')';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
