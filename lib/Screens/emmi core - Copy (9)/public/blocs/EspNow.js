...
Blockly.Java['espnow_init_esp32'] = function(block) {
  var id_node = Blockly.Java.valueToCode(block, 'id_node', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "espnow_init_esp32(' + id_node + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['espnow_init_esp32'] = function(block) {
  var id_node = Blockly.Python.valueToCode(block, 'id_node', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'espnow_init_esp32(' + id_node + ')';
...
Blockly.Java['espnow_init_esp8266'] = function(block) {
  var id_node = Blockly.Java.valueToCode(block, 'id_node', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "espnow_init_esp8266(' + id_node + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['espnow_init_esp8266'] = function(block) {
  var id_node = Blockly.Python.valueToCode(block, 'id_node', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'espnow_init_esp8266(' + id_node + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['espnow_sendmessage_all'] = function(block) {
  var code = "espnow_sendmessage_all();\n";
  return code;
};


Blockly.Python['espnow_sendmessage_all'] = function(block) {
  var code = 'espnow_sendmessage_all()\n';
  return code;
};
...
Blockly.Java['espnow_sendmessage_mac'] = function(block) {
  var code = "espnow_sendmessage_mac();\n";
  return code;
};


Blockly.Python['espnow_sendmessage_mac'] = function(block) {
  var code = 'espnow_sendmessage_mac()\n';
  return code;
};
...
Blockly.Java['espnow_paramText_refund'] = function(block) {
  var code = "espnow_paramText_refund()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['espnow_paramText_refund'] = function(block) {
  var code = 'espnow_paramText_refund()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['espnow_paramNode_refund'] = function(block) {
  var code = "espnow_paramNode_refund()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['espnow_paramNode_refund'] = function(block) {
  var code = 'espnow_paramNode_refund()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['espnow_paramInt_refund'] = function(block) {
  var code = "espnow_paramInt_refund()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['espnow_paramInt_refund'] = function(block) {
  var code = 'espnow_paramInt_refund()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['espnow_paramFloat_refund'] = function(block) {
  var code = "espnow_paramFloat_refund()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['espnow_paramFloat_refund'] = function(block) {
  var code = 'espnow_paramFloat_refund()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['espnow_paramInt_fill'] = function(block) {
  var ParamInt = Blockly.Java.valueToCode(block, 'ParamInt', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "espnow_paramInt_fill(' + ParamInt + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['espnow_paramInt_fill'] = function(block) {
  var ParamInt = Blockly.Python.valueToCode(block, 'ParamInt', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'espnow_paramInt_fill(' + ParamInt + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['espnow_paramFloat_fill'] = function(block) {
  var ParamFloat = Blockly.Java.valueToCode(block, 'ParamFloat', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "espnow_paramFloat_fill(' + ParamFloat + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['espnow_paramFloat_fill'] = function(block) {
  var ParamFloat = Blockly.Python.valueToCode(block, 'ParamFloat', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'espnow_paramFloat_fill(' + ParamFloat + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['espnow_paramText_fill'] = function(block) {
  var ParamText = Blockly.Java.valueToCode(block, 'ParamText', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "espnow_paramText_fill(' + ParamText + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['espnow_paramText_fill'] = function(block) {
  var ParamText = Blockly.Python.valueToCode(block, 'ParamText', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'espnow_paramText_fill(' + ParamText + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
