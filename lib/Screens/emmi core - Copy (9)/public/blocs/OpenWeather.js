...
Blockly.Java['Init_OpenWeather'] = function(block) {
  var code = "Init_OpenWeather();\n";
  return code;
};


Blockly.Python['Init_OpenWeather'] = function(block) {
  var code = 'Init_OpenWeather()\n';
  return code;
};
...
Blockly.Java['order_read_OpenWeather_server'] = function(block) {
  var city = Blockly.Java.valueToCode(block, 'city', Blockly.Java.ORDER_ATOMIC) || '';
  var countrycode = Blockly.Java.valueToCode(block, 'countrycode', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "order_read_OpenWeather_server(' + city + ', ' + countrycode + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['order_read_OpenWeather_server'] = function(block) {
  var city = Blockly.Python.valueToCode(block, 'city', Blockly.Python.ORDER_ATOMIC) || '';
  var countrycode = Blockly.Python.valueToCode(block, 'countrycode', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'order_read_OpenWeather_server(' + city + ', ' + countrycode + ')';
...
Blockly.Java['values_OpenWeather_server'] = function(block) {
  var code = "values_OpenWeather_server()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['values_OpenWeather_server'] = function(block) {
  var code = 'values_OpenWeather_server()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['values_text_OpenWeather_server'] = function(block) {
  var code = "values_text_OpenWeather_server()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['values_text_OpenWeather_server'] = function(block) {
  var code = 'values_text_OpenWeather_server()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
