...
Blockly.Java['mqtt_init'] = function(block) {
  var ssid = block.getFieldValue('SSID') || '';
  var wifipassword = block.getFieldValue('PASSWORD') || '';
  var server = block.getFieldValue('SERVER') || '';
  var port = block.getFieldValue('PORT') || '';
  ...
  var APIKey = block.getFieldValue('APIKEY') || '';
  var Idclient = block.getFieldValue('IDCLIENT') || '';
  var code = "mqtt_init(' + ssid + ', ' + wifipassword + ', ' + server + ', ' + port + ', ' + usermqtt + ', ' + APIKey + ', ' + Idclient + ');\n";
  return code;
};
...
Blockly.Java['mqtt_loop'] = function(block) {
  var code = "mqtt_loop();\n";
  return code;
};


Blockly.Python['mqtt_loop'] = function(block) {
  var code = 'mqtt_loop()\n';
  return code;
};
...
Blockly.Java['mqtt_subscribe_num'] = function(block) {
  var varName = Blockly.Java.valueToCode(block, 'variable', Blockly.Java.ORDER_ATOMIC) || '';
  var topic = block.getFieldValue('TOPIC') || '';
  var code = "mqtt_subscribe_num(' + varName + ', ' + topic + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['mqtt_subscribe_num'] = function(block) {
  var varName = Blockly.Python.valueToCode(block, 'variable', Blockly.Python.ORDER_ATOMIC) || '';
  var topic = block.getFieldValue('TOPIC') || '';
  var code = 'mqtt_subscribe_num(' + varName + ', ' + topic + ')';
...
Blockly.Java['mqtt_subscribe_text'] = function(block) {
  var varName = Blockly.Java.valueToCode(block, 'variable', Blockly.Java.ORDER_ATOMIC) || '';
  var topic = block.getFieldValue('TOPIC') || '';
  var code = "mqtt_subscribe_text(' + varName + ', ' + topic + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['mqtt_subscribe_text'] = function(block) {
  var varName = Blockly.Python.valueToCode(block, 'variable', Blockly.Python.ORDER_ATOMIC) || '';
  var topic = block.getFieldValue('TOPIC') || '';
  var code = 'mqtt_subscribe_text(' + varName + ', ' + topic + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
...
Blockly.Java['mqtt_publish'] = function(block) {
  var variable = Blockly.Java.valueToCode(block, 'variable', Blockly.Java.ORDER_ATOMIC) || '';
  var topic = block.getFieldValue('TOPIC') || '';
  var code = "mqtt_publish(' + variable + ', ' + topic + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
