...
Blockly.Java['Init_Compass_HMC5883'] = function(block) {
  var code = "Init_Compass_HMC5883();\n";
  return code;
};


Blockly.Python['Init_Compass_HMC5883'] = function(block) {
  var code = 'Init_Compass_HMC5883()\n';
  return code;
};
...
Blockly.Java['order_to_read_HMC5883_values'] = function(block) {
  var code = "order_to_read_HMC5883_values();\n";
  return code;
};


Blockly.Python['order_to_read_HMC5883_values'] = function(block) {
  var code = 'order_to_read_HMC5883_values()\n';
  return code;
};
...
Blockly.Java['HMC5883_values'] = function(block) {
  var code = "HMC5883_values()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['HMC5883_values'] = function(block) {
  var code = 'HMC5883_values()';
