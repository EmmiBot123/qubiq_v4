...
Blockly.Java['rfid_init'] = function(block) {
  var code = "rfid_init();\n";
  return code;
};
...
Blockly.Java['rfid_validationcard'] = function(block) {
  var pin_C1 = block.getFieldValue('C1') || '';
  var pin_C2 = block.getFieldValue('C2') || '';
  var pin_C3 = block.getFieldValue('C3') || '';
  var pin_C4 = block.getFieldValue('C4') || '';
  var Var_NAME = block.getFieldValue('NAME') || '';
  var code = "rfid_validationcard(' + pin_C1 + ', ' + pin_C2 + ', ' + pin_C3 + ', ' + pin_C4 + ', ' + Var_NAME + ');\n";
  return code;
};


Blockly.Python['rfid_validationcard'] = function(block) {
  var pin_C1 = block.getFieldValue('C1') || '';
  var pin_C2 = block.getFieldValue('C2') || '';
  var pin_C3 = block.getFieldValue('C3') || '';
  var pin_C4 = block.getFieldValue('C4') || '';
...
Blockly.Java['RFID_detected'] = function(block) {
  var code = "RFID_detected()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RFID_detected'] = function(block) {
  var code = 'RFID_detected()';
...
Blockly.Java['RFID_readed'] = function(block) {
  var code = "RFID_readed()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RFID_readed'] = function(block) {
  var code = 'RFID_readed()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['RFID_card_readed'] = function(block) {
  var code = "RFID_card_readed()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RFID_card_readed'] = function(block) {
  var code = 'RFID_card_readed()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['RFID_check_card'] = function(block) {
  var Var_NAME = block.getFieldValue('NAME') || '';
  var code = "RFID_check_card(' + Var_NAME + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RFID_check_card'] = function(block) {
  var Var_NAME = block.getFieldValue('NAME') || '';
  var code = 'RFID_check_card(' + Var_NAME + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['rfid_stopread'] = function(block) {
  var code = "rfid_stopread();\n";
  return code;
};


Blockly.Python['rfid_stopread'] = function(block) {
  var code = 'rfid_stopread()\n';
  return code;
};
...
Blockly.Java['rfid_init_custom'] = function(block) {
  var code = "rfid_init_custom();\n";
  return code;
};


Blockly.Python['rfid_init_custom'] = function(block) {
  var code = 'rfid_init_custom()\n';
  return code;
};
...
Blockly.Java['nfc_init'] = function(block) {
  var code = "nfc_init();\n";
  return code;
};


Blockly.Python['nfc_init'] = function(block) {
  var code = 'nfc_init()\n';
  return code;
};
...
Blockly.Java['nfc_validationcard'] = function(block) {
  var pin_C1 = block.getFieldValue('C1') || '';
  var pin_C2 = block.getFieldValue('C2') || '';
  var pin_C3 = block.getFieldValue('C3') || '';
  var pin_C4 = block.getFieldValue('C4') || '';
  var Var_NAME = block.getFieldValue('NAME') || '';
  var code = "nfc_validationcard(' + pin_C1 + ', ' + pin_C2 + ', ' + pin_C3 + ', ' + pin_C4 + ', ' + Var_NAME + ');\n";
  return code;
};


Blockly.Python['nfc_validationcard'] = function(block) {
  var pin_C1 = block.getFieldValue('C1') || '';
  var pin_C2 = block.getFieldValue('C2') || '';
  var pin_C3 = block.getFieldValue('C3') || '';
  var pin_C4 = block.getFieldValue('C4') || '';
...
Blockly.Java['nfc_validationcard_2'] = function(block) {
  var pin_C1 = block.getFieldValue('C1') || '';
  var pin_C2 = block.getFieldValue('C2') || '';
  var pin_C3 = block.getFieldValue('C3') || '';
  var pin_C4 = block.getFieldValue('C4') || '';
  ...
  var pin_C7 = block.getFieldValue('C7') || '';
  var Var_NAME = block.getFieldValue('NAME') || '';
  var code = "nfc_validationcard_2(' + pin_C1 + ', ' + pin_C2 + ', ' + pin_C3 + ', ' + pin_C4 + ', ' + pin_C5 + ', ' + pin_C6 + ', ' + pin_C7 + ', ' + Var_NAME + ');\n";
  return code;
};


Blockly.Python['nfc_validationcard_2'] = function(block) {
  var pin_C1 = block.getFieldValue('C1') || '';
  var pin_C2 = block.getFieldValue('C2') || '';
  var pin_C3 = block.getFieldValue('C3') || '';
  var pin_C4 = block.getFieldValue('C4') || '';
...
Blockly.Java['nfc_detected'] = function(block) {
  var code = "nfc_detected()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['nfc_detected'] = function(block) {
  var code = 'nfc_detected()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['nfc_card_readed'] = function(block) {
  var code = "nfc_card_readed()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['nfc_card_readed'] = function(block) {
  var code = 'nfc_card_readed()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['nfc_check_card'] = function(block) {
  var Var_NAME = block.getFieldValue('NAME') || '';
  var code = "nfc_check_card(' + Var_NAME + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['nfc_check_card'] = function(block) {
  var Var_NAME = block.getFieldValue('NAME') || '';
  var code = 'nfc_check_card(' + Var_NAME + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
