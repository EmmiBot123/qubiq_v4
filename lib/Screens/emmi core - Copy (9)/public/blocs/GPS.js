...
Blockly.Java['GPS_init_ss'] = function(block) {
  var code = "GPS_init_ss();\n";
  return code;
};


Blockly.Python['GPS_init_ss'] = function(block) {
  var code = 'GPS_init_ss()\n';
  return code;
};
...
Blockly.Java['GPS_read_save_values'] = function(block) {
  var code = "GPS_read_save_values();\n";
  return code;
};


Blockly.Python['GPS_read_save_values'] = function(block) {
  var code = 'GPS_read_save_values()\n';
  return code;
};
...
Blockly.Java['GPS_location'] = function(block) {
  var code = "GPS_location()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['GPS_location'] = function(block) {
  var code = 'GPS_location()';
...
Blockly.Java['GPS_speed'] = function(block) {
  var code = "GPS_speed()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};
...
Blockly.Java['GPS_datetime'] = function(block) {
  var code = "GPS_datetime()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['GPS_datetime'] = function(block) {
  var code = 'GPS_datetime()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['GPS_init_esp32'] = function(block) {
  var code = "GPS_init_esp32();\n";
  return code;
};


Blockly.Python['GPS_init_esp32'] = function(block) {
  var code = 'GPS_init_esp32()\n';
  return code;
};
