...
Blockly.Java['otto_i2cConfig'] = function (block) {
  var PIN_SDA = block.getFieldValue('PIN_SDA') || '';
  var PIN_SCL = block.getFieldValue('PIN_SCL') || '';
  var code = "otto_i2cConfig(" + PIN_SDA + ", " + PIN_SCL + ");\n";
  return code;
};


Blockly.Python['otto_i2cConfig'] = function (block) {
  var PIN_SDA = block.getFieldValue('PIN_SDA') || '';
  var PIN_SCL = block.getFieldValue('PIN_SCL') || '';
  var code = 'otto_i2cConfig(' + PIN_SDA + ', ' + PIN_SCL + ')\n';
  return code;
...
Blockly.Java['otto_arms_init'] = function (block) {
  var PIN_AL = block.getFieldValue('PIN_AL') || '';
  var PIN_AR = block.getFieldValue('PIN_AR') || '';
  var code = "otto_arms_init(" + PIN_AL + ", " + PIN_AR + ");\n";
  return code;
};


Blockly.Python['otto_arms_init'] = function (block) {
  var PIN_AL = block.getFieldValue('PIN_AL') || '';
  var PIN_AR = block.getFieldValue('PIN_AR') || '';
  var code = 'otto_arms_init(' + PIN_AL + ', ' + PIN_AR + ')\n';
  return code;
...
Blockly.Java['otto_arms'] = function (block) {
  var dropdown_otto_arms_choice = block.getFieldValue('otto_arms_choice') || '';
  var code = "otto_arms(\"" + dropdown_otto_arms_choice + "\");\n";
  return code;
};


Blockly.Python['otto_arms'] = function (block) {
  var dropdown_otto_arms_choice = block.getFieldValue('otto_arms_choice') || '';
  var code = 'otto_arms(' + dropdown_otto_arms_choice + ')\n';
  return code;
};
...
Blockly.Java['otto_arms_home'] = function (block) {
  var code = "otto_arms_home();\n";
  return code;
};


Blockly.Python['otto_arms_home'] = function (block) {
  var code = 'otto_arms_home()\n';
  return code;
};
...
Blockly.Blocks['otto_quad_configuration'] = {
  init: function () {
    var card = window.localStorage.card;
...
Blockly.Java['otto_quad_configuration'] = function (block) {
  var FLH = block.getFieldValue('FLH') || '';
  var FRH = block.getFieldValue('FRH') || '';
  var FLL = block.getFieldValue('FLL') || '';
  var FRL = block.getFieldValue('FRL') || '';
  ...
  var BLL = block.getFieldValue('BLL') || '';
  var BRL = block.getFieldValue('BRL') || '';
  var code = "otto_quad_configuration(" + FLH + ", " + FRH + ", " + FLL + ", " + FRL + ", " + BLH + ", " + BRH + ", " + BLL + ", " + BRL + ");\n";
  return code;
};


Blockly.Python['otto_quad_configuration'] = function (block) {
  var FLH = block.getFieldValue('FLH') || '';
  var FRH = block.getFieldValue('FRH') || '';
  var FLL = block.getFieldValue('FLL') || '';
  var FRL = block.getFieldValue('FRL') || '';
...
Blockly.Java['otto_quad_home'] = function (block) {
  var code = "otto_quad_home();\n";
  return code;
};


Blockly.Python['otto_quad_home'] = function (block) {
  var code = 'otto_quad_home()\n';
  return code;
};
...
Blockly.Blocks['otto_quad_hello'] = {
  init: function () {
...
Blockly.Java['otto_quad_hello'] = function (block) {
  var code = "otto_quad_hello();\n";
  return code;
};


Blockly.Python['otto_quad_hello'] = function (block) {
  var code = 'otto_quad_hello()\n';
  return code;
};
...
Blockly.Java['otto_quad_jump'] = function (block) {
  var code = "otto_quad_jump();\n";
  return code;
};


Blockly.Python['otto_quad_jump'] = function (block) {
  var code = 'otto_quad_jump()\n';
  return code;
};
...
Blockly.Blocks['otto_quad_scared'] = {
  init: function () {
...
Blockly.Java['otto_quad_scared'] = function (block) {
  var code = "otto_quad_scared();\n";
  return code;
};


Blockly.Python['otto_quad_scared'] = function (block) {
  var code = 'otto_quad_scared()\n';
  return code;
};
...
Blockly.Java['otto_quad_move'] = function (block) {
  var dropdown_otto_move_sens = block.getFieldValue('otto_move_sens') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var code = "otto_quad_move(\"" + dropdown_otto_move_sens + "\", " + dropdown_otto_move_speed + ");\n";
  return code;
};


Blockly.Python['otto_quad_move'] = function (block) {
  var dropdown_otto_move_sens = block.getFieldValue('otto_move_sens') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var code = 'otto_quad_move(' + dropdown_otto_move_sens + ', ' + dropdown_otto_move_speed + ')\n';
  return code;
...
Blockly.Java['otto_ninja_init'] = function (block) {
  var PIN_LL = block.getFieldValue('PIN_LL') || '';
  var PIN_RL = block.getFieldValue('PIN_RL') || '';
  var PIN_LF = block.getFieldValue('PIN_LF') || '';
  var PIN_RF = block.getFieldValue('PIN_RF') || '';
  ...
  var PIN_RA = block.getFieldValue('PIN_RA') || '';
  var PIN_H = block.getFieldValue('PIN_H') || '';
  var code = "otto_ninja_init(" + PIN_LL + ", " + PIN_RL + ", " + PIN_LF + ", " + PIN_RF + ", " + PIN_LA + ", " + PIN_RA + ", " + PIN_H + ");\n";
  return code;
};


Blockly.Python['otto_ninja_init'] = function (block) {
  var PIN_LL = block.getFieldValue('PIN_LL') || '';
  var PIN_RL = block.getFieldValue('PIN_RL') || '';
  var PIN_LF = block.getFieldValue('PIN_LF') || '';
  var PIN_RF = block.getFieldValue('PIN_RF') || '';
...
Blockly.Blocks['otto_ninja_calibration'] = {
  init: function () {
...
Blockly.Java['otto_ninja_calibration'] = function (block) {
  var valuela = Blockly.Java.valueToCode(block, 'LA0', Blockly.Java.ORDER_ATOMIC) || '';
  var valuera = Blockly.Java.valueToCode(block, 'RA0', Blockly.Java.ORDER_ATOMIC) || '';
  var valuerlatl = Blockly.Java.valueToCode(block, 'LATL', Blockly.Java.ORDER_ATOMIC) || '';
  var valuerratl = Blockly.Java.valueToCode(block, 'RATL', Blockly.Java.ORDER_ATOMIC) || '';
  var valuerlatr = Blockly.Java.valueToCode(block, 'LATR', Blockly.Java.ORDER_ATOMIC) || '';
  var valuerratr = Blockly.Java.valueToCode(block, 'RATR', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "otto_ninja_calibration(" + valuela + ", " + valuera + ", " + valuerlatl + ", " + valuerratl + ", " + valuerlatr + ", " + valuerratr + ");\n";
  return code;
};


Blockly.Python['otto_ninja_calibration'] = function (block) {
  // Auto-generated Python stub for otto_ninja_calibration
  var code = '0';
  return [code, Blockly.Python.ORDER_ATOMIC];
};


Blockly.Blocks['otto_ninja_speed'] = {
  init: function () {
...
Blockly.Java['otto_ninja_speed'] = function (block) {
  var valuellf = Blockly.Java.valueToCode(block, 'LFFWRS', Blockly.Java.ORDER_ATOMIC) || '';
  var valuerff = Blockly.Java.valueToCode(block, 'RFFWRS', Blockly.Java.ORDER_ATOMIC) || '';
  var valuelfb = Blockly.Java.valueToCode(block, 'LFBWRS', Blockly.Java.ORDER_ATOMIC) || '';
  var valuerfb = Blockly.Java.valueToCode(block, 'RFBWRS', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "otto_ninja_speed(" + valuellf + ", " + valuerff + ", " + valuelfb + ", " + valuerfb + ");\n";
  return code;
};


Blockly.Python['otto_ninja_speed'] = function (block) {
  // Auto-generated Python stub for otto_ninja_speed
  var code = '0';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['otto_ninja_home'] = function (block) {
  var code = "otto_ninja_home();\n";
  return code;
};


Blockly.Python['otto_ninja_home'] = function (block) {
  var code = 'otto_ninja_home()\n';
  return code;
};
...
Blockly.Blocks['otto_ninja_setwalk'] = {
  init: function () {
    this.appendDummyInput()
    ...
    this.setNextStatement(true);
    this.setColour("#4759F5");
    this.setHelpUrl('https://eurekaminds.in/')
  }
};
...
Blockly.Java['otto_ninja_setwalk'] = function (block) {
  var code = "otto_ninja_setwalk();\n";
  return code;
};


Blockly.Python['otto_ninja_setwalk'] = function (block) {
  var code = 'otto_ninja_setwalk()\n';
  return code;
};
...
Blockly.Blocks['otto_ninja_setroll'] = {
  init: function () {
    this.appendDummyInput()
...
Blockly.Java['otto_ninja_setroll'] = function (block) {
  var code = "otto_ninja_setroll();\n";
  return code;
};


Blockly.Python['otto_ninja_setroll'] = function (block) {
  var code = 'otto_ninja_setroll()\n';
  return code;
};
...
Blockly.Blocks['otto_ninja_walkstop'] = {
  init: function () {
...
Blockly.Java['otto_ninja_walkstop'] = function (block) {
  var code = "otto_ninja_walkstop();\n";
  return code;
};


Blockly.Python['otto_ninja_walkstop'] = function (block) {
  var code = 'otto_ninja_walkstop()\n';
  return code;
};
...
Blockly.Blocks['otto_ninja_rollstop'] = {
  init: function () {
...
Blockly.Java['otto_ninja_rollstop'] = function (block) {
  var code = "otto_ninja_rollstop();\n";
  return code;
};


Blockly.Python['otto_ninja_rollstop'] = function (block) {
  var code = 'otto_ninja_rollstop()\n';
  return code;
};
...
Blockly.Java['otto_ninja_walk'] = function (block) {
  var Walk = block.getFieldValue('Walk') || '';
  var code = "otto_ninja_walk(' + Walk + ');\n";
  return code;
};


Blockly.Python['otto_ninja_walk'] = function (block) {
  var Walk = block.getFieldValue('Walk') || '';
  var code = 'otto_ninja_walk(' + Walk + ')\n';
  return code;
};
...
Blockly.Java['otto_ninja_roll'] = function (block) {
  var speed = Blockly.Java.valueToCode(block, 'SPEED', Blockly.Java.ORDER_ATOMIC) || '';
  var Roll = block.getFieldValue('Roll') || '';
  var code = "otto_ninja_roll(' + speed + ', ' + Roll + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['otto_ninja_roll'] = function (block) {
  // Auto-generated Python stub for otto_ninja_roll
  var code = '0';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['otto_ninja_wifi'] = function (block) {
  var ssid = block.getFieldValue('SSID') || '';
  var wifipassword = block.getFieldValue('PASSWORD') || '';
  var code = "otto_ninja_wifi(' + ssid + ', ' + wifipassword + ');\n";
  return code;
};


Blockly.Python['otto_ninja_wifi'] = function (block) {
  var ssid = block.getFieldValue('SSID') || '';
  var wifipassword = block.getFieldValue('PASSWORD') || '';
  var code = 'otto_ninja_wifi(' + ssid + ', ' + wifipassword + ')\n';
  return code;
...
Blockly.Java['otto_ninja_app'] = function (block) {
  var code = "otto_ninja_app();\n";
  return code;
};


Blockly.Python['otto_ninja_app'] = function (block) {
  var code = 'otto_ninja_app()\n';
  return code;
};
...
Blockly.Java['otto9_app'] = function (block) {
  var code = "otto9_app();\n";
  return code;
};


Blockly.Python['otto9_app'] = function (block) {
  var code = 'otto9_app()\n';
  return code;
};
...
Blockly.Java['otto9_smooth'] = function (block) {
  var code = "otto9_smooth();\n";
  return code;
};


Blockly.Python['otto9_smooth'] = function (block) {
  var code = 'otto9_smooth()\n';
  return code;
};
