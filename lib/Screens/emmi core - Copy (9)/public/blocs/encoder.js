...
Blockly.Java['encoder'] = function(block) {
  var CLK = block.getFieldValue('CLK') || '';
  var DT = block.getFieldValue('DT') || '';
  var SW = block.getFieldValue('SW') || '';
  var code = "encoder(' + CLK + ', ' + DT + ', ' + SW + ');\n";
  return code;
};


Blockly.Python['encoder'] = function(block) {
  var CLK = block.getFieldValue('CLK') || '';
  var DT = block.getFieldValue('DT') || '';
  var SW = block.getFieldValue('SW') || '';
  var code = 'encoder(' + CLK + ', ' + DT + ', ' + SW + ')\n';
...
Blockly.Java['Init_RotaryEncoderInterrupt'] = function(block) {
  var code = "Init_RotaryEncoderInterrupt();\n";
  return code;
};


Blockly.Python['Init_RotaryEncoderInterrupt'] = function(block) {
  var code = 'Init_RotaryEncoderInterrupt()\n';
  return code;
};
...
Blockly.Java['RotaryEncoder_Write'] = function(block) {
  var writenumber = Blockly.Java.valueToCode(block, 'Writecounter', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "RotaryEncoder_Write(' + writenumber + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RotaryEncoder_Write'] = function(block) {
  var writenumber = Blockly.Python.valueToCode(block, 'Writecounter', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'RotaryEncoder_Write(' + writenumber + ')';
...
Blockly.Java['RotaryEncoder_Read'] = function(block) {
  var code = "RotaryEncoder_Read()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RotaryEncoder_Read'] = function(block) {
  var code = 'RotaryEncoder_Read()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['rotaryencoder_button_sensor'] = function(block) {
  var code = "rotaryencoder_button_sensor()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['rotaryencoder_button_sensor'] = function(block) {
  var code = 'rotaryencoder_button_sensor()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
