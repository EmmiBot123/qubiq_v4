...
Blockly.Java['DisplayTM1637_init'] = function(block) {
  var code = "DisplayTM1637_init();\n";
  return code;
};


Blockly.Python['DisplayTM1637_init'] = function(block) {
  var code = 'DisplayTM1637_init()\n';
  return code;
};
...
Blockly.Java['DisplayTM1637_setBrightness'] = function(block) {
  var britghness = Blockly.Java.valueToCode(block, 'Brightness', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "DisplayTM1637_setBrightness(' + britghness + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['DisplayTM1637_setBrightness'] = function(block) {
  var britghness = Blockly.Python.valueToCode(block, 'Brightness', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'DisplayTM1637_setBrightness(' + britghness + ')';
...
Blockly.Java['DisplayTM1637_clear'] = function(block) {
  var code = "DisplayTM1637_clear();\n";
  return code;
};


Blockly.Python['DisplayTM1637_clear'] = function(block) {
  var code = 'DisplayTM1637_clear()\n';
  return code;
};
...
Blockly.Java['DisplayTM1637_set_numberall'] = function(block) {
  var value = Blockly.Java.valueToCode(block, 'valuenumber', Blockly.Java.ORDER_ATOMIC) || '';
  var pos = Blockly.Java.valueToCode(block, 'Digit', Blockly.Java.ORDER_ATOMIC) || '';
  var length = Blockly.Java.valueToCode(block, 'Length', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "DisplayTM1637_set_numberall(' + value + ', ' + pos + ', ' + length + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['DisplayTM1637_set_numberall'] = function(block) {
  var value = Blockly.Python.valueToCode(block, 'valuenumber', Blockly.Python.ORDER_ATOMIC) || '';
  var pos = Blockly.Python.valueToCode(block, 'Digit', Blockly.Python.ORDER_ATOMIC) || '';
...
Blockly.Java['DisplayTM1637_setsegment'] = function(block) {
  var digit = Blockly.Java.valueToCode(block, 'SegmentDigit', Blockly.Java.ORDER_ATOMIC) || '';
  var value = Blockly.Java.valueToCode(block, 'SegmentValue', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "DisplayTM1637_setsegment(' + digit + ', ' + value + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['DisplayTM1637_setsegment'] = function(block) {
  var digit = Blockly.Python.valueToCode(block, 'SegmentDigit', Blockly.Python.ORDER_ATOMIC) || '';
  var value = Blockly.Python.valueToCode(block, 'SegmentValue', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'DisplayTM1637_setsegment(' + digit + ', ' + value + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['DisplayTM1637_segments'] = function(block) {
  var pos = Blockly.Java.valueToCode(block, 'Digit', Blockly.Java.ORDER_ATOMIC) || '';
  var length = Blockly.Java.valueToCode(block, 'Length', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "DisplayTM1637_segments(' + pos + ', ' + length + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['DisplayTM1637_segments'] = function(block) {
  var pos = Blockly.Python.valueToCode(block, 'Digit', Blockly.Python.ORDER_ATOMIC) || '';
  var length = Blockly.Python.valueToCode(block, 'Length', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'DisplayTM1637_segments(' + pos + ', ' + length + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
