...
Blockly.Blocks["servo_movemicros"] = {
  init: function () {
    var card = window.localStorage.card;
    this.appendDummyInput().appendField(new Blockly.FieldImage('media/servo.png', 22, 22, "*")).appendField(Blockly.Msg.ARDUINO_SERVO_MOVE_INPUT1);
    //this.appendValueInput("PIN", "Number").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.pin);
...
Blockly.Blocks['servo_2wheels_init'] = {
  init: function () {
    var card = window.localStorage.card;
...
Blockly.Java['servo_2wheels_init'] = function (block) {
  var pinl = block.getFieldValue('PINL') || '';
  var pinr = block.getFieldValue('PINR') || '';
  var pinl1 = block.getFieldValue('PINL1') || '';
  var pinr2 = block.getFieldValue('PINR2') || '';
  var code = "servo_2wheels_init(" + pinl + ", " + pinr + ", " + pinl1 + ", " + pinr2 + ");\n";
  return code;
};


Blockly.Python['servo_2wheels_init'] = function (block) {
  var pinl = block.getFieldValue('PINL') || '';
  var pinr = block.getFieldValue('PINR') || '';
  var pinl1 = block.getFieldValue('PINL1') || '';
  var pinr2 = block.getFieldValue('PINR2') || '';
...
Blockly.Blocks['flipperservo_2wheels_init'] = {
  init: function () {
    var card = window.localStorage.card;
    this.appendDummyInput().appendField(new Blockly.FieldImage('media/otto_wheels.png', 33, 33, "*")).appendField(Blockly.Msg.OTTO_HOME_TEXT + Blockly.Msg.OTTO_WHEELS_TEXT);
    //this.appendDummyInput()	.appendField(Blockly.Msg.left).setAlign(Blockly.ALIGN_RIGHT)	.appendField(new Blockly.FieldDropdown(profile[card].dropdownAllPins), "PINL");
...
Blockly.Arduino['flipperservo_2wheels_init'] = function (block) {
  var pinl = block.getFieldValue('PINL');
  var pinr = block.getFieldValue('PINR');
  var pinl1 = block.getFieldValue('PINL1');
  var pinr2 = block.getFieldValue('PINR2');

  Blockly.Arduino.includes_['otto9_wheels'] = 'const int pinl = 16;\n'
    + 'const int pinr = 2; \n'
    + 'const int pinl1 = 17;\n'
    + 'const int pinr2 = 4;\n';  // Using 2 motors for both directions
...
Blockly.Java['flipperservo_2wheels_init'] = function (block) {
  var pinl = block.getFieldValue('PINL') || '';
  var pinr = block.getFieldValue('PINR') || '';
  var pinl1 = block.getFieldValue('PINL1') || '';
  var pinr2 = block.getFieldValue('PINR2') || '';
  var code = "flipperservo_2wheels_init(" + pinl + ", " + pinr + ", " + pinl1 + ", " + pinr2 + ");\n";
  return code;
};


Blockly.Python['flipperservo_2wheels_init'] = function (block) {
  var pinl = block.getFieldValue('PINL') || '';
  var pinr = block.getFieldValue('PINR') || '';
  var pinl1 = block.getFieldValue('PINL1') || '';
  var pinr2 = block.getFieldValue('PINR2') || '';
...
Blockly.Java['servo_2wheels'] = function (block) {
  var dropdown_otto_move_sens = block.getFieldValue('otto_move_sens') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var otto_move_time = block.getFieldValue('time') || '';
  var code = "servo_2wheels('" + dropdown_otto_move_sens + "', '" + dropdown_otto_move_speed + "', " + otto_move_time + ");\n";
  return code;
};


Blockly.Python['servo_2wheels'] = function (block) {
  var dropdown_otto_move_sens = block.getFieldValue('otto_move_sens') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var otto_move_time = block.getFieldValue('time') || '';
  var code = 'servo_2wheels("' + dropdown_otto_move_sens + '", "' + dropdown_otto_move_speed + '", ' + otto_move_time + ')\n';
...
Blockly.Blocks['flipperservo_2wheels'] = {
  init: function () {
    this.appendDummyInput().appendField("💿 " + Blockly.Msg.OTTO_WHEELS_TEXT).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown(Blockly.Msg.OTTO9_MOVEW_CHOICE), "otto_move_sens");
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.OTTO9_MOVE_SPEED_TEXT).appendField(new Blockly.FieldDropdown(Blockly.Msg.OTTO9_MOVEW_SPEED_CHOICE), "otto_move_speed");
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.m_pap_step).appendField(new Blockly.FieldNumber("1"), "time");
...
Blockly.Arduino['flipperservo_2wheels'] = function (block) {
  var dropdown_otto_move_sens = block.getFieldValue('otto_move_sens');
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed');
  var otto_move_time = block.getFieldValue('time');
  var code = '';
...
Blockly.Java['flipperservo_2wheels'] = function (block) {
  var dropdown_otto_move_sens = block.getFieldValue('otto_move_sens') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var otto_move_time = block.getFieldValue('time') || '';
  var code = "flipperservo_2wheels('" + dropdown_otto_move_sens + "', '" + dropdown_otto_move_speed + "', " + otto_move_time + ");\n";
  return code;
};


Blockly.Python['flipperservo_2wheels'] = function (block) {
  var dropdown_otto_move_sens = block.getFieldValue('otto_move_sens') || '';
  var dropdown_otto_move_speed = block.getFieldValue('otto_move_speed') || '';
  var otto_move_time = block.getFieldValue('time') || '';
  var code = 'flipperservo_2wheels("' + dropdown_otto_move_sens + '", "' + dropdown_otto_move_speed + '", ' + otto_move_time + ')\n';
...
Blockly.Java['motor_run'] = function (block) {
  var motor_speed = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "motor_run(" + motor_speed + ");\n";
  return code;
};


Blockly.Python['motor_run'] = function (block) {
  var motor_speed = Blockly.Python.valueToCode(block, 'CONTENT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'motor_run(' + motor_speed + ')\n';
  return code;
};
...
Blockly.Java['motor_stop'] = function (block) {
  var code = "motor_stop();\n";
  return code;
};
...
Blockly.Java['stepper_configuration'] = function (block) {
  var stepper_steprev = Blockly.Java.valueToCode(block, 'STEP_RPM', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "stepper_configuration(" + stepper_steprev + ");\n";
  return code;
};


Blockly.Python['stepper_configuration'] = function (block) {
  var stepper_steprev = Blockly.Python.valueToCode(block, 'STEP_RPM', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'stepper_configuration(' + stepper_steprev + ')\n';
  return code;
};
...
Blockly.Java['stepper_speed'] = function (block) {
  var stepper_speed = Blockly.Java.valueToCode(block, 'STEPPER_SPEED', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "stepper_speed(" + stepper_speed + ");\n";
  return code;
};


Blockly.Python['stepper_speed'] = function (block) {
  var stepper_speed = Blockly.Python.valueToCode(block, 'STEPPER_SPEED', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'stepper_speed(' + stepper_speed + ')\n';
  return code;
};
...
Blockly.Java['stepper_steps'] = function (block) {
  var stepper_steps = Blockly.Java.valueToCode(block, 'STEPPER_STEP', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "stepper_steps(" + stepper_steps + ");\n";
  return code;
};


Blockly.Python['stepper_steps'] = function (block) {
  var stepper_steps = Blockly.Python.valueToCode(block, 'STEPPER_STEP', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'stepper_steps(' + stepper_steps + ')\n';
  return code;
};
...
Blockly.Java['m_pap_step'] = function (block) {
  var m_step = Blockly.Java.valueToCode(block, 'step', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "m_pap_step(' + m_step + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};

Blockly.Python['m_pap_step'] = function (block) {
  var m_step = Blockly.Python.valueToCode(block, 'step', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'm_pap_step(' + vars.join(', ') + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};


Blockly.Python['motor_MRTX_run'] = function (block) {
  var motor_speed = Blockly.Python.valueToCode(block, 'CONTENT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = '0'; // Stub for motor_MRTX_run
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['motor_MRTX_stop'] = function (block) {
  var code = "motor_MRTX_stop();\n";
  return code;
};


Blockly.Python['motor_MRTX_stop'] = function (block) {
  var code = 'motor_MRTX_stop()\n';
  return code;
};
...
Blockly.Java['motor_MRT_Node_run'] = function (block) {
  var motor_speed = Blockly.Java.valueToCode(block, 'CONTENT', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "motor_MRT_Node_run(' + motor_speed + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['motor_MRT_Node_run'] = function (block) {
  var motor_speed = Blockly.Python.valueToCode(block, 'CONTENT', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'motor_MRT_Node_run(' + motor_speed + ')';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['motor_MRT_Node_stop'] = function (block) {
  var code = "motor_MRT_Node_stop();\n";
  return code;
};


Blockly.Python['motor_MRT_Node_stop'] = function (block) {
  var code = 'motor_MRT_Node_stop()\n';
  return code;
};
