...
Blockly.Java['lcdi2c_setup'] = function(block) {
  var value_columns = Blockly.Java.valueToCode(block, 'COLUMNS', Blockly.Java.ORDER_ATOMIC) || '';
  var value_rows = Blockly.Java.valueToCode(block, 'ROWS', Blockly.Java.ORDER_ATOMIC) || '';
  var text_name = block.getFieldValue('NAME') || '';
  var code = "lcdi2c_setup(' + value_columns + ', ' + value_rows + ', ' + text_name + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['lcdi2c_setup'] = function(block) {
  ...
  Blockly.Python.imports_['lcd'] = 'from machine_i2c_lcd import I2cLcd';
  Blockly.Python.definitions_['lcd_init'] = 'i2c = machine.I2C(0, scl=machine.Pin(22), sda=machine.Pin(21), freq=400000)\nlcd = I2cLcd(i2c, ' + text_name + ', ' + value_rows + ', ' + value_columns + ')';
  return '';
};
...
Blockly.Java['lcdi2c_clear'] = function(block) {
  var code = "lcdi2c_clear();\n";
  return code;
};


Blockly.Python['lcdi2c_clear'] = function(block) {
  var code = 'lcdi2c_clear()\n';
  return code;
};
...
Blockly.Java['lcdi2c_home'] = function(block) {
  var code = "lcdi2c_home();\n";
  return code;
};


Blockly.Python['lcdi2c_home'] = function(block) {
  var code = 'lcdi2c_home()\n';
  return code;
};
...
Blockly.Java['lcdi2c_setcursor'] = function(block) {
  var value_column = Blockly.Java.valueToCode(block, 'column', Blockly.Java.ORDER_ATOMIC) || '';
  var value_row = Blockly.Java.valueToCode(block, 'row', Blockly.Java.ORDER_ATOMIC) || '';
  var value_texttoprint = Blockly.Java.valueToCode(block, 'texttoprint', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "lcdi2c_setcursor(' + value_column + ', ' + value_row + ', ' + value_texttoprint + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['lcdi2c_setcursor'] = function(block) {
...
Blockly.Java['lcdi2c_setcursoralone'] = function(block) {
  var value_column = Blockly.Java.valueToCode(block, 'column', Blockly.Java.ORDER_ATOMIC) || '';
  var value_row = Blockly.Java.valueToCode(block, 'row', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "lcdi2c_setcursoralone(' + value_column + ', ' + value_row + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['lcdi2c_setcursoralone'] = function(block) {
  var value_column = Blockly.Python.valueToCode(block, 'column', Blockly.Python.ORDER_ATOMIC) || '';
  var value_row = Blockly.Python.valueToCode(block, 'row', Blockly.Python.ORDER_ATOMIC) || '';
  var code = 'lcdi2c_setcursoralone(' + value_column + ', ' + value_row + ')';
...
Blockly.Java['lcdi2c_display'] = function(block) {
  var code = "lcdi2c_display();\n";
  return code;
};


Blockly.Python['lcdi2c_display'] = function(block) {
  var code = 'lcdi2c_display()\n';
  return code;
};
...
Blockly.Java['lcdi2c_scrollDisplay'] = function(block) {
  var code = "lcdi2c_scrollDisplay();\n";
  return code;
};


Blockly.Python['lcdi2c_scrollDisplay'] = function(block) {
  var code = 'lcdi2c_scrollDisplay()\n';
  return code;
};
...
Blockly.Java['lcdi2c_setBacklight'] = function(block) {
  var code = "lcdi2c_setBacklight();\n";
  return code;
};


Blockly.Python['lcdi2c_setBacklight'] = function(block) {
  var code = 'lcdi2c_setBacklight()\n';
  return code;
};
...
Blockly.Java['lcdi2c_showCursor'] = function(block) {
  var code = "lcdi2c_showCursor();\n";
  return code;
};


Blockly.Python['lcdi2c_showCursor'] = function(block) {
  var code = 'lcdi2c_showCursor()\n';
  return code;
};
...
Blockly.Java['lcdi2c_blinkCursor'] = function(block) {
  var code = "lcdi2c_blinkCursor();\n";
  return code;
};


Blockly.Python['lcdi2c_blinkCursor'] = function(block) {
  var code = 'lcdi2c_blinkCursor()\n';
  return code;
};
