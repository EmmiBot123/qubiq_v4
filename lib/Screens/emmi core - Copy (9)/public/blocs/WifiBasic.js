...
Blockly.Java['wifi_init_sta'] = function(block) {
  var ssid = block.getFieldValue('SSID') || '';
  var wifipassword = block.getFieldValue('PASSWORD') || '';
  var code = "wifi_init_sta(' + ssid + ', ' + wifipassword + ');\n";
  return code;
};


Blockly.Python['wifi_init_sta'] = function(block) {
  var ssid = block.getFieldValue('SSID') || '';
  var wifipassword = block.getFieldValue('PASSWORD') || '';
  var code = 'wifi_init_sta(' + ssid + ', ' + wifipassword + ')\n';
  return code;
...
Blockly.Java['wifi_init_ap'] = function(block) {
  var ssid = block.getFieldValue('SSID') || '';
  var wifipassword = block.getFieldValue('PASSWORD') || '';
  var code = "wifi_init_ap(' + ssid + ', ' + wifipassword + ');\n";
  return code;
};


Blockly.Python['wifi_init_ap'] = function(block) {
  var ssid = block.getFieldValue('SSID') || '';
  var wifipassword = block.getFieldValue('PASSWORD') || '';
  var code = 'wifi_init_ap(' + ssid + ', ' + wifipassword + ')\n';
  return code;
...
Blockly.Java['wifi_init_sta_ap'] = function(block) {
  var ssid = block.getFieldValue('SSID') || '';
  var wifipassword = block.getFieldValue('PASSWORD') || '';
  var ssid2 = block.getFieldValue('SSID2') || '';
  var wifipassword2 = block.getFieldValue('PASSWORD2') || '';
  var code = "wifi_init_sta_ap(' + ssid + ', ' + wifipassword + ', ' + ssid2 + ', ' + wifipassword2 + ');\n";
  return code;
};


Blockly.Python['wifi_init_sta_ap'] = function(block) {
  var ssid = block.getFieldValue('SSID') || '';
  var wifipassword = block.getFieldValue('PASSWORD') || '';
  var ssid2 = block.getFieldValue('SSID2') || '';
  var wifipassword2 = block.getFieldValue('PASSWORD2') || '';
...
Blockly.Java['wifi_ap_staticip'] = function(block) {
  var IP_ap = block.getFieldValue('IP') || '';
  var Mask_ap = block.getFieldValue('Mask') || '';
  var Gateway_ap = block.getFieldValue('Gateway') || '';
  var code = "wifi_ap_staticip(' + IP_ap + ', ' + Mask_ap + ', ' + Gateway_ap + ');\n";
  return code;
};


Blockly.Python['wifi_ap_staticip'] = function(block) {
  var IP_ap = block.getFieldValue('IP') || '';
  var Mask_ap = block.getFieldValue('Mask') || '';
  var Gateway_ap = block.getFieldValue('Gateway') || '';
  var code = 'wifi_ap_staticip(' + IP_ap + ', ' + Mask_ap + ', ' + Gateway_ap + ')\n';
...
Blockly.Java['wifi_sta_staticip'] = function(block) {
  var IP_sta = block.getFieldValue('IP') || '';
  var Mask_sta = block.getFieldValue('Mask') || '';
  var Gateway_sta = block.getFieldValue('Gateway') || '';
  var code = "wifi_sta_staticip(' + IP_sta + ', ' + Mask_sta + ', ' + Gateway_sta + ');\n";
  return code;
};


Blockly.Python['wifi_sta_staticip'] = function(block) {
  var IP_sta = block.getFieldValue('IP') || '';
  var Mask_sta = block.getFieldValue('Mask') || '';
  var Gateway_sta = block.getFieldValue('Gateway') || '';
  var code = 'wifi_sta_staticip(' + IP_sta + ', ' + Mask_sta + ', ' + Gateway_sta + ')\n';
