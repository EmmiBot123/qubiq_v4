...
Blockly.Java['RadioTEA5767_init'] = function(block) {
  var code = "RadioTEA5767_init();\n";
  return code;
};


Blockly.Python['RadioTEA5767_init'] = function(block) {
  var code = 'RadioTEA5767_init()\n';
  return code;
};
...
Blockly.Java['RadioTEA5767_activate'] = function(block) {
  var code = "RadioTEA5767_activate();\n";
  return code;
};


Blockly.Python['RadioTEA5767_activate'] = function(block) {
  var code = 'RadioTEA5767_activate()\n';
  return code;
};
...
Blockly.Java['RadioTEA5767_mute'] = function(block) {
  var code = "RadioTEA5767_mute();\n";
  return code;
};


Blockly.Python['RadioTEA5767_mute'] = function(block) {
  var code = 'RadioTEA5767_mute()\n';
  return code;
};
...
Blockly.Java['RadioTEA5767_LevelSignal'] = function(block) {
  var code = "RadioTEA5767_LevelSignal()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RadioTEA5767_LevelSignal'] = function(block) {
  var code = 'RadioTEA5767_LevelSignal()';
...
Blockly.Java['RadioTEA5767_Stereo'] = function(block) {
  var code = "RadioTEA5767_Stereo()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RadioTEA5767_Stereo'] = function(block) {
  var code = 'RadioTEA5767_Stereo()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Java['RadioTEA5767_setFrequency'] = function(block) {
  var value = Blockly.Java.valueToCode(block, 'Value', Blockly.Java.ORDER_ATOMIC) || '';
  var code = "RadioTEA5767_setFrequency(' + value + ')";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['RadioTEA5767_setFrequency'] = function(block) {
...
Blockly.Java['frequenciesMadrid'] = function(block) {
  var code = "frequenciesMadrid()";
  return [code, Blockly.Java.ORDER_ATOMIC];
};


Blockly.Python['frequenciesMadrid'] = function(block) {
  var code = 'frequenciesMadrid()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
