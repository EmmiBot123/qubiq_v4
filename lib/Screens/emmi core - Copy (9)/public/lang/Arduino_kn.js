...
// categories (menu)
Blockly.Msg.CAT_TAB = "🔠 ಅರೇಗಳು";
Blockly.Msg.CAT_list = "🔤 ಪಟ್ಟಿ";
Blockly.Msg.CAT_LOGIC = "🔂 ನಿಯಂತ್ರಣ";
Blockly.Msg.CAT_MATH = "🔢 ಗಣಿತ";
Blockly.Msg.CAT_TEXT = "🔤 ಪಠ್ಯ";
Blockly.Msg.CAT_VARIABLES = "🔀 ವೇರಿಯೇಬಲ್‌ಗಳು";
Blockly.Msg.CAT_FUNCTIONS = "🔣 ಕಾರ್ಯಗಳು";
Blockly.Msg.CAT_ARDUINO = "🔄 ರಚನೆ";
Blockly.Msg.CAT_ARDUINO_IN = "♾️ ಆರ್ಡುನೊ";
...
Blockly.Msg.CAT_ARDUINO_OUT = "🔛 ಇನ್ / ಔಟ್";
Blockly.Msg.CAT_ARDUINO_TIME = "⏱️ ಸಮಯ";
Blockly.Msg.CAT_OTTO = "🤖 Emmi";
Blockly.Msg.CAT_OTTO_LEGS = "🦿 ಕಾಲುಗಳು";
Blockly.Msg.CAT_OTTO_ARMS = "🦾 ಕೈಗಳು";
Blockly.Msg.CAT_OTTO_WHEELS = "💿 ಚಕ್ರಗಳು";
Blockly.Msg.CAT_OTTO_NINJA = "🐱‍👤 ನಿಂಜಾ";
Blockly.Msg.CAT_OTTO_QUAD = "🕷️ ಕ್ವಾಡ್";
Blockly.Msg.CAT_ESCORNABOT = "🐞 ಎಸ್ಕಾರ್ನಾಬಾಟ್";
Blockly.Msg.CAT_servo = "🦾 ಸರ್ವೋ";
Blockly.Msg.CAT_actionneur = "⚙️ ಮೋಟಾರ್";
Blockly.Msg.CAT_ARDUINO_moteur = "⚙️ ಸ್ಟೆಪ್ಪರ್";
Blockly.Msg.CAT_ultrason = "👓 ಅಲ್ಟ್ರಾಸಾನಿಕ್";
Blockly.Msg.CAT_SENSORS = "👂 ಸೆನ್ಸಿಂಗ್";
