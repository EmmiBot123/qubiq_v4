...
// categories (menu)
Blockly.Msg.CAT_TAB = "🔠 એરે";
Blockly.Msg.CAT_list = "🔤 યાદી";
Blockly.Msg.CAT_LOGIC = "🔂 નિયંત્રણ";
Blockly.Msg.CAT_MATH = "🔢 ગણિત";
Blockly.Msg.CAT_TEXT = "🔤 લખાણ";
Blockly.Msg.CAT_VARIABLES = "🔀 વેરિયેબલ્સ";
Blockly.Msg.CAT_FUNCTIONS = "🔣 ફંક્શન";
Blockly.Msg.CAT_ARDUINO = "🔄 માળખું";
Blockly.Msg.CAT_ARDUINO_IN = "♾️ આર્ડુનો";
...
Blockly.Msg.CAT_ARDUINO_OUT = "🔛 ઇન / આઉટ";
Blockly.Msg.CAT_ARDUINO_TIME = "⏱️ સમય";
Blockly.Msg.CAT_OTTO = "🤖 Emmi";
Blockly.Msg.CAT_OTTO_LEGS = "🦿 પગ";
Blockly.Msg.CAT_OTTO_ARMS = "🦾 હાથ";
Blockly.Msg.CAT_OTTO_WHEELS = "💿 પૈડાં";
Blockly.Msg.CAT_OTTO_NINJA = "🐱‍👤 નિન્જા";
Blockly.Msg.CAT_OTTO_QUAD = "🕷️ ક્વાડ";
Blockly.Msg.CAT_ESCORNABOT = "🐞 Escornabot";
Blockly.Msg.CAT_servo = "🦾 સર્વો";
Blockly.Msg.CAT_actionneur = "⚙️ મોટર";
Blockly.Msg.CAT_ARDUINO_moteur = "⚙️ સ્ટેપર";
Blockly.Msg.CAT_ultrason = "👓 અલ્ટ્રાસોનિક";
Blockly.Msg.CAT_SENSORS = "👂 સેન્સિંગ";
...
Blockly.Msg.CAT_Displays = "💻 ડિસ્પ્લે";
