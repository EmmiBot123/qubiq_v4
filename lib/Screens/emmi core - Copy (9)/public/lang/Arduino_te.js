...
// categories (menu)
Blockly.Msg.CAT_TAB = "🔠 అరేలు";
Blockly.Msg.CAT_list = "🔤 జాబಿತా";
Blockly.Msg.CAT_LOGIC = "🔂 నియంత్రణ";
Blockly.Msg.CAT_MATH = "🔢 గణితం";
Blockly.Msg.CAT_TEXT = "🔤 టెక్స్ట్";
Blockly.Msg.CAT_VARIABLES = "🔀 వేరియబుల్స్";
Blockly.Msg.CAT_FUNCTIONS = "🔣 ఫంక్షన్లు";
Blockly.Msg.CAT_ARDUINO = "🔄 నిర్మాణం";
Blockly.Msg.CAT_ARDUINO_IN = "♾️ ఆర్డునో";
...
Blockly.Msg.CAT_ARDUINO_OUT = "🔛 ఇన్ / అవుట్";
Blockly.Msg.CAT_ARDUINO_TIME = "⏱️ సమయం";
Blockly.Msg.CAT_OTTO = "🤖 Emmi";
Blockly.Msg.CAT_OTTO_LEGS = "🦿 కాళ్లు";
Blockly.Msg.CAT_OTTO_ARMS = "🦾 చేతులు";
Blockly.Msg.CAT_OTTO_WHEELS = "💿 చక్రాలు";
Blockly.Msg.CAT_OTTO_NINJA = "🐱‍👤 Ninja";
Blockly.Msg.CAT_OTTO_QUAD = "🕷️ Quad";
Blockly.Msg.CAT_ESCORNABOT="🐞 Escornabot";
Blockly.Msg.CAT_servo = "🦾 సర్వో";
Blockly.Msg.CAT_actionneur = "⚙️ మోటార్";
Blockly.Msg.CAT_ARDUINO_moteur="⚙️ స్టెప్పర్";
Blockly.Msg.CAT_ultrason = "👓 అల్ట్రాసోనిక్";
Blockly.Msg.CAT_SENSORS = "👂 సెన్సింగ్";
...
Blockly.Msg.CAT_Displays = "💻 డిస్ప్లే";
...
Blockly.Msg.CAT_com = "📡 కమ్యూనికేషన్";
...
Blockly.Msg.CAT_iot = "☁️ ఐఓటి (IoT)";
Blockly.Msg.CAT_html = "✉️ HTML";
Blockly.Msg.CAT_wifi = "🌐 వైఫై";
