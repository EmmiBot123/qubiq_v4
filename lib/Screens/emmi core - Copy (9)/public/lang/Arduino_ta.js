...
// categories (menu)
Blockly.Msg.CAT_TAB = "🔠 அணிகள்";
Blockly.Msg.CAT_list = "🔤 பட்டியல்";
Blockly.Msg.CAT_LOGIC = "🔂 கட்டுப்பாடு";
Blockly.Msg.CAT_MATH = "🔢 கணிதம்";
Blockly.Msg.CAT_TEXT = "🔤 உரை";
Blockly.Msg.CAT_VARIABLES = "🔀 மாறிகள்";
Blockly.Msg.CAT_FUNCTIONS = "🔣 செயல்பாடுகள்";
Blockly.Msg.CAT_ARDUINO = "🔄 கட்டமைப்பு";
Blockly.Msg.CAT_ARDUINO_IN = "♾️ அர்டுயினோ";
...
Blockly.Msg.CAT_ARDUINO_OUT = "🔛 உள்ளீடு / வெளியீடு";
Blockly.Msg.CAT_ARDUINO_TIME = "⏱️ நேரம்";
Blockly.Msg.CAT_OTTO = "🤖 Emmi";
Blockly.Msg.CAT_OTTO_LEGS = "🦿 கால்கள்";
Blockly.Msg.CAT_OTTO_ARMS = "🦾 கைகள்";
Blockly.Msg.CAT_OTTO_WHEELS = "💿 சக்கரங்கள்";
Blockly.Msg.CAT_OTTO_NINJA = "🐱‍👤 Ninja";
Blockly.Msg.CAT_OTTO_QUAD = "🕷️ Quad";
Blockly.Msg.CAT_ESCORNABOT="🐞 Escornabot";
Blockly.Msg.CAT_servo = "🦾 சர்வோ";
Blockly.Msg.CAT_actionneur = "⚙️ மோட்டார்";
Blockly.Msg.CAT_ARDUINO_moteur="⚙️ ஸ்டெப்பர்";
Blockly.Msg.CAT_ultrason = "👓 அல்ட்ராசோனிக்";
Blockly.Msg.CAT_SENSORS = "👂 உணர்தல்";
...
Blockly.Msg.CAT_Displays = "💻 டிஸ்ப்ளே";
...
Blockly.Msg.CAT_com = "📡 திறன் தொடர்பு";
...
Blockly.Msg.CAT_iot = "☁️ ஐஓடி (IoT)";
Blockly.Msg.CAT_html = "✉️ HTML";
Blockly.Msg.CAT_wifi = "🌐 வைஃபை";
